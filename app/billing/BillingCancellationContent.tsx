...
export interface BillingCancellationContentProps {
  billing: BillingAccountInfo | undefined
  loading: boolean
...
// BillingCancellationContent renders cancellation consequences and controls.
export function BillingCancellationContent(
  props: BillingCancellationContentProps,
) {
  const {
    billing,
    loading,
