...
// Windows code-signing identity-validation period; replace the archives
// with .msix installers and drop the flag once signing is available. CLI
// artifacts are signed where platform signing is available
