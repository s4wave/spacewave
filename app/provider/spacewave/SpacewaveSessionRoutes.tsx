...
// SpacewaveSessionRoutesOptions configures shared route wrappers.
export interface SpacewaveSessionRoutesOptions {
  fallbackPath: string
}
...
export function spacewaveSessionRoutes(
  ...
  options: SpacewaveSessionRoutesOptions = { fallbackPath: '../' },
): ReactNode[] {
  const frame = (children: ReactNode) => (
    <SessionFlowFrame fallbackPath={options.fallbackPath}>
      {children}
    </SessionFlowFrame>
  )
