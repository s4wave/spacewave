...
import { ExecControllerRequest } from '../../vendor/github.com/aperturerobotics/controllerbus/controller/exec/exec'
import { BlockRef } from '../../vendor/github.com/aperturerobotics/hydra/block/block'
import { ControllerConfig } from '../../vendor/github.com/aperturerobotics/controllerbus/controller/configset/proto/configset'
...
export const Assembly = {
  ...
  fromPartial<I extends Exact<DeepPartial<Assembly>, I>>(object: I): Assembly {
    const message = createBaseAssembly()
    message.controllerExec =
      object.controllerExec !== undefined && object.controllerExec !== null
...
export const SubAssembly = {
  ...
  fromPartial<I extends Exact<DeepPartial<SubAssembly>, I>>(
    object: I
  ): SubAssembly {
    const message = createBaseSubAssembly()
...
export const DirectiveBridge = {
  ...
  fromJSON(object: any): DirectiveBridge {
    return {
      controllerConfig: isSet(object.controllerConfig)
        ? ControllerConfig.fromJSON(object.controllerConfig)
        : undefined,
      bridgeToParent: isSet(object.bridgeToParent)
        ? Boolean(object.bridgeToParent)
        : false,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DirectiveBridge>, I>>(
    object: I
  ): DirectiveBridge {
    const message = createBaseDirectiveBridge()
    message.controllerConfig =
      object.controllerConfig !== undefined && object.controllerConfig !== null
