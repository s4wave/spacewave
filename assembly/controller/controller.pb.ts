...
function createBaseConfig(): Config {
  return { disableResolver: false, disablePartialSuccess: false }
}
...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      disableResolver: isSet(object.disableResolver)
        ? Boolean(object.disableResolver)
        : false,
      disablePartialSuccess: isSet(object.disablePartialSuccess)
        ? Boolean(object.disablePartialSuccess)
        : false,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    const message = createBaseConfig()
    message.disableResolver = object.disableResolver ?? false
    message.disablePartialSuccess = object.disablePartialSuccess ?? false
    return message
  },
}
