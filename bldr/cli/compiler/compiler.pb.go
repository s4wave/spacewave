...
type Config struct {
	...
	ComposePackage string `protobuf:"bytes,5,opt,name=compose_package,json=composePackage,proto3" json:"composePackage,omitempty"`
}
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ComposePackage)
