...
type Config struct {
	...
	NativeRunnerPackage string `protobuf:"bytes,17,opt,name=native_runner_package,json=nativeRunnerPackage,proto3" json:"nativeRunnerPackage,omitempty"`
	...
	ComposePackage string `protobuf:"bytes,18,opt,name=compose_package,json=composePackage,proto3" json:"composePackage,omitempty"`
}
...
func (x *Config) GetNativeRunnerPackage() string {
	if x != nil {
		return x.NativeRunnerPackage
	}
	return ""
}

func (x *Config) GetComposePackage() string {
	if x != nil {
		return x.ComposePackage
	}
	return ""
}
...
func (m *Config) CloneVT() *Config {
	...
	r.NativeRunnerPackage = m.NativeRunnerPackage
	r.ComposePackage = m.ComposePackage
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if this.NativeRunnerPackage != that.NativeRunnerPackage {
		return false
	}
	if this.ComposePackage != that.ComposePackage {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *Config) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.NativeRunnerPackage != "" || s.HasField("nativeRunnerPackage") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("nativeRunnerPackage")
		s.WriteString(x.NativeRunnerPackage)
	}
	if x.ComposePackage != "" || s.HasField("composePackage") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("composePackage")
		s.WriteString(x.ComposePackage)
	}
	s.WriteObjectEnd()
}
...
func (x *Config) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "native_runner_package", "nativeRunnerPackage":
			s.AddField("native_runner_package")
			x.NativeRunnerPackage = s.ReadString()
		case "compose_package", "composePackage":
			s.AddField("compose_package")
			x.ComposePackage = s.ReadString()
		}
	})
}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ComposePackage) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ComposePackage)
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	}
	if len(m.NativeRunnerPackage) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.NativeRunnerPackage)
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(2, m.NativeRunnerPackage)
	n += protobuf_go_lite.SizeStringNonEmpty(2, m.ComposePackage)
	n += len(m.unknownFields)
	return n
}
...
func (x *Config) MarshalProtoText() string {
	...
	if x.NativeRunnerPackage != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "native_runner_package")
		protobuf_go_lite.TextWriteString(&sb, x.NativeRunnerPackage)
	}
	if x.ComposePackage != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "compose_package")
		protobuf_go_lite.TextWriteString(&sb, x.ComposePackage)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NativeRunnerPackage", wireType)
			}
			var v string
			v, iNdEx, err = protobuf_go_lite.DecodeString(dAtA, iNdEx)
			if err != nil {
			...
			m.NativeRunnerPackage = v
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ComposePackage", wireType)
			}
			var v string
			v, iNdEx, err = protobuf_go_lite.DecodeString(dAtA, iNdEx)
			if err != nil {
