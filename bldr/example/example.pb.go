...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.RunDemo {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.RunDemo)
		i--
		dAtA[i] = 0x8
	}
...
func (m *Config) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeBoolNonZero(1, m.RunDemo)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.RunDemo != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "run_demo")
		protobuf_go_lite.TextWriteBool(&sb, x.RunDemo)
	}
...
func (x *ExampleProps) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ExampleProps")
	if x.Msg != "" {
