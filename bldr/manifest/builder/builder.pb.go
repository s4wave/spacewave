...
type BuilderResult struct {
	...
	SourceRef *bucket.ObjectRef `protobuf:"bytes,5,opt,name=source_ref,json=sourceRef,proto3" json:"sourceRef,omitempty"`
}
...
func (x *BuilderResult) GetSourceRef() *bucket.ObjectRef {
	if x != nil {
		return x.SourceRef
	}
	return nil
...
func (x *BuilderResult) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.SubManifestResults != nil || s.HasField("subManifestResults") {
		...
		for _, k := range slices.Sorted(maps.Keys(x.SubManifestResults)) {
