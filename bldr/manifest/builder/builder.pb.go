...
func (x *InputManifest) MarshalProtoText() string {
	...
	if len(x.Files) > 0 {
		...
		for i, v := range x.Files {
			...
			if v == nil {
				sb.WriteString((&InputManifest_File{}).MarshalProtoText())
			} else {
	...
	if len(x.ManifestDeps) > 0 {
		...
		for i, v := range x.ManifestDeps {
			...
			if v == nil {
				sb.WriteString((&InputManifest_ManifestDep{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.StartupInputs) > 0 {
		...
		for i, v := range x.StartupInputs {
			...
			if v == nil {
				sb.WriteString((&InputManifest_StartupInput{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
