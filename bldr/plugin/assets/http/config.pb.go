...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FsPath) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.FsPath)
		i--
		dAtA[i] = 0x12
	}
	if len(m.ServePath) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ServePath)
		i--
		dAtA[i] = 0xa
	}
...
func (m *Config) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ServePath)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.FsPath)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.ServePath != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "serve_path")
		protobuf_go_lite.TextWriteString(&sb, x.ServePath)
	}
	if x.FsPath != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "fs_path")
		protobuf_go_lite.TextWriteString(&sb, x.FsPath)
	}
	if x.PluginId != "" {
