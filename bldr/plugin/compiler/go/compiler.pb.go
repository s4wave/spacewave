...
func (x *InputManifestMeta) MarshalProtoText() string {
	...
	if len(x.EsbuildBundles) > 0 {
		...
		for i, v := range x.EsbuildBundles {
			...
			if v == nil {
				sb.WriteString((&EsbuildBundleVarMeta{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.ViteBundles) > 0 {
		...
		for i, v := range x.ViteBundles {
			...
			if v == nil {
				sb.WriteString((&ViteBundleVarMeta{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *EsbuildBundleVarMeta) MarshalProtoText() string {
	...
	if len(x.EntrypointVars) > 0 {
		...
		for i, v := range x.EntrypointVars {
			...
			if v == nil {
				sb.WriteString((&EsbuildEntrypointVar{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *ViteBundleVarMeta) MarshalProtoText() string {
	...
	if len(x.EntrypointVars) > 0 {
		...
		for i, v := range x.EntrypointVars {
			...
			if v == nil {
				sb.WriteString((&ViteEntrypointVar{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
