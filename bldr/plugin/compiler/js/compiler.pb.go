...
func (x *Config) MarshalProtoText() string {
	...
	if len(x.Modules) > 0 {
		...
		for i, v := range x.Modules {
			...
			if v == nil {
				sb.WriteString((&JsModule{}).MarshalProtoText())
			} else {
	...
	if len(x.EsbuildBundles) > 0 {
		...
		for i, v := range x.EsbuildBundles {
			...
			if v == nil {
				sb.WriteString((&compiler.EsbuildBundleMeta{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.ViteBundles) > 0 {
		...
		for i, v := range x.ViteBundles {
			...
			if v == nil {
				sb.WriteString((&compiler1.ViteBundleMeta{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.BackendEntrypoints) > 0 {
		...
		for i, v := range x.BackendEntrypoints {
			...
			if v == nil {
				sb.WriteString((&BackendEntrypoint{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.FrontendEntrypoints) > 0 {
		...
		for i, v := range x.FrontendEntrypoints {
			...
			if v == nil {
				sb.WriteString((&FrontendEntrypoint{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.WebPkgs) > 0 {
		...
		for i, v := range x.WebPkgs {
			...
			if v == nil {
				sb.WriteString((&bundler.WebPkgRefConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.HostConfigSet) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.HostConfigSet)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&proto.ControllerConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.BuildTypes) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.BuildTypes)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&Config{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *InputManifestMeta) MarshalProtoText() string {
	...
	if len(x.WebPkgRefs) > 0 {
		...
		for i, v := range x.WebPkgRefs {
			...
			if v == nil {
				sb.WriteString((&pkg.WebPkgRef{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.EsbuildOutputs) > 0 {
		...
		for i, v := range x.EsbuildOutputs {
			...
			if v == nil {
				sb.WriteString((&esbuild.EsbuildOutputMeta{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.ViteOutputs) > 0 {
		...
		for i, v := range x.ViteOutputs {
			...
			if v == nil {
				sb.WriteString((&vite.ViteOutputMeta{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
