...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ServerIdRegex) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ServerIdRegex)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ServiceIdRegex) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ServiceIdRegex)
		i--
		dAtA[i] = 0x12
	}
	if len(m.PluginId) > 0 {
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ServiceIdRegex)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ServerIdRegex)
	if m.Backoff != nil {
		l = m.Backoff.SizeVT()
...
func (x *Config) MarshalProtoText() string {
	...
	if x.ServiceIdRegex != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "service_id_regex")
		protobuf_go_lite.TextWriteString(&sb, x.ServiceIdRegex)
	}
	if x.ServerIdRegex != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "server_id_regex")
		protobuf_go_lite.TextWriteString(&sb, x.ServerIdRegex)
	}
	if x.Backoff != nil {
