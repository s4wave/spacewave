...
// @generated from file github.com/s4wave/spacewave/bldr/plugin/forward-rpc-service/config.proto (package bldr.plugin.forward_rpc_service, syntax proto3)
/* eslint-disable */
...
export const Config: MessageType<Config> = createMessageType({
  typeName: 'bldr.plugin.forward_rpc_service.Config',
  fields: [
