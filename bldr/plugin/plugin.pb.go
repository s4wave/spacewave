...
func (m *LoadPluginResponse) CloneVT() *LoadPluginResponse {
	...
	r.PluginStatus = m.PluginStatus.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *PluginContextInfo) CloneVT() *PluginContextInfo {
	...
	r.PluginMeta = m.PluginMeta.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *GetPluginInfoResponse) EqualVT(that *GetPluginInfoResponse) bool {
	...
	if !this.HostVolumeInfo.EqualVT(that.HostVolumeInfo) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *PluginStartInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.InstanceId) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.InstanceId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (x *GetPluginInfoResponse) MarshalProtoText() string {
	...
	if x.HostVolumeInfo != nil {
		...
		sb.WriteString("host_volume_info: ")
		sb.WriteString(x.HostVolumeInfo.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *LoadPluginResponse) MarshalProtoText() string {
	...
	if x.PluginStatus != nil {
		...
		sb.WriteString("plugin_status: ")
		sb.WriteString(x.PluginStatus.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *PluginStartInfo) MarshalProtoText() string {
	...
	if x.InstanceId != "" {
		...
		sb.WriteString(strconv.Quote(x.InstanceId))
	}
	if x.PluginId != "" {
		if sb.Len() > 17 {
			sb.WriteString(" ")
...
func (x *PluginContextInfo) MarshalProtoText() string {
	...
	if x.PluginMeta != nil {
		...
		sb.WriteString("plugin_meta: ")
		sb.WriteString(x.PluginMeta.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (m *GetPluginInfoResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.HostVolumeInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
