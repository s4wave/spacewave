...
type Config struct {
	...
	FrontendRoutePrefix string `protobuf:"bytes,9,opt,name=frontend_route_prefix,json=frontendRoutePrefix,proto3" json:"frontendRoutePrefix,omitempty"`
}
...
func (x *Config) GetFrontendRoutePrefix() string {
	if x != nil {
