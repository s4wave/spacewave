...
func (x *ProjectConfig) MarshalProtoText() string {
	...
	if len(x.Manifests) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.Manifests)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&ManifestConfig{}).MarshalProtoText())
			} else {
	...
	if len(x.Build) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.Build)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&BuildConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.Remotes) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.Remotes)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&RemoteConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
	...
	if len(x.Publish) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.Publish)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&PublishConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *PublishConfig) MarshalProtoText() string {
	...
	if len(x.ManifestStorage) > 0 {
		...
		for _, k := range slices.Sorted(maps.Keys(x.ManifestStorage)) {
			...
			sb.WriteString(": ")
			if v == nil {
				sb.WriteString((&PublishStorageConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
