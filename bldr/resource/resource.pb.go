...
func (m *ResourceClientResponse_ClientError) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = protobuf_go_lite.EncodeString(dAtA, i, m.ClientError)
	i--
	dAtA[i] = 0x1a
	return len(dAtA) - i, nil
}
...
func (m *ResourceClientResponse_ClientError) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringValue(1, m.ClientError)
	return n
}
...
func (x *ResourceClientRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "ResourceClientRequest")
...
func (x *ResourceClientResponse) MarshalProtoText() string {
	...
	case *ResourceClientResponse_ClientError:
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "client_error")
		protobuf_go_lite.TextWriteString(&sb, body.ClientError)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *ResourceClientResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Body = &ResourceClientResponse_ClientError{ClientError: v}
		default:
			iNdEx = preIndex
			skippy, err := protobuf_go_lite.Skip(dAtA[iNdEx:])
			if err != nil {
