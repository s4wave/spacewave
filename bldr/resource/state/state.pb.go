...
func (m *GetStateResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.StateJson) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.StateJson)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GetStateResponse) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.StateJson)
...
func (x *GetStateResponse) MarshalProtoText() string {
	...
	if x.StateJson != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "state_json")
		protobuf_go_lite.TextWriteString(&sb, x.StateJson)
	}
	if x.Seqno != 0 {
...
func (x *SetStateRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SetStateRequest")
	if x.StateJson != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "state_json")
		protobuf_go_lite.TextWriteString(&sb, x.StateJson)
	}
...
func (x *SetStateResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SetStateResponse")
	if x.Seqno != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "seqno")
		protobuf_go_lite.TextWriteUint(&sb, x.Seqno)
	}
