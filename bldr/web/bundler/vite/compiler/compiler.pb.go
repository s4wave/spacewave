...
type ViteBundleMeta struct {
	...
	BundleWebPkgs bool `protobuf:"varint,7,opt,name=bundle_web_pkgs,json=bundleWebPkgs,proto3" json:"bundleWebPkgs,omitempty"`
}
...
func (x *ViteBundleMeta) GetBundleWebPkgs() bool {
	if x != nil {
		return x.BundleWebPkgs
	}
	return false
}
...
func (m *ViteBundleMeta) CloneVT() *ViteBundleMeta {
	...
	r.DisableProjectConfig = m.DisableProjectConfig
	r.BundleWebPkgs = m.BundleWebPkgs
...
func (this *ViteBundleMeta) EqualVT(that *ViteBundleMeta) bool {
	...
	if this.BundleWebPkgs != that.BundleWebPkgs {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *ViteBundleMeta) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.BundleWebPkgs || s.HasField("bundleWebPkgs") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("bundleWebPkgs")
		s.WriteBool(x.BundleWebPkgs)
	}
	s.WriteObjectEnd()
}
...
func (x *ViteBundleMeta) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "bundle_web_pkgs", "bundleWebPkgs":
			s.AddField("bundle_web_pkgs")
			x.BundleWebPkgs = s.ReadBool()
		}
	})
}
...
func (m *ViteBundleMeta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.BundleWebPkgs {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.BundleWebPkgs)
		i--
		dAtA[i] = 0x38
	}
...
func (m *ViteBundleMeta) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.BundleWebPkgs)
	n += len(m.unknownFields)
	return n
}
...
func (x *ViteBundleMeta) MarshalProtoText() string {
	...
	if x.BundleWebPkgs != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "bundle_web_pkgs")
		protobuf_go_lite.TextWriteBool(&sb, x.BundleWebPkgs)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *ViteBundleMeta) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BundleWebPkgs", wireType)
			}
			var v bool
			v, iNdEx, err = protobuf_go_lite.DecodeVarintBool(dAtA, iNdEx)
			if err != nil {
