...
type DevelopmentConfig struct {
	...
	RoutePrefix string `protobuf:"bytes,9,opt,name=route_prefix,json=routePrefix,proto3" json:"routePrefix,omitempty"`
	// WebPkgIds are packages supplied by another plugin at the shared /b/pkg route.
	WebPkgIds []string `protobuf:"bytes,10,rep,name=web_pkg_ids,json=webPkgIds,proto3" json:"webPkgIds,omitempty"`
}
...
func (x *DevelopmentConfig) GetRoutePrefix() string {
	if x != nil {
...
func (x *DevelopmentConfig) GetWebPkgIds() []string {
	if x != nil {
		return x.WebPkgIds
	}
	return nil
...
func (m *DevelopmentConfig) CloneVT() *DevelopmentConfig {
	...
	r.WebPkgIds = protobuf_go_lite.CloneSlice(m.WebPkgIds)
...
func (this *DevelopmentConfig) EqualVT(that *DevelopmentConfig) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.WebPkgIds, that.WebPkgIds) {
		return false
	}
...
func (x *DevelopmentConfig) MarshalProtoJSON(s *json.MarshalState) {
	...
	if len(x.WebPkgIds) > 0 || s.HasField("webPkgIds") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("webPkgIds")
		s.WriteStringArray(x.WebPkgIds)
	}
	s.WriteObjectEnd()
}
...
func (x *DevelopmentConfig) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "web_pkg_ids", "webPkgIds":
			s.AddField("web_pkg_ids")
			if s.ReadNil() {
				x.WebPkgIds = nil
				return
			}
			x.WebPkgIds = s.ReadStringArray()
		}
	})
}
...
func (m *DevelopmentConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.WebPkgIds) > 0 {
		for iNdEx := len(m.WebPkgIds) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.WebPkgIds[iNdEx])
			i--
			dAtA[i] = 0x52
		}
	}
...
func (m *DevelopmentConfig) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringSlice(1, m.WebPkgIds)
...
func (x *DevelopmentConfig) MarshalProtoText() string {
	...
	if len(x.WebPkgIds) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "web_pkg_ids")
		for i, v := range x.WebPkgIds {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			protobuf_go_lite.TextWriteString(&sb, v)
		}
		protobuf_go_lite.TextWriteListEnd(&sb)
...
func (m *DevelopmentConfig) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WebPkgIds", wireType)
			}
			var v string
			v, iNdEx, err = protobuf_go_lite.DecodeString(dAtA, iNdEx)
			if err != nil {
			...
			m.WebPkgIds = append(m.WebPkgIds, v)
		default:
			iNdEx = preIndex
