...
type WebDocumentStatus struct {
	...
	PluginWorkersBlocked bool `protobuf:"varint,6,opt,name=plugin_workers_blocked,json=pluginWorkersBlocked,proto3" json:"pluginWorkersBlocked,omitempty"`
}
...
func (x *WebDocumentStatus) GetPluginWorkersBlocked() bool {
	if x != nil {
		return x.PluginWorkersBlocked
	}
	return false
}
...
func (m *WebDocumentStatus) CloneVT() *WebDocumentStatus {
	...
	r.Hidden = m.Hidden
	r.Closed = m.Closed
	r.PluginWorkersBlocked = m.PluginWorkersBlocked
...
func (this *WebDocumentStatus) EqualVT(that *WebDocumentStatus) bool {
	...
	if this.PluginWorkersBlocked != that.PluginWorkersBlocked {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *WebDocumentStatus) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.PluginWorkersBlocked || s.HasField("pluginWorkersBlocked") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("pluginWorkersBlocked")
		s.WriteBool(x.PluginWorkersBlocked)
	}
	s.WriteObjectEnd()
}
...
func (x *WebDocumentStatus) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "closed":
			s.AddField("closed")
			x.Closed = s.ReadBool()
		case "plugin_workers_blocked", "pluginWorkersBlocked":
			s.AddField("plugin_workers_blocked")
			x.PluginWorkersBlocked = s.ReadBool()
		}
	})
}
...
func (m *WebDocumentStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PluginWorkersBlocked {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.PluginWorkersBlocked)
		i--
		dAtA[i] = 0x30
	}
	if m.Closed {
...
func (m *WebDocumentStatus) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.PluginWorkersBlocked)
	n += len(m.unknownFields)
	return n
}
...
func (x *WebDocumentStatus) MarshalProtoText() string {
	...
	if x.PluginWorkersBlocked != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "plugin_workers_blocked")
		protobuf_go_lite.TextWriteBool(&sb, x.PluginWorkersBlocked)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *WebDocumentStatus) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PluginWorkersBlocked", wireType)
			}
			var v bool
			v, iNdEx, err = protobuf_go_lite.DecodeVarintBool(dAtA, iNdEx)
			if err != nil {
