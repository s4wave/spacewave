...
import (
	...
	entrypoint_electron_bundle "github.com/s4wave/spacewave/bldr/web/entrypoint/electron/bundle"
	entrypoint_saucer_bundle "github.com/s4wave/spacewave/bldr/web/entrypoint/saucer/bundle"
	web_pkg_vite "github.com/s4wave/spacewave/bldr/web/pkg/vite"
	web_plugin_browser_build "github.com/s4wave/spacewave/bldr/web/plugin/browser/build"
...
const basePkg = "github.com/s4wave/spacewave/bldr"
