...
func (x *NativeAppConfig) GetDesktopPresencePolicy() DesktopPresencePolicy {
	if x != nil {
...
func (x *NativeAppConfig) GetTrayIconPath() string {
	if x != nil {
...
func (x *NativeAppConfig) GetMacosTemplateTrayIconPath() string {
	if x != nil {
...
func (m *Config) CloneVT() *Config {
	...
	r.NativeApp = protobuf_go_lite.CloneVTValue(m.NativeApp)
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.NativeApp, that.NativeApp) {
		return false
	}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ElectronPkg) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ElectronPkg)
		i--
		dAtA[i] = 0x1a
	}
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ElectronPkg)
	if m.NativeApp != nil {
...
func (x *Config) MarshalProtoText() string {
	...
	if x.ElectronPkg != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "electron_pkg")
		protobuf_go_lite.TextWriteString(&sb, x.ElectronPkg)
	}
	if x.NativeApp != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "native_app")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.NativeApp)
	}
...
func (x *NativeAppConfig) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "NativeAppConfig")
	if x.AppName != "" {
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.NativeApp.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
