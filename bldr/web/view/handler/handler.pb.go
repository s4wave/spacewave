...
func (m *WebViewHandlersConfig) CloneVT() *WebViewHandlersConfig {
	...
	if rhs := m.Handlers; rhs != nil {
		r.Handlers = make([]*WebViewHandlerConfig, len(rhs))
		for k, v := range rhs {
			r.Handlers[k] = v.CloneVT()
		}
	}
...
func (this *WebViewHandlersConfig) EqualVT(that *WebViewHandlersConfig) bool {
	...
	if len(this.Handlers) != len(that.Handlers) {
		return false
	}
	for i, vx := range this.Handlers {
		vy := that.Handlers[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &WebViewHandlerConfig{}
			}
			if q == nil {
				q = &WebViewHandlerConfig{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *WebViewHandlerConfig_SetRenderMode) EqualVT(thatIface isWebViewHandlerConfig_Handler) bool {
	...
	if p, q := this.SetRenderMode, that.SetRenderMode; p != q {
		if p == nil {
			p = &view.SetRenderModeRequest{}
		}
		if q == nil {
			q = &view.SetRenderModeRequest{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *WebViewHandlerConfig_SetHtmlLinks) EqualVT(thatIface isWebViewHandlerConfig_Handler) bool {
	...
	if p, q := this.SetHtmlLinks, that.SetHtmlLinks; p != q {
		if p == nil {
			p = &view.SetHtmlLinksRequest{}
		}
		if q == nil {
			q = &view.SetHtmlLinksRequest{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (x *WebViewHandlersConfig) MarshalProtoText() string {
	...
	if len(x.Handlers) > 0 {
		...
		for i, v := range x.Handlers {
			...
			if v == nil {
				sb.WriteString((&WebViewHandlerConfig{}).MarshalProtoText())
			} else {
...
func (x *WebViewHandlerConfig) MarshalProtoText() string {
	...
	case *WebViewHandlerConfig_SetRenderMode:
		...
		if body.SetRenderMode == nil {
			sb.WriteString((&view.SetRenderModeRequest{}).MarshalProtoText())
		} else {
			sb.WriteString(body.SetRenderMode.MarshalProtoText())
		}
	case *WebViewHandlerConfig_SetHtmlLinks:
		if sb.Len() > 22 {
			sb.WriteString(" ")
		...
		if body.SetHtmlLinks == nil {
			sb.WriteString((&view.SetHtmlLinksRequest{}).MarshalProtoText())
		} else {
			sb.WriteString(body.SetHtmlLinks.MarshalProtoText())
		}
	}
	sb.WriteString("}")
	return sb.String()
...
func (m *WebViewHandlersConfig) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Handlers[len(m.Handlers)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
	...
	for iNdEx < l {
		...
		case 3:
			...
			if oneof, ok := m.Handler.(*WebViewHandlerConfig_SetRenderMode); ok {
				if err := oneof.SetRenderMode.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
		...
		case 4:
			...
			if oneof, ok := m.Handler.(*WebViewHandlerConfig_SetHtmlLinks); ok {
				if err := oneof.SetHtmlLinks.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
