...
func (m *Blob) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RawData) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RawData)))
		i--
		dAtA[i] = 0x1a
	}
	if m.TotalSize != 0 {
	...
	if m.BlobType != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.BlobType))
		i--
		dAtA[i] = 0x8
	}
...
func (m *BuildBlobOpts) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.RawHighWaterMark != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.RawHighWaterMark))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ChunkerArgs) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ChunkerType != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ChunkerType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *RabinArgs) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ChunkingMaxSize != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ChunkingMaxSize))
		i--
		dAtA[i] = 0x18
	}
	if m.ChunkingMinSize != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ChunkingMinSize))
		i--
		dAtA[i] = 0x10
	}
	if m.Pol != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Pol))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Blob) SizeVT() (n int) {
	...
	_ = l
	if m.BlobType != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.BlobType))
	}
	if m.TotalSize != 0 {
...
func (m *BuildBlobOpts) SizeVT() (n int) {
	...
	_ = l
	if m.RawHighWaterMark != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.RawHighWaterMark))
	}
	if m.ChunkerArgs != nil {
...
func (m *ChunkerArgs) SizeVT() (n int) {
	...
	_ = l
	if m.ChunkerType != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ChunkerType))
	}
	if m.RabinArgs != nil {
...
func (m *RabinArgs) SizeVT() (n int) {
	...
	_ = l
	if m.Pol != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Pol))
	}
	if m.ChunkingMinSize != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ChunkingMinSize))
	}
	if m.ChunkingMaxSize != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ChunkingMaxSize))
	}
	if m.RandomPol {
		n += 2
	}
