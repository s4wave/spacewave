...
function createBaseFile(): File {
  return { totalSize: Long.UZERO, rootBlob: undefined, rangeNonce: Long.UZERO, ranges: [] };
}
...
export const File = {
  ...
  async *encodeTransform(source: AsyncIterable<File | File[]> | Iterable<File | File[]>): AsyncIterable<Uint8Array> {
  ...
  fromJSON(object: any): File {
    return {
      ...
      rootBlob: isSet(object.rootBlob) ? Blob.fromJSON(object.rootBlob) : undefined,
      rangeNonce: isSet(object.rangeNonce) ? Long.fromValue(object.rangeNonce) : Long.UZERO,
  ...
  toJSON(message: File): unknown {
    ...
    message.rootBlob !== undefined && (obj.rootBlob = message.rootBlob ? Blob.toJSON(message.rootBlob) : undefined);
    message.rangeNonce !== undefined && (obj.rangeNonce = (message.rangeNonce || Long.UZERO).toString());
    if (message.ranges) {
  ...
  fromPartial<I extends Exact<DeepPartial<File>, I>>(object: I): File {
    ...
    message.totalSize = (object.totalSize !== undefined && object.totalSize !== null)
      ...
      : Long.UZERO;
    message.rootBlob = (object.rootBlob !== undefined && object.rootBlob !== null)
      ? Blob.fromPartial(object.rootBlob)
      : undefined;
    message.rangeNonce = (object.rangeNonce !== undefined && object.rangeNonce !== null)
...
function createBaseRange(): Range {
  return { nonce: Long.UZERO, start: Long.UZERO, length: Long.UZERO, ref: undefined };
}
