...
export const KeyFilters = {
  encode(message: KeyFilters, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<KeyFilters | KeyFilters[]> | Iterable<KeyFilters | KeyFilters[]>,
  ...
  fromJSON(object: any): KeyFilters {
    return {
      ...
      quadPrefix: isSet(object.quadPrefix) ? Quad.fromJSON(object.quadPrefix) : undefined,
      keyBloom: isSet(object.keyBloom) ? BloomFilter.fromJSON(object.keyBloom) : undefined,
    };
  },
  ...
  toJSON(message: KeyFilters): unknown {
    ...
    message.quadPrefix !== undefined &&
      (obj.quadPrefix = message.quadPrefix ? Quad.toJSON(message.quadPrefix) : undefined);
    message.keyBloom !== undefined &&
      (obj.keyBloom = message.keyBloom ? BloomFilter.toJSON(message.keyBloom) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<KeyFilters>, I>>(object: I): KeyFilters {
    const message = createBaseKeyFilters();
    message.keyPrefix = object.keyPrefix ?? "";
    message.quadPrefix = (object.quadPrefix !== undefined && object.quadPrefix !== null)
      ? Quad.fromPartial(object.quadPrefix)
      : undefined;
    message.keyBloom = (object.keyBloom !== undefined && object.keyBloom !== null)
