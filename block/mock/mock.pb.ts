...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.exampleSubBlock !== undefined) {
      SubBlock.encode(message.exampleSubBlock, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Root {
    return { exampleSubBlock: isSet(object.exampleSubBlock) ? SubBlock.fromJSON(object.exampleSubBlock) : undefined };
  },

  toJSON(message: Root): unknown {
    const obj: any = {};
    message.exampleSubBlock !== undefined &&
      (obj.exampleSubBlock = message.exampleSubBlock ? SubBlock.toJSON(message.exampleSubBlock) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    const message = createBaseRoot();
    message.exampleSubBlock = (object.exampleSubBlock !== undefined && object.exampleSubBlock !== null)
...
export const SubBlock = {
  encode(message: SubBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<SubBlock | SubBlock[]> | Iterable<SubBlock | SubBlock[]>,
  ...
  fromJSON(object: any): SubBlock {
    return { examplePtr: isSet(object.examplePtr) ? BlockRef.fromJSON(object.examplePtr) : undefined };
  },

  toJSON(message: SubBlock): unknown {
    const obj: any = {};
    message.examplePtr !== undefined &&
      (obj.examplePtr = message.examplePtr ? BlockRef.toJSON(message.examplePtr) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<SubBlock>, I>>(object: I): SubBlock {
    const message = createBaseSubBlock();
    message.examplePtr = (object.examplePtr !== undefined && object.examplePtr !== null)
