...
export const MsgpackBlob = {
  encode(message: MsgpackBlob, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<MsgpackBlob | MsgpackBlob[]> | Iterable<MsgpackBlob | MsgpackBlob[]>,
  ...
  toJSON(message: MsgpackBlob): unknown {
    const obj: any = {};
    message.blob !== undefined && (obj.blob = message.blob ? Blob.toJSON(message.blob) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgpackBlob>, I>>(object: I): MsgpackBlob {
    const message = createBaseMsgpackBlob();
    message.blob = (object.blob !== undefined && object.blob !== null) ? Blob.fromPartial(object.blob) : undefined;
    return message;
  },
};
