...
const ::uint32_t
    TableStruct_github_2ecom_2faperturerobotics_2fhydra_2fblock_2fstore_2fbucket_2fconfig_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::block::store::bucket::Config, _impl_.block_store_id_),
        PROTOBUF_FIELD_OFFSET(::block::store::bucket::Config, _impl_.bucket_config_),
        PROTOBUF_FIELD_OFFSET(::block::store::bucket::Config, _impl_.bucket_store_id_),
        PROTOBUF_FIELD_OFFSET(::block::store::bucket::Config, _impl_.not_found_if_idle_),
        0,
        2,
        1,
        3,
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::block::store::bucket::Config)},
};
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fblock_2fstore_2fbucket_2fconfig_2eproto = {
    ...
    "github.com/aperturerobotics/hydra/block/store/bucket/config.proto",
...
void Config::clear_bucket_config() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.bucket_config_ != nullptr) _impl_.bucket_config_->Clear();
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:block.store.bucket.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::block::store::bucket::Config& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        block_store_id_(arena, from.block_store_id_),
        bucket_store_id_(arena, from.bucket_store_id_) {}
...
Config::Config(
  ...
  _impl_.bucket_config_ = (CheckHasBit(cached_has_bits, 0x00000004U))
                ? ::google::protobuf::Message::CopyConstruct(arena, *from._impl_.bucket_config_)
                : nullptr;
  _impl_.not_found_if_idle_ = from._impl_.not_found_if_idle_;

  // @@protoc_insertion_point(copy_constructor:block.store.bucket.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : _cached_size_{0},
        ...
        bucket_store_id_(arena) {}

inline void Config::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
  ::memset(reinterpret_cast<char*>(&_impl_) +
               offsetof(Impl_, bucket_config_),
           0,
           offsetof(Impl_, not_found_if_idle_) -
               offsetof(Impl_, bucket_config_) +
               sizeof(Impl_::not_found_if_idle_));
}
Config::~Config() {
  // @@protoc_insertion_point(destructor:block.store.bucket.Config)
  SharedDtor(*this);
}
inline void Config::SharedDtor(MessageLite& self) {
  ...
  this_._impl_.bucket_store_id_.Destroy();
  delete this_._impl_.bucket_config_;
  this_._impl_.~Impl_();
}
...
Config::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::block::store::bucket::Config>(),  // to_prefetch
    ...
    {::_pbi::TcParser::FastMtS1,
     {18, 2, 0,
      PROTOBUF_FIELD_OFFSET(Config, _impl_.bucket_config_)}},
    // string bucket_store_id = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 1, 0,
      PROTOBUF_FIELD_OFFSET(Config, _impl_.bucket_store_id_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string block_store_id = 1;
    ...
    // .bucket.Config bucket_config = 2;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.bucket_config_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // string bucket_store_id = 3;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.bucket_store_id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // bool not_found_if_idle = 4;
  ...
  {{
    "\31\16\0\17\0\0\0\0"
    "block.store.bucket.Config"
    "block_store_id"
    "bucket_store_id"
  }},
};
PROTOBUF_NOINLINE void Config::Clear() {
// @@protoc_insertion_point(message_clear_start:block.store.bucket.Config)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000007U)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
      _impl_.bucket_store_id_.ClearNonDefaultToEmpty();
    }
    if (CheckHasBit(cached_has_bits, 0x00000004U)) {
      ABSL_DCHECK(_impl_.bucket_config_ != nullptr);
      _impl_.bucket_config_->Clear();
    }
  }
...
::uint8_t* PROTOBUF_NONNULL Config::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:block.store.bucket.Config)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_block_store_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "block.store.bucket.Config.block_store_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        2, *this_._impl_.bucket_config_, this_._impl_.bucket_config_->GetCachedSize(), target,
        stream);
  }

  // string bucket_store_id = 3;
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_bucket_store_id().empty()) {
      const ::std::string& _s = this_._internal_bucket_store_id();
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "block.store.bucket.Config.bucket_store_id");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:block.store.bucket.Config)
  return target;
}
...
::size_t Config::ByteSizeLong() const {
  const Config& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:block.store.bucket.Config)
  ::size_t total_size = 0;
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x0000000fU)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
      if (!this_._internal_bucket_store_id().empty()) {
        total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(
                                        this_._internal_bucket_store_id());
      }
    }
    // .bucket.Config bucket_config = 2;
    if (CheckHasBit(cached_has_bits, 0x00000004U)) {
      total_size += 1 +
                    ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.bucket_config_);
    }
    // bool not_found_if_idle = 4;
    if (CheckHasBit(cached_has_bits, 0x00000008U)) {
      if (this_._internal_not_found_if_idle() != 0) {
...
void Config::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:block.store.bucket.Config)
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x0000000fU)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
      if (!from._internal_bucket_store_id().empty()) {
        _this->_internal_set_bucket_store_id(from._internal_bucket_store_id());
      } else {
        if (_this->_impl_.bucket_store_id_.IsDefault()) {
          _this->_internal_set_bucket_store_id("");
        }
      }
    }
    if (CheckHasBit(cached_has_bits, 0x00000004U)) {
      ABSL_DCHECK(from._impl_.bucket_config_ != nullptr);
      if (_this->_impl_.bucket_config_ == nullptr) {
        _this->_impl_.bucket_config_ = ::google::protobuf::Message::CopyConstruct(arena, *from._impl_.bucket_config_);
      } else {
        _this->_impl_.bucket_config_->MergeFrom(*from._impl_.bucket_config_);
      }
    }
    if (CheckHasBit(cached_has_bits, 0x00000008U)) {
...
void Config::CopyFrom(const Config& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:block.store.bucket.Config)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Config::InternalSwap(Config* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.bucket_store_id_, &other->_impl_.bucket_store_id_, arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Config, _impl_.not_found_if_idle_)
      + sizeof(Config::_impl_.not_found_if_idle_)
      - PROTOBUF_FIELD_OFFSET(Config, _impl_.bucket_config_)>(
          reinterpret_cast<char*>(&_impl_.bucket_config_),
          reinterpret_cast<char*>(&other->_impl_.bucket_config_));
}
