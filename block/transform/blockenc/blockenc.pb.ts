...
import { BlockEnc, blockEncFromJSON, blockEncToJSON } from "../../../util/blockenc/blockenc.pb.js";
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.blockEnc !== 0) {
      writer.uint32(8).int32(message.blockEnc);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Config {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.blockEnc = reader.int32() as any;
          break;
        case 2:
  ...
  toJSON(message: Config): unknown {
    const obj: any = {};
    message.blockEnc !== undefined && (obj.blockEnc = blockEncToJSON(message.blockEnc));
