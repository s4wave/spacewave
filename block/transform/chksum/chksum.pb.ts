...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return { chksumType: isSet(object.chksumType) ? chksumTypeFromJSON(object.chksumType) : 0 };
  },

  toJSON(message: Config): unknown {
    const obj: any = {};
    message.chksumType !== undefined && (obj.chksumType = chksumTypeToJSON(message.chksumType));
    return obj;
  },
