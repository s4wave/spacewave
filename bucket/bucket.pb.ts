...
export interface ApplyBucketConfigResult {
  ...
  bucketConf: Config | undefined
  /** OldBucketConf returns the previous bucket configuration. */
  oldBucketConf: Config | undefined
...
export interface ObjectRef {
   ...
   */
  transformConfRef: BlockRef | undefined
  ...
  fromJSON(object: any): Config {
    return {
      ...
      lookup: isSet(object.lookup)
        ? LookupConfig.fromJSON(object.lookup)
        : undefined,
    }
  },
  ...
  fromJSON(object: any): ApplyBucketConfigResult {
    return {
      ...
      bucketConf: isSet(object.bucketConf)
        ...
        : undefined,
      oldBucketConf: isSet(object.oldBucketConf)
        ? Config.fromJSON(object.oldBucketConf)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<ApplyBucketConfigResult>, I>>(
    ...
    message.bucketConf =
      object.bucketConf !== undefined && object.bucketConf !== null
        ...
        : undefined
    message.oldBucketConf =
      object.oldBucketConf !== undefined && object.oldBucketConf !== null
...
export const ObjectRef = {
  ...
  fromJSON(object: any): ObjectRef {
    return {
      ...
      transformConfRef: isSet(object.transformConfRef)
        ...
        : undefined,
      transformConf: isSet(object.transformConf)
        ? Config1.fromJSON(object.transformConf)
        : undefined,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ObjectRef>, I>>(
    ...
    message.bucketId = object.bucketId ?? ''
    message.transformConfRef =
      object.transformConfRef !== undefined && object.transformConfRef !== null
        ? BlockRef.fromPartial(object.transformConfRef)
        : undefined
    message.transformConf =
      object.transformConf !== undefined && object.transformConf !== null
