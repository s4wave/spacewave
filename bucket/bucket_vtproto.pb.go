...
func (m *ReconcilerConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Controller != nil {
		if marshalto, ok := interface{}(m.Controller).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *ObjectRef) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TransformConf != nil {
		if marshalto, ok := interface{}(m.TransformConf).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.TransformConfRef != nil {
		if marshalto, ok := interface{}(m.TransformConfRef).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
