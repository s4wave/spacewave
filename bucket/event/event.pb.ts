...
export const Event = {
  ...
  fromJSON(object: any): Event {
    return {
      ...
      putBlock: isSet(object.putBlock) ? PutBlock.fromJSON(object.putBlock) : undefined,
      rmBlock: isSet(object.rmBlock) ? RmBlock.fromJSON(object.rmBlock) : undefined,
    };
  },
  ...
  toJSON(message: Event): unknown {
    ...
    message.putBlock !== undefined && (obj.putBlock = message.putBlock ? PutBlock.toJSON(message.putBlock) : undefined);
    message.rmBlock !== undefined && (obj.rmBlock = message.rmBlock ? RmBlock.toJSON(message.rmBlock) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Event>, I>>(object: I): Event {
    ...
    message.putBlock = (object.putBlock !== undefined && object.putBlock !== null)
      ? PutBlock.fromPartial(object.putBlock)
      : undefined;
    message.rmBlock = (object.rmBlock !== undefined && object.rmBlock !== null)
...
export const BlockCommon = {
  encode(message: BlockCommon, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.bucketId !== "") {
  ...
  async *encodeTransform(
    source: AsyncIterable<BlockCommon | BlockCommon[]> | Iterable<BlockCommon | BlockCommon[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): BlockCommon {
    return {
      ...
      bucketConfRev: isSet(object.bucketConfRev) ? Number(object.bucketConfRev) : 0,
  ...
  toJSON(message: BlockCommon): unknown {
    ...
    message.bucketConfRev !== undefined && (obj.bucketConfRev = Math.round(message.bucketConfRev));
    message.blockRef !== undefined && (obj.blockRef = message.blockRef ? BlockRef.toJSON(message.blockRef) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<BlockCommon>, I>>(object: I): BlockCommon {
    const message = createBaseBlockCommon();
...
export const PutBlock = {
  encode(message: PutBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<PutBlock | PutBlock[]> | Iterable<PutBlock | PutBlock[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): PutBlock {
    return { blockCommon: isSet(object.blockCommon) ? BlockCommon.fromJSON(object.blockCommon) : undefined };
  },

  toJSON(message: PutBlock): unknown {
    const obj: any = {};
    message.blockCommon !== undefined &&
      (obj.blockCommon = message.blockCommon ? BlockCommon.toJSON(message.blockCommon) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PutBlock>, I>>(object: I): PutBlock {
    const message = createBasePutBlock();
    message.blockCommon = (object.blockCommon !== undefined && object.blockCommon !== null)
...
export const RmBlock = {
  encode(message: RmBlock, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.blockCommon !== undefined) {
      BlockCommon.encode(message.blockCommon, writer.uint32(10).fork()).ldelim();
    }
    return writer;
