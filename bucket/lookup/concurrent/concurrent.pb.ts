...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      bucketConf: isSet(object.bucketConf) ? Config1.fromJSON(object.bucketConf) : undefined,
      notFoundBehavior: isSet(object.notFoundBehavior) ? notFoundBehaviorFromJSON(object.notFoundBehavior) : 0,
      putBlockBehavior: isSet(object.putBlockBehavior) ? putBlockBehaviorFromJSON(object.putBlockBehavior) : 0,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.bucketConf !== undefined &&
      (obj.bucketConf = message.bucketConf ? Config1.toJSON(message.bucketConf) : undefined);
    message.notFoundBehavior !== undefined && (obj.notFoundBehavior = notFoundBehaviorToJSON(message.notFoundBehavior));
    message.putBlockBehavior !== undefined && (obj.putBlockBehavior = putBlockBehaviorToJSON(message.putBlockBehavior));
    return obj;
  },
