...
export const Root = {
  ...
  fromJSON(object: any): Root {
    return { examplePtr: isSet(object.examplePtr) ? ObjectRef.fromJSON(object.examplePtr) : undefined };
  },

  toJSON(message: Root): unknown {
    const obj: any = {};
    message.examplePtr !== undefined &&
      (obj.examplePtr = message.examplePtr ? ObjectRef.toJSON(message.examplePtr) : undefined);
    return obj;
  },
