...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto = nullptr;
const ::uint32_t
    TableStruct_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::cdn::world::controller::Config)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::cdn::world::controller::_Config_default_instance_._instance,
};
const char descriptor_table_protodef_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto = {
    ...
    TableStruct_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto::offsets,
    file_level_enum_descriptors_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto,
    file_level_service_descriptors_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto,
};
namespace cdn {
namespace world {
namespace controller {
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:cdn.world.controller.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::cdn::world::controller::Config& from_msg)
...
constexpr auto Config::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto,
      nullptr,  // tracker
  };
}
...
Config::_table_ = {
  {
    ...
    // string space_id = 2;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.space_id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string cdn_base_url = 3;
...
// @@protoc_insertion_point(message_clear_start:cdn.world.controller.Config)
...
::uint8_t* PROTOBUF_NONNULL Config::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:cdn.world.controller.Config)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_engine_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "cdn.world.controller.Config.engine_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_space_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "cdn.world.controller.Config.space_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    if (!this_._internal_cdn_base_url().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "cdn.world.controller.Config.cdn_base_url");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000008U)) {
    if (!this_._internal_pointer_ttl_dur().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "cdn.world.controller.Config.pointer_ttl_dur");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cdn.world.controller.Config)
  return target;
}
...
::size_t Config::ByteSizeLong() const {
  const Config& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:cdn.world.controller.Config)
  ::size_t total_size = 0;
...
void Config::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:cdn.world.controller.Config)
...
void Config::CopyFrom(const Config& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:cdn.world.controller.Config)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fcore_2fcdn_2fworld_2fcontroller_2fcontroller_2eproto),
         ::std::false_type{});
