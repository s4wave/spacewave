...
#ifndef github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto_2epb_2eh
#define github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto
...
struct TableStruct_github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto;
}  // extern "C"
namespace debug {
namespace bridge {
class Config;
...
/* @@protoc_insertion_point(class_definition:debug.bridge.Config) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "debug.bridge.Config"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:debug.bridge.Config)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto;
};
...
// string socket_path = 1;
inline void Config::clear_socket_path() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.socket_path_.ClearToEmpty();
  ClearHasBit(_impl_._has_bits_[0],
                  0x00000001U);
}
inline const ::std::string& Config::socket_path() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:debug.bridge.Config.socket_path)
  return _internal_socket_path();
}
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void Config::set_socket_path(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  _impl_.socket_path_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:debug.bridge.Config.socket_path)
}
inline ::std::string* PROTOBUF_NONNULL Config::mutable_socket_path()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  ::std::string* _s = _internal_mutable_socket_path();
  // @@protoc_insertion_point(field_mutable:debug.bridge.Config.socket_path)
  return _s;
}
inline const ::std::string& Config::_internal_socket_path() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.socket_path_.Get();
}
inline void Config::_internal_set_socket_path(const ::std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.socket_path_.Set(value, GetArena());
}
inline ::std::string* PROTOBUF_NONNULL Config::_internal_mutable_socket_path() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.socket_path_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE Config::release_socket_path() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:debug.bridge.Config.socket_path)
...
inline void Config::set_allocated_socket_path(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  } else {
  ...
  // @@protoc_insertion_point(field_set_allocated:debug.bridge.Config.socket_path)
}
...
#endif  // github_2ecom_2fs4wave_2fspacewave_2fcore_2fdebug_2fbridge_2fconfig_2eproto_2epb_2eh
