...
// source: github.com/s4wave/spacewave/core/plugin/space/runtime/runtime.proto
...
import (
	...
	space "github.com/s4wave/spacewave/core/plugin/space"
)
...
func (x *Config) GetSpace() *space.Config {
	if x != nil {
		return x.Space
	}
	return nil
...
func (x *Config) MarshalProtoJSON(s *json.MarshalState) {
	...
	s.WriteObjectStart()
	var wroteField bool
	if x.Space != nil || s.HasField("space") {
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Space == nil {
				m.Space = &space.Config{}
			}
			if err := m.Space.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
