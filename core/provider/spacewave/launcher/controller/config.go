...
func (c *Config) ParseInitDistConfig(projectID string, signerPeerIDs []peer.ID) (distConfig *spacewave_launcher.DistConfig, confMsg string, confPeerID peer.ID, err error) {
