...
func (this *TransferState) EqualVT(that *TransferState) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Spaces, that.Spaces, func() *SpaceTransferState { return &SpaceTransferState{} }) {
		return false
	}
	if this.ErrorMessage != that.ErrorMessage {
		return false
...
func (m *TransferCheckpoint) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.CurrentSpaceIndex)
	n += len(m.unknownFields)
	return n
}
...
func (x *SpaceTransferState) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SpaceTransferState")
	if x.SharedObjectId != "" {
	...
	if x.Phase != 0 {
		...
		protobuf_go_lite.TextWriteStringer(&sb, TransferPhase(x.Phase))
	}
	if x.BlocksCopied != 0 {
	...
	if x.BlocksTotal != 0 {
		...
		protobuf_go_lite.TextWriteUint(&sb, x.BlocksTotal)
	}
	if x.ErrorMessage != "" {
...
func (x *TransferState) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "TransferState")
	if x.Mode != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "mode")
		protobuf_go_lite.TextWriteStringer(&sb, TransferMode(x.Mode))
	}
	if x.Phase != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "phase")
		protobuf_go_lite.TextWriteStringer(&sb, TransferPhase(x.Phase))
	...
	if len(x.Spaces) > 0 {
		...
		for i, v := range x.Spaces {
			...
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &SpaceTransferState{})
			} else {
...
func (x *TransferCheckpoint) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "TransferCheckpoint")
	if x.State != nil {
	...
	if x.CurrentSpaceIndex != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "current_space_index")
		protobuf_go_lite.TextWriteUint(&sb, x.CurrentSpaceIndex)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
