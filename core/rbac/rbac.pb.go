...
func (m *RbacRule) CloneVT() *RbacRule {
	...
	r.Verbs = protobuf_go_lite.CloneSlice(m.Verbs)
...
func (m *RbacRole) CloneVT() *RbacRole {
	...
	r.Builtin = m.Builtin
	r.Rules = protobuf_go_lite.CloneVTSlice(m.Rules)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *RbacRule) EqualVT(that *RbacRule) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.Verbs, that.Verbs) {
		return false
	}
...
func (this *RbacRole) EqualVT(that *RbacRole) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Rules, that.Rules, func() *RbacRule { return &RbacRule{} }) {
		return false
	}
...
func (this *RbacConfig) EqualVT(that *RbacConfig) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Roles, that.Roles, func() *RbacRole { return &RbacRole{} }) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Bindings, that.Bindings, func() *RbacRoleBinding { return &RbacRoleBinding{} }) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *RbacRule) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Verbs) > 0 {
		for iNdEx := len(m.Verbs) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.Verbs[iNdEx])
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *RbacRole) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Builtin {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.Builtin)
		i--
		dAtA[i] = 0x20
	}
	if len(m.Rules) > 0 {
...
func (m *RbacRoleBinding) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SubjectId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.SubjectId)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.RoleId) > 0 {
...
func (m *RbacRule) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringSlice(1, m.Verbs)
...
func (m *RbacRole) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Builtin)
	n += len(m.unknownFields)
	return n
}
...
func (m *RbacRoleBinding) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.SubjectId)
...
func (x *RbacRole) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "RbacRole")
	if x.Id != "" {
	...
	if len(x.Rules) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "rules")
		for i, v := range x.Rules {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &RbacRule{})
			} else {
	...
	if x.Builtin != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "builtin")
		protobuf_go_lite.TextWriteBool(&sb, x.Builtin)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *RbacRoleBinding) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "RbacRoleBinding")
	if x.Id != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "id")
		protobuf_go_lite.TextWriteString(&sb, x.Id)
	}
	...
	if x.SubjectId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "subject_id")
		protobuf_go_lite.TextWriteString(&sb, x.SubjectId)
	}
	if x.Scope != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "scope")
		protobuf_go_lite.TextWriteStringer(&sb, RbacScope(x.Scope))
	}
	if x.ScopeId != "" {
...
func (x *RbacConfig) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "RbacConfig")
	if len(x.Roles) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "roles")
		for i, v := range x.Roles {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &RbacRole{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
	...
	if len(x.Bindings) > 0 {
		...
		for i, v := range x.Bindings {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &RbacRoleBinding{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
...
func (m *RbacRole) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.Rules[len(m.Rules)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
