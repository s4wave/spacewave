...
#ifndef github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto_2epb_2eh
#define github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto
...
struct TableStruct_github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto;
}  // extern "C"
namespace resource {
namespace root {
...
/* @@protoc_insertion_point(class_definition:resource.root.controller.Config) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "resource.root.controller.Config"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:resource.root.controller.Config)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto;
};
...
inline const ::std::string& Config::service_id() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:resource.root.controller.Config.service_id)
...
PROTOBUF_ALWAYS_INLINE void Config::set_service_id(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:resource.root.controller.Config.service_id)
}
inline ::std::string* PROTOBUF_NONNULL Config::mutable_service_id()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  ::std::string* _s = _internal_mutable_service_id();
  // @@protoc_insertion_point(field_mutable:resource.root.controller.Config.service_id)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Config::release_service_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:resource.root.controller.Config.service_id)
...
inline void Config::set_allocated_service_id(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:resource.root.controller.Config.service_id)
}
...
#endif  // github_2ecom_2fs4wave_2fspacewave_2fcore_2fresource_2froot_2fcontroller_2fconfig_2eproto_2epb_2eh
