...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SessionControllerId) > 0 {
		i -= len(m.SessionControllerId)
		copy(dAtA[i:], m.SessionControllerId)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.SessionControllerId)))
		i--
		dAtA[i] = 0xa
	}
...
func (x *Config) MarshalProtoText() string {
	...
	if x.SessionControllerId != "" {
		...
		sb.WriteString("session_controller_id: ")
		sb.WriteString(strconv.Quote(x.SessionControllerId))
	}
	if x.VolumeId != "" {
		if sb.Len() > 8 {
			sb.WriteString(" ")
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.SessionControllerId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
