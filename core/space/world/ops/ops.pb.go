...
type SetSpaceIndexPathOp struct {
	unknownFields []byte
	...
	ExpectedIndexPath *string `protobuf:"bytes,3,opt,name=expected_index_path,json=expectedIndexPath,proto3,oneof" json:"expectedIndexPath,omitempty"`
}

func (x *SetSpaceIndexPathOp) Reset() {
	*x = SetSpaceIndexPathOp{}
}

func (*SetSpaceIndexPathOp) ProtoMessage() {}

func (x *SetSpaceIndexPathOp) GetIndexPath() string {
	if x != nil {
		return x.IndexPath
	}
	return ""
...
func (x *SetSpaceIndexPathOp) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *SetSpaceIndexPathOp) GetExpectedIndexPath() string {
	if x != nil && x.ExpectedIndexPath != nil {
		return *x.ExpectedIndexPath
	}
	return ""
}
...
func (m *SetSpaceIndexPathOp) CloneVT() *SetSpaceIndexPathOp {
	if m == nil {
		return (*SetSpaceIndexPathOp)(nil)
	}
	r := new(SetSpaceIndexPathOp)
	r.IndexPath = m.IndexPath
	r.Timestamp = protobuf_go_lite.CloneVTValue(m.Timestamp)
	r.ExpectedIndexPath = protobuf_go_lite.ClonePtr(m.ExpectedIndexPath)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *SetSpaceIndexPathOp) CloneMessageVT() protobuf_go_lite.CloneMessage {
	return m.CloneVT()
}
...
func (this *SetSpaceIndexPathOp) EqualVT(that *SetSpaceIndexPathOp) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if !protobuf_go_lite.EqualPtr(this.ExpectedIndexPath, that.ExpectedIndexPath) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *SetSpaceIndexPathOp) EqualMessageVT(thatMsg any) bool {
	that, ok := thatMsg.(*SetSpaceIndexPathOp)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
// MarshalProtoJSON marshals the SetSpaceIndexPathOp message to JSON.
func (x *SetSpaceIndexPathOp) MarshalProtoJSON(s *json.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
	...
	if x.ExpectedIndexPath != nil {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("expectedIndexPath")
		s.WriteString(*x.ExpectedIndexPath)
	}
	s.WriteObjectEnd()
}

// MarshalJSON marshals the SetSpaceIndexPathOp to JSON.
func (x *SetSpaceIndexPathOp) MarshalJSON() ([]byte, error) {
	return json.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the SetSpaceIndexPathOp message from JSON.
func (x *SetSpaceIndexPathOp) UnmarshalProtoJSON(s *json.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
		...
		case "timestamp":
			...
			x.Timestamp = &timestamppb.Timestamp{}
			x.Timestamp.UnmarshalProtoJSON(s.WithField("timestamp", true))
		case "expected_index_path", "expectedIndexPath":
			s.AddField("expected_index_path")
			if s.ReadNil() {
				x.ExpectedIndexPath = nil
				return
			}
			t := s.ReadString()
			x.ExpectedIndexPath = &t
		}
	})
}

// UnmarshalJSON unmarshals the SetSpaceIndexPathOp from JSON.
func (x *SetSpaceIndexPathOp) UnmarshalJSON(b []byte) error {
	return json.DefaultUnmarshalerConfig.Unmarshal(b, x)
}
...
func (m *SetSpaceIndexPathOp) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *SetSpaceIndexPathOp) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *SetSpaceIndexPathOp) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.ExpectedIndexPath != nil {
		i = protobuf_go_lite.EncodeString(dAtA, i, *m.ExpectedIndexPath)
		i--
		dAtA[i] = 0x1a
	}
	if m.Timestamp != nil {
...
func (m *SetSpaceIndexPathOp) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += protobuf_go_lite.SizeStringPtr(1, m.ExpectedIndexPath)
	n += len(m.unknownFields)
	return n
}
...
func (x *SetSpaceIndexPathOp) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SetSpaceIndexPathOp")
	if x.IndexPath != "" {
	...
	if x.ExpectedIndexPath != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "expected_index_path")
		protobuf_go_lite.TextWriteString(&sb, *x.ExpectedIndexPath)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}

func (x *SetSpaceIndexPathOp) String() string {
	return x.MarshalProtoText()
}
...
func (m *SetSpaceIndexPathOp) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	var err error
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetSpaceIndexPathOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetSpaceIndexPathOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpectedIndexPath", wireType)
			}
			var v string
			v, iNdEx, err = protobuf_go_lite.DecodeString(dAtA, iNdEx)
			if err != nil {
