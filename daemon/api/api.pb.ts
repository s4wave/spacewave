...
export const PutBucketConfigRequest = {
  ...
  fromJSON(object: any): PutBucketConfigRequest {
    return {
      config: isSet(object.config)
        ...
        : undefined,
      volumeIdRegex: isSet(object.volumeIdRegex)
        ? String(object.volumeIdRegex)
        : '',
    }
  },
  ...
  toJSON(message: PutBucketConfigRequest): unknown {
    ...
    message.volumeIdRegex !== undefined &&
      (obj.volumeIdRegex = message.volumeIdRegex)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<PutBucketConfigRequest>, I>>(
    object: I
  ): PutBucketConfigRequest {
    const message = createBasePutBucketConfigRequest()
    message.config =
...
export const PutBucketConfigResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<PutBucketConfigResponse>, I>>(
    object: I
  ): PutBucketConfigResponse {
    const message = createBasePutBucketConfigResponse()
    message.applyConfResult =
...
export interface HydraDaemonService {
  ...
  PutBucketConfig(
    request: PutBucketConfigRequest
  ): AsyncIterable<PutBucketConfigResponse>
