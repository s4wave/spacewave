...
func (m *ListVolumesResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Volumes) > 0 {
		for iNdEx := len(m.Volumes) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Volumes[iNdEx]).(interface {
...
func (m *ListBucketsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Buckets) > 0 {
		for iNdEx := len(m.Buckets) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Buckets[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
...
func (m *PutBucketConfigResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ApplyConfResult != nil {
		if marshalto, ok := interface{}(m.ApplyConfResult).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *BucketOpRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PutOpts != nil {
		if marshalto, ok := interface{}(m.PutOpts).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.BucketOpArgs != nil {
		if marshalto, ok := interface{}(m.BucketOpArgs).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
