...
func (m *File) CloneVT() *File {
	...
	r.RootBlob = protobuf_go_lite.CloneVTValue(m.RootBlob)
...
func (this *File) EqualVT(that *File) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.RootBlob, that.RootBlob) {
		return false
	}
	if this.RangeNonce != that.RangeNonce {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Ranges, that.Ranges, func() *Range { return &Range{} }) {
		return false
	}
...
func (m *File) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.RangeNonce)
...
func (x *File) MarshalProtoText() string {
	...
	if x.RootBlob != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "root_blob")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.RootBlob)
	}
	if x.RangeNonce != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "range_nonce")
		protobuf_go_lite.TextWriteUint(&sb, x.RangeNonce)
	}
	if len(x.Ranges) > 0 {
		...
		for i, v := range x.Ranges {
			...
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &Range{})
			} else {
...
func (m *File) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.RootBlob.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			m.RangeNonce = 0
			m.RangeNonce, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 4:
...
func (m *Range) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Length = 0
			m.Length, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 4:
