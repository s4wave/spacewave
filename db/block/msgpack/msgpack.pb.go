...
func (m *MsgpackBlob) CloneVT() *MsgpackBlob {
	...
	r := new(MsgpackBlob)
	r.Blob = protobuf_go_lite.CloneVTValue(m.Blob)
...
func (this *MsgpackBlob) EqualVT(that *MsgpackBlob) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.Blob, that.Blob) {
		return false
	}
...
func (x *MsgpackBlob) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MsgpackBlob")
	if x.Blob != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "blob")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Blob)
	}
...
func (m *MsgpackBlob) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Blob.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
