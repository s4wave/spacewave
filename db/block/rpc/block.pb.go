...
type GetBlockRequest struct {
	...
	WithRefs bool `protobuf:"varint,2,opt,name=with_refs,json=withRefs,proto3" json:"withRefs,omitempty"`
}
...
func (x *GetBlockRequest) GetWithRefs() bool {
	if x != nil {
		return x.WithRefs
	}
	return false
...
type GetBlockResponse struct {
	...
	Refs []*block.BlockRef `protobuf:"bytes,4,rep,name=refs,proto3" json:"refs,omitempty"`
	// RefsKnown indicates the store recorded the block's outgoing refs.
	RefsKnown bool `protobuf:"varint,5,opt,name=refs_known,json=refsKnown,proto3" json:"refsKnown,omitempty"`
}
...
func (x *GetBlockResponse) GetRefs() []*block.BlockRef {
	if x != nil {
		return x.Refs
	}
	return nil
...
func (x *GetBlockResponse) GetRefsKnown() bool {
	if x != nil {
		return x.RefsKnown
	}
	return false
...
func (this *GetBlockRequest) EqualVT(that *GetBlockRequest) bool {
	...
	if this.WithRefs != that.WithRefs {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *GetBlockRequest) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.WithRefs || s.HasField("withRefs") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("withRefs")
		s.WriteBool(x.WithRefs)
	}
	s.WriteObjectEnd()
}
...
func (x *GetBlockRequest) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "ref":
			...
			x.Ref = &block.BlockRef{}
			x.Ref.UnmarshalProtoJSON(s.WithField("ref", true))
		case "with_refs", "withRefs":
			s.AddField("with_refs")
			x.WithRefs = s.ReadBool()
		}
	})
}
...
func (x *GetBlockResponse) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.RefsKnown || s.HasField("refsKnown") {
		s.WriteMoreIf(&wroteField)
...
func (m *GetBlockRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.WithRefs {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.WithRefs)
		i--
		dAtA[i] = 0x10
	}
	if m.Ref != nil {
...
func (m *GetBlockRequest) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.WithRefs)
	n += len(m.unknownFields)
	return n
}
...
func (x *GetBlockRequest) MarshalProtoText() string {
	...
	if x.WithRefs != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "with_refs")
		protobuf_go_lite.TextWriteBool(&sb, x.WithRefs)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *GetBlockRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithRefs", wireType)
			}
			var v bool
			v, iNdEx, err = protobuf_go_lite.DecodeVarintBool(dAtA, iNdEx)
			if err != nil {
...
func (m *GetBlockResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RefsKnown", wireType)
			}
			var v bool
			v, iNdEx, err = protobuf_go_lite.DecodeVarintBool(dAtA, iNdEx)
			if err != nil {
