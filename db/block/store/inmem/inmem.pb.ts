...
// @generated from file github.com/s4wave/spacewave/db/block/store/inmem/inmem.proto (package block.store.inmem, syntax proto3)
/* eslint-disable */
...
export const Config: MessageType<Config> = createMessageType({
  ...
  fields: [
    ...
    { no: 4, name: 'hash_get', kind: 'scalar', T: ScalarType.BOOL },
    {
      no: 5,
      name: 'bucket_ids',
      kind: 'scalar',
