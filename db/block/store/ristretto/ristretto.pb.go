...
func (m *Config) CloneVT() *Config {
	...
	r.Verbose = m.Verbose
	r.Ristretto = protobuf_go_lite.CloneVTValue(m.Ristretto)
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.Ristretto, that.Ristretto) {
		return false
	}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HashGet {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.HashGet)
		i--
		dAtA[i] = 0x40
	}
	if m.Verbose {
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.HashGet)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.Ristretto != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ristretto")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Ristretto)
	}
	if x.KvKeyOpts != nil {
	...
	if x.HashGet != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "hash_get")
		protobuf_go_lite.TextWriteBool(&sb, x.HashGet)
	}
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Ristretto.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
