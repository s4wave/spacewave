...
type BlockObject struct {
	...
	Refs []*block.BlockRef `protobuf:"bytes,2,rep,name=refs,proto3" json:"refs,omitempty"`
}

func (x *BlockObject) Reset() {
	*x = BlockObject{}
}

func (*BlockObject) ProtoMessage() {}

func (x *BlockObject) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *BlockObject) GetRefs() []*block.BlockRef {
	if x != nil {
		return x.Refs
	}
	return nil
...
func (m *BlockObject) CloneVT() *BlockObject {
	if m == nil {
...
func (m *BlockObject) CloneMessageVT() protobuf_go_lite.CloneMessage {
	return m.CloneVT()
}
...
func (this *BlockObject) EqualVT(that *BlockObject) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
// MarshalProtoJSON marshals the BlockObject message to JSON.
func (x *BlockObject) MarshalProtoJSON(s *json.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
...
// MarshalJSON marshals the BlockObject to JSON.
func (x *BlockObject) MarshalJSON() ([]byte, error) {
	return json.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the BlockObject message from JSON.
func (x *BlockObject) UnmarshalProtoJSON(s *json.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
...
func (m *BlockObject) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BlockObject) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BlockObject) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BlockObject) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (x *BlockObject) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "BlockObject")
	if len(x.Data) != 0 {
...
func (m *BlockObject) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	var err error
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlockObject: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlockObject: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
