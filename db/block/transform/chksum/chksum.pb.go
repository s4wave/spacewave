...
func (m *Config) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.ChksumType)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.ChksumType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "chksum_type")
		protobuf_go_lite.TextWriteStringer(&sb, ChksumType(x.ChksumType))
	}
