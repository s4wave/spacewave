...
#ifndef github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto_2epb_2eh
#define github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto
...
struct TableStruct_github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto;
}  // extern "C"
namespace transform {
namespace gzip {
class Config;
...
/* @@protoc_insertion_point(class_definition:transform.gzip.Config) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "transform.gzip.Config"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:transform.gzip.Config)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto;
};
...
inline ::int32_t Config::compression_level() const {
  // @@protoc_insertion_point(field_get:transform.gzip.Config.compression_level)
  return _internal_compression_level();
}
inline void Config::set_compression_level(::int32_t value) {
  _internal_set_compression_level(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_set:transform.gzip.Config.compression_level)
}
inline ::int32_t Config::_internal_compression_level() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.compression_level_;
}
inline void Config::_internal_set_compression_level(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
#endif  // github_2ecom_2fs4wave_2fspacewave_2fdb_2fblock_2ftransform_2fgzip_2fgzip_2eproto_2epb_2eh
