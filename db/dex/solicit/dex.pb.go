...
type DexMessage struct {
	...
	Refs []*block.BlockRef `protobuf:"bytes,8,rep,name=refs,proto3" json:"refs,omitempty"`
...
func (x *DexMessage) GetRefs() []*block.BlockRef {
	if x != nil {
		return x.Refs
	}
	return nil
...
func (x *DexMessage) GetRefsKnown() bool {
	if x != nil {
		return x.RefsKnown
	}
	return false
