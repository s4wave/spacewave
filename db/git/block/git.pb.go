...
func (m *EncodedObjectStore) CloneVT() *EncodedObjectStore {
	...
	r.PackfileKvtxRoot = m.PackfileKvtxRoot.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *Packfile) CloneVT() *Packfile {
	...
	r := new(Packfile)
	r.PackHash = m.PackHash.CloneVT()
	r.PackBlob = m.PackBlob.CloneVT()
	r.IdxBlob = m.IdxBlob.CloneVT()
...
func (x *ShallowRefsStore) MarshalProtoText() string {
	...
	if len(x.ShallowRefs) > 0 {
		...
		for i, v := range x.ShallowRefs {
			...
			if v == nil {
				sb.WriteString((&hash.Hash{}).MarshalProtoText())
			} else {
...
func (x *Index) MarshalProtoText() string {
	...
	if len(x.Entries) > 0 {
		...
		for i, v := range x.Entries {
			...
			if v == nil {
				sb.WriteString((&IndexEntry{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *Tree) MarshalProtoText() string {
	...
	if len(x.Entries) > 0 {
		...
		for i, v := range x.Entries {
			...
			if v == nil {
				sb.WriteString((&TreeEntry{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *ResolveUndo) MarshalProtoText() string {
	...
	if len(x.Entries) > 0 {
		...
		for i, v := range x.Entries {
			...
			if v == nil {
				sb.WriteString((&ResolveUndoEntry{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
