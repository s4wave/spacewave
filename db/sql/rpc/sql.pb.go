...
func (m *SqlExecRequest) CloneVT() *SqlExecRequest {
	...
	if rhs := m.Args; rhs != nil {
		r.Args = make([]*sql.SqlValue, len(rhs))
		for k, v := range rhs {
			r.Args[k] = v.CloneVT()
		}
	}
...
func (this *SqlTransactionRequest_Init) EqualVT(thatIface isSqlTransactionRequest_Body) bool {
	...
	if p, q := this.Init, that.Init; p != q {
		if p == nil {
			p = &SqlTransactionInit{}
		}
		if q == nil {
			q = &SqlTransactionInit{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *SqlTransactionResponse_Complete) EqualVT(thatIface isSqlTransactionResponse_Body) bool {
	...
	if p, q := this.Complete, that.Complete; p != q {
		if p == nil {
			p = &SqlTransactionComplete{}
		}
		if q == nil {
			q = &SqlTransactionComplete{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (m *SqlQueryRequest_Next) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.Next))
	return n
}
...
func (x *SqlTransactionRequest) MarshalProtoText() string {
	...
	sb.WriteString("SqlTransactionRequest {")
	...
	case *SqlTransactionRequest_Init:
		...
		sb.WriteString("init: ")
		if body.Init == nil {
			sb.WriteString((&SqlTransactionInit{}).MarshalProtoText())
		} else {
...
func (x *SqlTransactionInit) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlTransactionInit {")
	if x.Write != false {
		if sb.Len() > 20 {
			sb.WriteString(" ")
		}
...
func (x *SqlTransactionResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlTransactionResponse {")
	switch body := x.Body.(type) {
	case *SqlTransactionResponse_Ack:
		if sb.Len() > 24 {
			sb.WriteString(" ")
		...
		sb.WriteString("ack: ")
		if body.Ack == nil {
			sb.WriteString((&SqlTransactionAck{}).MarshalProtoText())
		} else {
	...
	case *SqlTransactionResponse_Complete:
		...
		if body.Complete == nil {
			sb.WriteString((&SqlTransactionComplete{}).MarshalProtoText())
		} else {
...
func (x *SqlTransactionAck) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlTransactionAck {")
	if x.Error != "" {
		if sb.Len() > 19 {
			sb.WriteString(" ")
		}
...
func (x *SqlTransactionComplete) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlTransactionComplete {")
	if x.Error != "" {
		if sb.Len() > 24 {
			sb.WriteString(" ")
		}
...
func (x *SqlExecResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlExecResponse {")
	if x.Error != "" {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
	...
	if x.LastInsertId != 0 {
		...
		sb.WriteString("last_insert_id: ")
		sb.WriteString(strconv.FormatInt(int64(x.LastInsertId), 10))
	}
	if x.RowsAffected != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		...
		sb.WriteString(strconv.FormatInt(int64(x.RowsAffected), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *SqlQueryRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlQueryRequest {")
	switch body := x.Body.(type) {
	case *SqlQueryRequest_Init:
		if sb.Len() > 17 {
			sb.WriteString(" ")
		...
		sb.WriteString("init: ")
		if body.Init == nil {
			sb.WriteString((&SqlQueryInit{}).MarshalProtoText())
		} else {
			sb.WriteString(body.Init.MarshalProtoText())
		}
	case *SqlQueryRequest_Next:
		...
		sb.WriteString("next: ")
		sb.WriteString(strconv.FormatUint(uint64(body.Next), 10))
	case *SqlQueryRequest_Close:
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
...
func (x *SqlQueryResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SqlQueryResponse {")
	switch body := x.Body.(type) {
	case *SqlQueryResponse_Ack:
		if sb.Len() > 18 {
			sb.WriteString(" ")
		...
		sb.WriteString("ack: ")
		if body.Ack == nil {
			sb.WriteString((&SqlQueryAck{}).MarshalProtoText())
		} else {
			sb.WriteString(body.Ack.MarshalProtoText())
		}
	case *SqlQueryResponse_Batch:
		...
		if body.Batch == nil {
			...
			sb.WriteString(body.Batch.MarshalProtoText())
		}
	case *SqlQueryResponse_ReqError:
		if sb.Len() > 18 {
			sb.WriteString(" ")
...
func (m *SqlQueryResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Body = &SqlQueryResponse_ReqError{ReqError: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
