...
func (x UnixFSErrorType) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), UnixFSErrorType_name)
}
...
func (m *UnixFSError) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ErrorBody) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ErrorBody)
		i--
		dAtA[i] = 0x12
	}
	if m.ErrorType != 0 {
...
func (m *UnixFSError) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.ErrorType)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ErrorBody)
...
func (x *UnixFSError) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "UnixFSError")
	if x.ErrorType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "error_type")
		protobuf_go_lite.TextWriteStringer(&sb, UnixFSErrorType(x.ErrorType))
	}
	if x.ErrorBody != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "error_body")
		protobuf_go_lite.TextWriteString(&sb, x.ErrorBody)
	}
...
func (m *UnixFSError) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ErrorType = UnixFSErrorType(_v)
			if err != nil {
				return err
			}
		case 2:
