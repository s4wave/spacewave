...
// @generated from file github.com/s4wave/spacewave/db/volume/bolt/bolt.proto (package volume.bolt, syntax proto3)
/* eslint-disable */
...
export const Config: MessageType<Config> = createMessageType({
  ...
  fields: [
    ...
    { no: 3, name: 'verbose', kind: 'scalar', T: ScalarType.BOOL },
