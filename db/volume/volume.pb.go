...
func (m *VolumeInfo) CloneVT() *VolumeInfo {
	...
	r.ControllerInfo = protobuf_go_lite.CloneVTValue(m.ControllerInfo)
...
func (this *VolumeInfo) EqualVT(that *VolumeInfo) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.ControllerInfo, that.ControllerInfo) {
		return false
	}
...
func (m *VolumeInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PeerPub) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.PeerPub)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.PeerId) > 0 {
...
func (m *VolumeInfo) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.PeerPub)
	if m.ControllerInfo != nil {
...
func (x *VolumeInfo) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "VolumeInfo")
	if x.VolumeId != "" {
	...
	if x.PeerPub != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "peer_pub")
		protobuf_go_lite.TextWriteString(&sb, x.PeerPub)
	}
	if x.ControllerInfo != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "controller_info")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.ControllerInfo)
	}
	if x.HashType != 0 {
...
func (x *StorageStats) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "StorageStats")
	if x.TotalBytes != 0 {
...
func (x *VolumeBucketInfo) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "VolumeBucketInfo")
	if x.BucketInfo != nil {
...
func (x *ListBucketsRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ListBucketsRequest")
	if x.BucketId != "" {
...
func (m *VolumeInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.ControllerInfo.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
