...
func (m *WorldChange) CloneVT() *WorldChange {
	...
	r.ObjectRef = protobuf_go_lite.CloneVTValue(m.ObjectRef)
	r.PrevObjectRef = protobuf_go_lite.CloneVTValue(m.PrevObjectRef)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *ChangeLogLL) CloneVT() *ChangeLogLL {
	...
	r.ChangeType = m.ChangeType
	r.PrevRef = protobuf_go_lite.CloneVTValue(m.PrevRef)
	r.ChangeBatch = protobuf_go_lite.CloneVTValue(m.ChangeBatch)
	r.KeyFilters = protobuf_go_lite.CloneVTValue(m.KeyFilters)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *World) EqualVT(that *World) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.ObjectKeyValue, that.ObjectKeyValue) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.GraphKeyValue, that.GraphKeyValue) {
		return false
	}
...
func (this *WorldChange) EqualVT(that *WorldChange) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.ObjectRef, that.ObjectRef) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.PrevObjectRef, that.PrevObjectRef) {
		return false
	}
...
func (this *WorldChangeLL) EqualVT(that *WorldChangeLL) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Changes, that.Changes, func() *WorldChange { return &WorldChange{} }) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *ChangeLogLL) EqualVT(that *ChangeLogLL) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.ChangeBatch, that.ChangeBatch) {
		return false
	}
	if this.ChangeType != that.ChangeType {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.KeyFilters, that.KeyFilters) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x WorldChangeType) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), WorldChangeType_name)
}
...
func (m *WorldChange) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.NewKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.NewKey)
		i--
		dAtA[i] = 0x42
	}
	if m.ObjectRev != 0 {
...
func (m *WorldChange) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.NewKey)
	n += len(m.unknownFields)
	return n
}
...
func (x *World) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "World")
	if x.ObjectKeyValue != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_key_value")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.ObjectKeyValue)
	}
	if x.GraphKeyValue != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "graph_key_value")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.GraphKeyValue)
	}
	if x.LastChange != nil {
...
func (x *Object) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "Object")
	if x.Key != "" {
...
func (x *WorldChange) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WorldChange")
	if x.ChangeType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "change_type")
		protobuf_go_lite.TextWriteStringer(&sb, WorldChangeType(x.ChangeType))
	}
	if x.Key != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "key")
		protobuf_go_lite.TextWriteString(&sb, x.Key)
	...
	if x.ObjectRef != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_ref")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.ObjectRef)
	}
	if x.PrevObjectRef != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "prev_object_ref")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.PrevObjectRef)
	}
	if x.ObjectRev != 0 {
	...
	if x.NewKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "new_key")
		protobuf_go_lite.TextWriteString(&sb, x.NewKey)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WorldChangeLL) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WorldChangeLL")
	if x.Height != 0 {
	...
	if len(x.Changes) > 0 {
		...
		for i, v := range x.Changes {
			...
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &WorldChange{})
			} else {
...
func (x *ChangeLogLL) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ChangeLogLL")
	if x.Seqno != 0 {
	...
	if x.ChangeBatch != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "change_batch")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.ChangeBatch)
	}
	if x.ChangeType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "change_type")
		protobuf_go_lite.TextWriteStringer(&sb, WorldChangeType(x.ChangeType))
	...
	if x.KeyFilters != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "key_filters")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.KeyFilters)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *World) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.ObjectKeyValue.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := m.GraphKeyValue.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *WorldChange) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ChangeType = WorldChangeType(_v)
			if err != nil {
				return err
			}
		case 2:
		...
		case 5:
			...
			if err := m.ObjectRef.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			...
			if err := m.PrevObjectRef.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *WorldChangeLL) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.TotalSize = 0
			m.TotalSize, iNdEx, err = protobuf_go_lite.DecodeVarintUint32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 4:
...
func (m *ChangeLogLL) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.ChangeBatch.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
		...
		case 5:
			...
			if err := m.KeyFilters.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
