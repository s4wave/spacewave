...
export const LookupBlockFromNetworkRequest = {
  encode(message: LookupBlockFromNetworkRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.bucketId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LookupBlockFromNetworkRequest {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<LookupBlockFromNetworkRequest | LookupBlockFromNetworkRequest[]>
      | Iterable<LookupBlockFromNetworkRequest | LookupBlockFromNetworkRequest[]>,
