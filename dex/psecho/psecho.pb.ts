...
function createBaseConfig(): Config {
  return { bucketId: "", pubsubChannel: "", peerId: "", transportId: Long.UZERO, syncBackoff: undefined };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.pubsubChannel !== "") {
      writer.uint32(18).string(message.pubsubChannel);
    }
    if (message.peerId !== "") {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      pubsubChannel: isSet(object.pubsubChannel) ? String(object.pubsubChannel) : "",
      peerId: isSet(object.peerId) ? String(object.peerId) : "",
      transportId: isSet(object.transportId) ? Long.fromValue(object.transportId) : Long.UZERO,
      syncBackoff: isSet(object.syncBackoff) ? Backoff.fromJSON(object.syncBackoff) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.pubsubChannel !== undefined && (obj.pubsubChannel = message.pubsubChannel);
    ...
    message.syncBackoff !== undefined &&
      (obj.syncBackoff = message.syncBackoff ? Backoff.toJSON(message.syncBackoff) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.pubsubChannel = object.pubsubChannel ?? "";
    message.peerId = object.peerId ?? "";
    message.transportId = (object.transportId !== undefined && object.transportId !== null)
      ? Long.fromValue(object.transportId)
      : Long.UZERO;
    message.syncBackoff = (object.syncBackoff !== undefined && object.syncBackoff !== null)
...
export const PubSubMessage = {
  encode(message: PubSubMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<PubSubMessage | PubSubMessage[]> | Iterable<PubSubMessage | PubSubMessage[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): PubSubMessage {
    return {
      wantRefs: Array.isArray(object?.wantRefs) ? object.wantRefs.map((e: any) => BlockRef.fromJSON(e)) : [],
      haveRefs: Array.isArray(object?.haveRefs) ? object.haveRefs.map((e: any) => BlockRef.fromJSON(e)) : [],
      clearRefs: Array.isArray(object?.clearRefs) ? object.clearRefs.map((e: any) => BlockRef.fromJSON(e)) : [],
  ...
  toJSON(message: PubSubMessage): unknown {
    const obj: any = {};
    if (message.wantRefs) {
      obj.wantRefs = message.wantRefs.map((e) => e ? BlockRef.toJSON(e) : undefined);
    } else {
      obj.wantRefs = [];
    }
    if (message.haveRefs) {
      obj.haveRefs = message.haveRefs.map((e) => e ? BlockRef.toJSON(e) : undefined);
    } else {
      obj.haveRefs = [];
    }
    if (message.clearRefs) {
      obj.clearRefs = message.clearRefs.map((e) => e ? BlockRef.toJSON(e) : undefined);
    } else {
      obj.clearRefs = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<PubSubMessage>, I>>(object: I): PubSubMessage {
    const message = createBasePubSubMessage();
    message.wantRefs = object.wantRefs?.map((e) => BlockRef.fromPartial(e)) || [];
    message.haveRefs = object.haveRefs?.map((e) => BlockRef.fromPartial(e)) || [];
    message.clearRefs = object.clearRefs?.map((e) => BlockRef.fromPartial(e)) || [];
...
function createBaseSyncMessage(): SyncMessage {
  return { messageType: 0, ref: undefined, chunk: new Uint8Array(), complete: false, blockSize: 0 };
}

export const SyncMessage = {
  encode(message: SyncMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<SyncMessage | SyncMessage[]> | Iterable<SyncMessage | SyncMessage[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): SyncMessage {
    return {
      messageType: isSet(object.messageType) ? syncMessageTypeFromJSON(object.messageType) : 0,
  ...
  toJSON(message: SyncMessage): unknown {
    const obj: any = {};
    message.messageType !== undefined && (obj.messageType = syncMessageTypeToJSON(message.messageType));
