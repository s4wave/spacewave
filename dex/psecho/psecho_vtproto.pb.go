...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.SyncBackoff != nil {
		if marshalto, ok := interface{}(m.SyncBackoff).(interface {
...
func (m *PubSubMessage) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ClearRefs) > 0 {
		for iNdEx := len(m.ClearRefs) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.ClearRefs[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
	...
	if len(m.HaveRefs) > 0 {
		for iNdEx := len(m.HaveRefs) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.HaveRefs[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
	...
	if len(m.WantRefs) > 0 {
		for iNdEx := len(m.WantRefs) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.WantRefs[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
