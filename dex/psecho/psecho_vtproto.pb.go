...
func (this *PubSubMessage) EqualVT(that *PubSubMessage) bool {
	...
	for i := range this.WantRefs {
		if equal, ok := interface{}(this.WantRefs[i]).(interface{ EqualVT(*block.BlockRef) bool }); ok {
			if !equal.EqualVT(that.WantRefs[i]) {
				return false
			}
		} else if !proto.Equal(this.WantRefs[i], that.WantRefs[i]) {
			return false
		}
	}
	...
	for i := range this.HaveRefs {
		if equal, ok := interface{}(this.HaveRefs[i]).(interface{ EqualVT(*block.BlockRef) bool }); ok {
			if !equal.EqualVT(that.HaveRefs[i]) {
				return false
			}
		} else if !proto.Equal(this.HaveRefs[i], that.HaveRefs[i]) {
			return false
		}
	}
	...
	for i := range this.ClearRefs {
		if equal, ok := interface{}(this.ClearRefs[i]).(interface{ EqualVT(*block.BlockRef) bool }); ok {
			if !equal.EqualVT(that.ClearRefs[i]) {
				return false
			}
		} else if !proto.Equal(this.ClearRefs[i], that.ClearRefs[i]) {
			return false
		}
	}
