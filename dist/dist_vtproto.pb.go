...
func (m *DistMeta) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *DistMeta) EqualMessageVT(thatMsg proto.Message) bool {
...
func (m *DistMeta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.StartupPlugins) > 0 {
		for iNdEx := len(m.StartupPlugins) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.StartupPlugins[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
