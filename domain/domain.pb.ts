...
export const DomainInfo = {
  encode(message: DomainInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.domainId !== "") {
  ...
  async *encodeTransform(
    source: AsyncIterable<DomainInfo | DomainInfo[]> | Iterable<DomainInfo | DomainInfo[]>,
  ...
  fromPartial<I extends Exact<DeepPartial<DomainInfo>, I>>(object: I): DomainInfo {
    const message = createBaseDomainInfo();
