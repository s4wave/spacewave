...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      domainInfo: isSet(object.domainInfo) ? DomainInfo.fromJSON(object.domainInfo) : undefined,
      clientOpts: isSet(object.clientOpts) ? Config1.fromJSON(object.clientOpts) : undefined,
  ...
  toJSON(message: Config): unknown {
    ...
    message.domainInfo !== undefined &&
      (obj.domainInfo = message.domainInfo ? DomainInfo.toJSON(message.domainInfo) : undefined);
    message.clientOpts !== undefined &&
      (obj.clientOpts = message.clientOpts ? Config1.toJSON(message.clientOpts) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    const message = createBaseConfig();
    message.domainInfo = (object.domainInfo !== undefined && object.domainInfo !== null)
      ? DomainInfo.fromPartial(object.domainInfo)
      : undefined;
    message.clientOpts = (object.clientOpts !== undefined && object.clientOpts !== null)
