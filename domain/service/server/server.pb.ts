...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      domainIds: Array.isArray(object?.domainIds) ? object.domainIds.map((e: any) => String(e)) : [],
      requestTimeout: isSet(object.requestTimeout) ? String(object.requestTimeout) : "",
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.requestTimeout !== undefined && (obj.requestTimeout = message.requestTimeout);
    return obj;
  },
