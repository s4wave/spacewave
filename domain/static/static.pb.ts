...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      silentNotFound: isSet(object.silentNotFound) ? Boolean(object.silentNotFound) : false,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.silentNotFound !== undefined && (obj.silentNotFound = message.silentNotFound);
    return obj;
  },
