// Auto-generated by build-runtime-wasm
(() => {
  ...
  var require_wasm_exec = __commonJS({
    "../../../../../../usr/lib/go/misc/wasm/wasm_exec.js"(exports, module) {
      (() => {
        ...
        if (!global.require && typeof undefined !== "undefined") {
          global.require = undefined;
        }
        if (!global.fs && global.require) {
          const fs2 = undefined("fs");
        ...
        if (!global.crypto && global.require) {
          const nodeCrypto = undefined("crypto");
          global.crypto = {
            getRandomValues(b) {
        ...
        if (!global.TextEncoder && global.require) {
          global.TextEncoder = undefined("util").TextEncoder;
        }
        if (!global.TextEncoder) {
          throw new Error("global.TextEncoder is not available, polyfill required");
        }
        if (!global.TextDecoder && global.require) {
          global.TextDecoder = undefined("util").TextDecoder;
        }
        ...
        if (typeof module !== "undefined" && global.require && global.require.main === module && global.process && global.process.versions && !global.process.versions.electron) {
          ...
          go.env = Object.assign({ TMPDIR: undefined("os").tmpdir() }, process.env);
  ...
  // runtime-wasm.ts
  var import_wasm_exec = __toModule(require_wasm_exec());
  async function startRuntime() {
    ...
    WebAssembly.instantiateStreaming(payload, go.importObject).then((result) => {
      mod = result.module;
