...
import { InputWorld } from "../../target/target.pb.js";
...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      resolveControllerConfigTimeout: isSet(object.resolveControllerConfigTimeout)
        ? String(object.resolveControllerConfigTimeout)
        : "",
      allowNonExecController: isSet(object.allowNonExecController) ? Boolean(object.allowNonExecController) : false,
      inputWorld: isSet(object.inputWorld) ? InputWorld.fromJSON(object.inputWorld) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.resolveControllerConfigTimeout !== undefined &&
      (obj.resolveControllerConfigTimeout = message.resolveControllerConfigTimeout);
    message.allowNonExecController !== undefined && (obj.allowNonExecController = message.allowNonExecController);
    message.inputWorld !== undefined &&
      (obj.inputWorld = message.inputWorld ? InputWorld.toJSON(message.inputWorld) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.resolveControllerConfigTimeout = object.resolveControllerConfigTimeout ?? "";
    message.allowNonExecController = object.allowNonExecController ?? false;
    message.inputWorld = (object.inputWorld !== undefined && object.inputWorld !== null)
