  ...
  fromJSON(object: any): Config {
    return {
      ...
      resolveControllerConfigTimeout: isSet(
        ...
        ? globalThis.String(object.resolveControllerConfigTimeout)
        : '',
      allowNonExecController: isSet(object.allowNonExecController)
        ? globalThis.Boolean(object.allowNonExecController)
        : false,
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        ...
        yield* [ExecConfig.encode(pkt as any).finish()]
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        ...
        yield* [ExecConfig.decode(pkt as any)]
      }
    }
  },
