...
func (m *Job) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.JobState)
	if m.Result != nil {
		l = m.Result.SizeVT()
...
func (x *Job) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "Job")
	if x.JobState != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "job_state")
		protobuf_go_lite.TextWriteStringer(&sb, State(x.JobState))
	}
	if x.Result != nil {
