...
func (m *Tx) CloneVT() *Tx {
	...
	r.TxCreateExecSpecs = protobuf_go_lite.CloneVTValue(m.TxCreateExecSpecs)
	r.TxUpdateExecStates = protobuf_go_lite.CloneVTValue(m.TxUpdateExecStates)
...
func (m *TxStart) CloneVT() *TxStart {
	...
	r := new(TxStart)
	r.CreateExecSpecs = protobuf_go_lite.CloneVTValue(m.CreateExecSpecs)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *TxCreateExecSpecs) CloneVT() *TxCreateExecSpecs {
	...
	r.ExecSpecs = protobuf_go_lite.CloneVTSlice(m.ExecSpecs)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *Tx) EqualVT(that *Tx) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.TxCreateExecSpecs, that.TxCreateExecSpecs) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.TxUpdateExecStates, that.TxUpdateExecStates) {
		return false
	}
...
func (this *TxStart) EqualVT(that *TxStart) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.CreateExecSpecs, that.CreateExecSpecs) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *TxCreateExecSpecs) EqualVT(that *TxCreateExecSpecs) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.ExecSpecs, that.ExecSpecs, func() *ExecSpec { return &ExecSpec{} }) {
		return false
	}
...
func (m *Tx) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PassObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.PassObjectKey)
		i--
		dAtA[i] = 0x12
	}
	if m.TxType != 0 {
...
func (m *TxCreateExecSpecs) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ClearExisting {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.ClearExisting)
		i--
		dAtA[i] = 0x10
	}
...
func (m *Tx) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.PassObjectKey)
	if m.TxStart != nil {
		l = m.TxStart.SizeVT()
...
func (m *TxCreateExecSpecs) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.ClearExisting)
	n += len(m.unknownFields)
	return n
}
...
func (x *Tx) MarshalProtoText() string {
	...
	if x.PassObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "pass_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.PassObjectKey)
	}
	if x.TxStart != nil {
	...
	if x.TxCreateExecSpecs != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "tx_create_exec_specs")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.TxCreateExecSpecs)
	}
	if x.TxUpdateExecStates != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "tx_update_exec_states")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.TxUpdateExecStates)
	}
	if x.TxComplete != nil {
...
func (x *ExecSpec) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ExecSpec")
	if x.PeerId != "" {
...
func (x *TxStart) MarshalProtoText() string {
	...
	if x.CreateExecSpecs != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "create_exec_specs")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.CreateExecSpecs)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *TxCreateExecSpecs) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "TxCreateExecSpecs")
	if len(x.ExecSpecs) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "exec_specs")
		for i, v := range x.ExecSpecs {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &ExecSpec{})
			} else {
	...
	if x.ClearExisting != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "clear_existing")
		protobuf_go_lite.TextWriteBool(&sb, x.ClearExisting)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *TxUpdateExecStates) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "TxUpdateExecStates")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *TxCancel) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "TxCancel")
	if x.Result != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "result")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Result)
	}
...
func (m *Tx) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.TxCreateExecSpecs.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			if err := m.TxUpdateExecStates.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *TxStart) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.CreateExecSpecs.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TxCreateExecSpecs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.ExecSpecs[len(m.ExecSpecs)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
