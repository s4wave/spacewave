...
#ifndef github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto_2epb_2eh
#define github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto
...
struct TableStruct_github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto;
}  // extern "C"
namespace task {
...
/* @@protoc_insertion_point(class_definition:task.controller.Config) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "task.controller.Config"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:task.controller.Config)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto;
};
...
inline const ::std::string& Config::engine_id() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:task.controller.Config.engine_id)
...
PROTOBUF_ALWAYS_INLINE void Config::set_engine_id(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:task.controller.Config.engine_id)
}
inline ::std::string* PROTOBUF_NONNULL Config::mutable_engine_id()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  ::std::string* _s = _internal_mutable_engine_id();
  // @@protoc_insertion_point(field_mutable:task.controller.Config.engine_id)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Config::release_engine_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:task.controller.Config.engine_id)
...
inline void Config::set_allocated_engine_id(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:task.controller.Config.engine_id)
}
...
inline const ::std::string& Config::object_key() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:task.controller.Config.object_key)
...
PROTOBUF_ALWAYS_INLINE void Config::set_object_key(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:task.controller.Config.object_key)
}
inline ::std::string* PROTOBUF_NONNULL Config::mutable_object_key()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000002U);
  ::std::string* _s = _internal_mutable_object_key();
  // @@protoc_insertion_point(field_mutable:task.controller.Config.object_key)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Config::release_object_key() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:task.controller.Config.object_key)
...
inline void Config::set_allocated_object_key(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:task.controller.Config.object_key)
}
...
inline const ::std::string& Config::peer_id() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:task.controller.Config.peer_id)
...
PROTOBUF_ALWAYS_INLINE void Config::set_peer_id(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:task.controller.Config.peer_id)
}
inline ::std::string* PROTOBUF_NONNULL Config::mutable_peer_id()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000004U);
  ::std::string* _s = _internal_mutable_peer_id();
  // @@protoc_insertion_point(field_mutable:task.controller.Config.peer_id)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Config::release_peer_id() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:task.controller.Config.peer_id)
...
inline void Config::set_allocated_peer_id(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:task.controller.Config.peer_id)
}
...
inline bool Config::assign_self() const {
  // @@protoc_insertion_point(field_get:task.controller.Config.assign_self)
  return _internal_assign_self();
}
inline void Config::set_assign_self(bool value) {
  _internal_set_assign_self(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000008U);
  // @@protoc_insertion_point(field_set:task.controller.Config.assign_self)
}
...
#endif  // github_2ecom_2fs4wave_2fspacewave_2fforge_2ftask_2fcontroller_2fconfig_2eproto_2epb_2eh
