...
func (m *Task) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.TaskState)
...
func (x *Task) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "Task")
	if x.TaskState != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "task_state")
		protobuf_go_lite.TextWriteStringer(&sb, State(x.TaskState))
	}
	if x.Name != "" {
