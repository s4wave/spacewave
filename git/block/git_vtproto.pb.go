...
func (m *Repo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ShallowRefsStoreRef != nil {
		if marshalto, ok := interface{}(m.ShallowRefsStoreRef).(interface {
...
func (m *EncodedObjectStore) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ChunkerArgs != nil {
		if marshalto, ok := interface{}(m.ChunkerArgs).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.KvtxRoot != nil {
		if marshalto, ok := interface{}(m.KvtxRoot).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *ShallowRefsStore) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ShallowRefs) > 0 {
		for iNdEx := len(m.ShallowRefs) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.ShallowRefs[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
...
func (m *Submodule) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.RepoRef != nil {
		if marshalto, ok := interface{}(m.RepoRef).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *EncodedObject) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DataHash != nil {
		if marshalto, ok := interface{}(m.DataHash).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
	...
	if m.DataBlob != nil {
		if marshalto, ok := interface{}(m.DataBlob).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *IndexEntry) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ModifiedAt != nil {
		if marshalto, ok := interface{}(m.ModifiedAt).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
