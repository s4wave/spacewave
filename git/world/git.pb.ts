...
export interface GitCreateWorktreeOp {
  ...
  workdirRef: UnixfsRef | undefined
  ...
  checkoutOpts: CheckoutOpts | undefined
...
export const GitInitOp = {
  ...
  fromPartial<I extends Exact<DeepPartial<GitInitOp>, I>>(
    ...
    message.createWorktree =
      object.createWorktree !== undefined && object.createWorktree !== null
...
export const Worktree = {
  ...
  fromJSON(object: any): Worktree {
    return {
      gitIndex: isSet(object.gitIndex)
        ? Index.fromJSON(object.gitIndex)
        : undefined,
      headRefStore: isSet(object.headRefStore)
        ? HeadRefStore.fromJSON(object.headRefStore)
        : undefined,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Worktree>, I>>(object: I): Worktree {
    const message = createBaseWorktree()
    message.gitIndex =
      object.gitIndex !== undefined && object.gitIndex !== null
        ? Index.fromPartial(object.gitIndex)
        : undefined
    message.headRefStore =
      object.headRefStore !== undefined && object.headRefStore !== null
  ...
  fromPartial<I extends Exact<DeepPartial<HeadRefStore>, I>>(
    ...
    message.headRef =
      object.headRef !== undefined && object.headRef !== null
        ...
        : undefined
    message.submodules =
      object.submodules?.map((e) => HeadRefStore.fromPartial(e)) || []
    return message
  },
}
...
export const GitCreateWorktreeOp = {
  ...
  fromPartial<I extends Exact<DeepPartial<GitCreateWorktreeOp>, I>>(
    ...
    message.workdirRef =
      object.workdirRef !== undefined && object.workdirRef !== null
        ? UnixfsRef.fromPartial(object.workdirRef)
        : undefined
    message.createWorkdir = object.createWorkdir ?? false
    message.checkoutOpts =
      object.checkoutOpts !== undefined && object.checkoutOpts !== null
