...
require github.com/s4wave/goscript v0.2.18-0.20260713120307-ab4ff47ec996 // master
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-alpha.4.0.20260713100844-d5e9b9c7895b // main
