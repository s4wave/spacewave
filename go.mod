...
require github.com/aperturerobotics/bifrost v0.7.6-0.20221014225606-6f2484d6cce3
...
require (
	github.com/aperturerobotics/controllerbus v0.16.3-0.20221014204918-c4e355fdc6b2
