...
require (
	github.com/aperturerobotics/bifrost v0.32.1 // master
...
require (
	...
	github.com/aperturerobotics/go-brotli-decoder v0.1.1 // indirect; latest
...
require (
	...
	golang.org/x/crypto v0.22.1-0.20240503134056-ebb717d63002
)
