...
require github.com/aperturerobotics/hydra v0.0.0-20221228021717-4d6c139f1b74

// Note: the below is from the Hydra go.mod

require github.com/aperturerobotics/bifrost v0.8.8-0.20221228022040-eeb9cb9d841d
