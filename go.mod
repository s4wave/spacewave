...
require github.com/aperturerobotics/hydra v0.0.0-20221222215447-8bfdb5388db8

// Note: the below is from the Hydra go.mod

require github.com/aperturerobotics/bifrost v0.8.6-0.20221222215108-79ffbb40a994
