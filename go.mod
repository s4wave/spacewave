...
require github.com/s4wave/goscript v0.2.16-0.20260710214142-402589d7d1d3 // master
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-alpha.4.0.20260707125336-d60654d4f998 // main
