...
require (
	...
	github.com/aperturerobotics/starpc v0.49.16-0.20260527143541-1ea564686612 // latest
	github.com/aperturerobotics/util v1.34.7-0.20260528041410-47689504b8f8 // latest
)
