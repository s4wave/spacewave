...
require (
	...
	golang.org/x/mod v0.32.0 // latest
...
require (
	github.com/aperturerobotics/bifrost v0.44.1-0.20260131060332-1c6e160693d5 // master
...
require (
	...
	github.com/aperturerobotics/starpc v0.46.0 // latest
