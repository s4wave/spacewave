...
require github.com/s4wave/goscript v0.2.22-0.20260717111424-ccc0f425823e // master
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-alpha.4.0.20260716142645-5f90b841aef2 // main
