...
replace (
	...
	github.com/dolthub/go-mysql-server => github.com/dolthub/go-mysql-server v0.6.1-0.20210129194859-cc04b535136f // master
...
replace (
	github.com/genjidb/genji => github.com/paralin/genji v0.10.2-0.20210201024614-0f77be2c9277 // ext-engines-4
