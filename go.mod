...
require (
	github.com/aperturerobotics/hydra v0.0.0-20240713191240-75c1e3eb7088 // master
...
require (
	github.com/aperturerobotics/bifrost v0.35.1-0.20240713134415-9dceb1e81e85 // master
