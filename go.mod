...
require (
	github.com/aperturerobotics/hydra v0.0.0-20240305034132-0507fbd75ad5
...
require (
	github.com/aperturerobotics/controllerbus v0.36.4-0.20240305021941-6b425805eba1 // latest
