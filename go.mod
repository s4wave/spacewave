...
require github.com/aperturerobotics/hydra v0.0.0-20231111030517-21ff4329d818 // master
...
replace (
	...
	github.com/hidal-go/hidalgo => github.com/aperturerobotics/hidalgo v0.3.1-0.20231111025626-8e86ced5bdd7 // aperture
