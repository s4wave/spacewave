...
require github.com/aperturerobotics/hydra v0.0.0-20221222094035-ef5b41b59e01
...
require (
	github.com/aperturerobotics/controllerbus v0.20.4-0.20221222093403-3ee2ac6b2c1d
