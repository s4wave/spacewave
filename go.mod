...
require github.com/aperturerobotics/hydra v0.0.0-20221219062927-d9c4162c1f4c

// Note: the below is from the Hydra go.mod

require github.com/aperturerobotics/bifrost v0.8.6-0.20221219062732-d3f5054ae0d3
