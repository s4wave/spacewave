...
export const Entity = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break
        case 6:
          message.keypairSignatures.push(
            Signature.decode(reader, reader.uint32())
          )
          break
        default:
  ...
  toJSON(message: Entity): unknown {
    ...
    if (message.entityKeypairs) {
      obj.entityKeypairs = message.entityKeypairs.map((e) =>
    ...
    if (message.keypairSignatures) {
      obj.keypairSignatures = message.keypairSignatures.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<Entity>, I>>(object: I): Entity {
    ...
    message.keypairSignatures =
      object.keypairSignatures?.map((e) => Signature.fromPartial(e)) || []
    return message
  },
}
...
export const EntityKeypair = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<EntityKeypair | EntityKeypair[]>
      | Iterable<EntityKeypair | EntityKeypair[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): EntityKeypair {
    return {
      entityId: isSet(object.entityId) ? String(object.entityId) : '',
      domainId: isSet(object.domainId) ? String(object.domainId) : '',
      keypair: isSet(object.keypair)
        ? Keypair.fromJSON(object.keypair)
        : undefined,
    }
  },
  ...
  toJSON(message: EntityKeypair): unknown {
    ...
    message.keypair !== undefined &&
      (obj.keypair = message.keypair
        ? Keypair.toJSON(message.keypair)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<EntityKeypair>, I>>(
    object: I
  ): EntityKeypair {
    const message = createBaseEntityKeypair()
    message.entityId = object.entityId ?? ''
    message.domainId = object.domainId ?? ''
    message.keypair =
      object.keypair !== undefined && object.keypair !== null
...
export const EntityRef = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<EntityRef | EntityRef[]>
      | Iterable<EntityRef | EntityRef[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
...
function createBaseKeypair(): Keypair {
  return {
    ...
    pubKey: '',
    authMethodId: '',
    authMethodParams: new Uint8Array(),
  }
}
...
export const Keypair = {
  ...
  fromJSON(object: any): Keypair {
    return {
      ...
      authMethodId: isSet(object.authMethodId)
        ? String(object.authMethodId)
        : '',
      authMethodParams: isSet(object.authMethodParams)
        ? bytesFromBase64(object.authMethodParams)
        : new Uint8Array(),
    }
  },
...
export const PendingEntityChange = {
  ...
  fromJSON(object: any): PendingEntityChange {
    return {
      changePeerId: isSet(object.changePeerId)
        ? String(object.changePeerId)
        : '',
      epoch: isSet(object.epoch) ? Long.fromValue(object.epoch) : Long.UZERO,
      domainIdentifier: isSet(object.domainIdentifier)
        ? String(object.domainIdentifier)
        : '',
      entityChangeType: isSet(object.entityChangeType)
        ? entityChangeTypeFromJSON(object.entityChangeType)
        : 0,
      entityChangeData: isSet(object.entityChangeData)
        ? String(object.entityChangeData)
        : '',
    }
  },
...
function createBaseRegisterKeypair(): RegisterKeypair {
  return {
    registerPeerId: '',
    authMethodId: '',
    authMethodState: new Uint8Array(),
  }
}
...
export const RegisterKeypair = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<RegisterKeypair | RegisterKeypair[]>
      | Iterable<RegisterKeypair | RegisterKeypair[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): RegisterKeypair {
    return {
      registerPeerId: isSet(object.registerPeerId)
        ? String(object.registerPeerId)
        : '',
      authMethodId: isSet(object.authMethodId)
        ? String(object.authMethodId)
        : '',
      authMethodState: isSet(object.authMethodState)
        ? bytesFromBase64(object.authMethodState)
        : new Uint8Array(),
    }
  },
  ...
  toJSON(message: RegisterKeypair): unknown {
    const obj: any = {}
    message.registerPeerId !== undefined &&
    ...
    message.authMethodState !== undefined &&
      (obj.authMethodState = base64FromBytes(
        message.authMethodState !== undefined
          ? message.authMethodState
          : new Uint8Array()
      ))
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<RegisterKeypair>, I>>(
    object: I
  ): RegisterKeypair {
    const message = createBaseRegisterKeypair()
...
export const RemoveKeypair = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<RemoveKeypair | RemoveKeypair[]>
      | Iterable<RemoveKeypair | RemoveKeypair[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<RemoveKeypair>, I>>(
    object: I
  ): RemoveKeypair {
    const message = createBaseRemoveKeypair()
    message.peerId = object.peerId ?? ''
