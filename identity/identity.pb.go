...
func (m *EntityKeypairSet) CloneVT() *EntityKeypairSet {
	...
	if rhs := m.EntityKeypairs; rhs != nil {
		r.EntityKeypairs = make([][]byte, len(rhs))
		for k, v := range rhs {
			r.EntityKeypairs[k] = slices.Clone(v)
		}
	}
	if rhs := m.EntityKeypairSignatures; rhs != nil {
		r.EntityKeypairSignatures = make([]*peer.Signature, len(rhs))
		for k, v := range rhs {
			r.EntityKeypairSignatures[k] = v.CloneVT()
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
...
func (m *RegisterKeypair) CloneVT() *RegisterKeypair {
	...
	if rhs := m.AuthMethodState; rhs != nil {
		r.AuthMethodState = slices.Clone(rhs)
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
