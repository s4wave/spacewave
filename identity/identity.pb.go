...
func (m *Entity) CloneVT() *Entity {
	...
	r.Epoch = m.Epoch
	r.EntityKeypairSet = protobuf_go_lite.CloneVTValue(m.EntityKeypairSet)
...
func (m *EntityKeypairSet) CloneVT() *EntityKeypairSet {
	...
	r.EntityKeypairs = protobuf_go_lite.CloneBytesSlice(m.EntityKeypairs)
	r.EntityKeypairSignatures = protobuf_go_lite.CloneVTSlice(m.EntityKeypairSignatures)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *RegisterKeypair) CloneVT() *RegisterKeypair {
	...
	r.AuthMethodId = m.AuthMethodId
	r.AuthMethodState = protobuf_go_lite.CloneBytes(m.AuthMethodState)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *Entity) EqualVT(that *Entity) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.EntityKeypairSet, that.EntityKeypairSet) {
		return false
	}
...
func (this *EntityKeypairSet) EqualVT(that *EntityKeypairSet) bool {
	...
	if !protobuf_go_lite.EqualBytesSlice(this.EntityKeypairs, that.EntityKeypairs) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.EntityKeypairSignatures, that.EntityKeypairSignatures, func() *peer.Signature { return &peer.Signature{} }) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *RegisterKeypair) EqualVT(that *RegisterKeypair) bool {
	...
	if !protobuf_go_lite.EqualBytes(this.AuthMethodState, that.AuthMethodState) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x EntityChangeType) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), EntityChangeType_name)
}
...
func (m *Entity) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.EntityUuid) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.EntityUuid)
		i--
		dAtA[i] = 0x12
	}
	if len(m.EntityId) > 0 {
...
func (m *EntityKeypairSet) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.EntityKeypairs) > 0 {
		for iNdEx := len(m.EntityKeypairs) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeBytes(dAtA, i, m.EntityKeypairs[iNdEx])
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Keypair) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PubKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.PubKey)
		i--
		dAtA[i] = 0x12
	}
	if len(m.PeerId) > 0 {
...
func (m *PendingEntityChange) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.EntityChangeData) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.EntityChangeData)
		i--
		dAtA[i] = 0x2a
	}
	...
	if len(m.DomainIdentifier) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.DomainIdentifier)
		i--
		dAtA[i] = 0x1a
	}
	if m.Epoch != 0 {
	...
	if len(m.ChangePeerId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ChangePeerId)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RegisterKeypair) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AuthMethodState) > 0 {
		i = protobuf_go_lite.EncodeBytes(dAtA, i, m.AuthMethodState)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.AuthMethodId) > 0 {
	...
	if len(m.RegisterPeerId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.RegisterPeerId)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Entity) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.EntityUuid)
...
func (m *EntityKeypairSet) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeBytesSlice(1, m.EntityKeypairs)
...
func (m *Keypair) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.PubKey)
...
func (m *PendingEntityChange) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ChangePeerId)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Epoch)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.DomainIdentifier)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.EntityChangeType)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.EntityChangeData)
	n += len(m.unknownFields)
	return n
}
...
func (m *RegisterKeypair) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.RegisterPeerId)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.AuthMethodId)
	n += protobuf_go_lite.SizeBytesNonEmpty(1, m.AuthMethodState)
	n += len(m.unknownFields)
	return n
}
...
func (x *Entity) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "Entity")
	if x.EntityId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "entity_id")
		protobuf_go_lite.TextWriteString(&sb, x.EntityId)
	}
	if x.EntityUuid != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "entity_uuid")
		protobuf_go_lite.TextWriteString(&sb, x.EntityUuid)
	}
	if x.DomainId != "" {
	...
	if x.EntityKeypairSet != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "entity_keypair_set")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.EntityKeypairSet)
	}
...
func (x *EntityKeypairSet) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "EntityKeypairSet")
	...
	if len(x.EntityKeypairSignatures) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "entity_keypair_signatures")
...
func (x *EntityRef) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "EntityRef")
	if x.EntityId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "entity_id")
		protobuf_go_lite.TextWriteString(&sb, x.EntityId)
	}
...
func (x *Keypair) MarshalProtoText() string {
	...
	if x.PubKey != "" {
		...
		protobuf_go_lite.TextWriteString(&sb, x.PubKey)
	}
	if x.AuthMethodId != "" {
...
func (x *PendingEntityChange) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "PendingEntityChange")
	if x.ChangePeerId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "change_peer_id")
		protobuf_go_lite.TextWriteString(&sb, x.ChangePeerId)
	}
	if x.Epoch != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "epoch")
		protobuf_go_lite.TextWriteUint(&sb, x.Epoch)
	...
	if x.DomainIdentifier != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "domain_identifier")
		protobuf_go_lite.TextWriteString(&sb, x.DomainIdentifier)
	}
	if x.EntityChangeType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "entity_change_type")
		protobuf_go_lite.TextWriteStringer(&sb, EntityChangeType(x.EntityChangeType))
	}
	if x.EntityChangeData != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "entity_change_data")
		protobuf_go_lite.TextWriteString(&sb, x.EntityChangeData)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *RegisterKeypair) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "RegisterKeypair")
	if x.RegisterPeerId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "register_peer_id")
		protobuf_go_lite.TextWriteString(&sb, x.RegisterPeerId)
	}
	if x.AuthMethodId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "auth_method_id")
		protobuf_go_lite.TextWriteString(&sb, x.AuthMethodId)
	...
	if len(x.AuthMethodState) != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "auth_method_state")
		protobuf_go_lite.TextWriteBytes(&sb, x.AuthMethodState)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *RemoveKeypair) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "RemoveKeypair")
	if x.PeerId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "peer_id")
		protobuf_go_lite.TextWriteString(&sb, x.PeerId)
	}
...
func (m *Entity) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := m.EntityKeypairSet.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EntityKeypairSet) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.EntityKeypairs = append(m.EntityKeypairs, v)
		case 2:
			if wireType != 2 {
			...
			if err := m.EntityKeypairSignatures[len(m.EntityKeypairSignatures)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PendingEntityChange) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.EntityChangeType = EntityChangeType(_v)
			if err != nil {
				return err
			}
		case 5:
...
func (m *RegisterKeypair) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.AuthMethodState, iNdEx, err = protobuf_go_lite.DecodeBytesAppend(m.AuthMethodState, dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
