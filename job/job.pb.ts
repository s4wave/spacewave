...
export const Job = {
  ...
  async *encodeTransform(source: AsyncIterable<Job | Job[]> | Iterable<Job | Job[]>): AsyncIterable<Uint8Array> {
  ...
  toJSON(message: Job): unknown {
    const obj: any = {};
    message.jobState !== undefined && (obj.jobState = stateToJSON(message.jobState));
