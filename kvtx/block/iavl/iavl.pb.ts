...
export const Node = {
  ...
  async *encodeTransform(source: AsyncIterable<Node | Node[]> | Iterable<Node | Node[]>): AsyncIterable<Uint8Array> {
  ...
  fromJSON(object: any): Node {
    return {
      ...
      valueRef: isSet(object.valueRef) ? BlockRef.fromJSON(object.valueRef) : undefined,
      valueRefBlob: isSet(object.valueRefBlob) ? Boolean(object.valueRefBlob) : false,
      leftChildRef: isSet(object.leftChildRef) ? BlockRef.fromJSON(object.leftChildRef) : undefined,
      rightChildRef: isSet(object.rightChildRef) ? BlockRef.fromJSON(object.rightChildRef) : undefined,
    };
  },
  ...
  toJSON(message: Node): unknown {
    ...
    message.valueRef !== undefined && (obj.valueRef = message.valueRef ? BlockRef.toJSON(message.valueRef) : undefined);
    message.valueRefBlob !== undefined && (obj.valueRefBlob = message.valueRefBlob);
    message.leftChildRef !== undefined &&
      (obj.leftChildRef = message.leftChildRef ? BlockRef.toJSON(message.leftChildRef) : undefined);
    message.rightChildRef !== undefined &&
      (obj.rightChildRef = message.rightChildRef ? BlockRef.toJSON(message.rightChildRef) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Node>, I>>(object: I): Node {
    ...
    message.valueRef = (object.valueRef !== undefined && object.valueRef !== null)
      ? BlockRef.fromPartial(object.valueRef)
      : undefined;
    message.valueRefBlob = object.valueRefBlob ?? false;
    message.leftChildRef = (object.leftChildRef !== undefined && object.leftChildRef !== null)
      ? BlockRef.fromPartial(object.leftChildRef)
      : undefined;
    message.rightChildRef = (object.rightChildRef !== undefined && object.rightChildRef !== null)
