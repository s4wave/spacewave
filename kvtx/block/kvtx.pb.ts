...
export const KeyValueStore = {
  encode(message: KeyValueStore, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<KeyValueStore | KeyValueStore[]> | Iterable<KeyValueStore | KeyValueStore[]>,
  ...
  fromJSON(object: any): KeyValueStore {
    return {
      implType: isSet(object.implType) ? kVImplTypeFromJSON(object.implType) : 0,
      iavlRoot: isSet(object.iavlRoot) ? BlockRef.fromJSON(object.iavlRoot) : undefined,
    };
  },

  toJSON(message: KeyValueStore): unknown {
    const obj: any = {};
    message.implType !== undefined && (obj.implType = kVImplTypeToJSON(message.implType));
    message.iavlRoot !== undefined && (obj.iavlRoot = message.iavlRoot ? BlockRef.toJSON(message.iavlRoot) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<KeyValueStore>, I>>(object: I): KeyValueStore {
    const message = createBaseKeyValueStore();
    message.implType = object.implType ?? 0;
    message.iavlRoot = (object.iavlRoot !== undefined && object.iavlRoot !== null)
