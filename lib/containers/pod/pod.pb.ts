...
export const Config = {
  encode(
    ...
    Object.entries(message.volumeInputs).forEach(([key, value]) => {
      Config_VolumeInputsEntry.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break
        case 7:
          const entry7 = Config_VolumeInputsEntry.decode(
            reader,
            reader.uint32()
          )
  ...
  fromJSON(object: any): Config {
    return {
      ...
      volumeInputs: isObject(object.volumeInputs)
        ? Object.entries(object.volumeInputs).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.volumeInputs = Object.entries(object.volumeInputs ?? {}).reduce<{
      [key: string]: string
    }>((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = String(value)
...
export const Config_VolumeInputsEntry = {
  encode(
    message: Config_VolumeInputsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
  ...
  fromPartial<I extends Exact<DeepPartial<Config_VolumeInputsEntry>, I>>(
    object: I
  ): Config_VolumeInputsEntry {
    const message = createBaseConfig_VolumeInputsEntry()
