...
function createBaseConfig(): Config {
  return { objectKey: "", cloneOpts: undefined, authOpts: undefined, worktreeOpts: undefined };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.worktreeOpts !== undefined) {
      GitCreateWorktreeOp.encode(message.worktreeOpts, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Config {
    return {
      ...
      cloneOpts: isSet(object.cloneOpts) ? CloneOpts.fromJSON(object.cloneOpts) : undefined,
      authOpts: isSet(object.authOpts) ? AuthOpts.fromJSON(object.authOpts) : undefined,
      worktreeOpts: isSet(object.worktreeOpts) ? GitCreateWorktreeOp.fromJSON(object.worktreeOpts) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.cloneOpts !== undefined &&
      (obj.cloneOpts = message.cloneOpts ? CloneOpts.toJSON(message.cloneOpts) : undefined);
    message.authOpts !== undefined && (obj.authOpts = message.authOpts ? AuthOpts.toJSON(message.authOpts) : undefined);
    message.worktreeOpts !== undefined &&
      (obj.worktreeOpts = message.worktreeOpts ? GitCreateWorktreeOp.toJSON(message.worktreeOpts) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.cloneOpts = (object.cloneOpts !== undefined && object.cloneOpts !== null)
      ? CloneOpts.fromPartial(object.cloneOpts)
      : undefined;
    message.authOpts = (object.authOpts !== undefined && object.authOpts !== null)
      ? AuthOpts.fromPartial(object.authOpts)
      : undefined;
    message.worktreeOpts = (object.worktreeOpts !== undefined && object.worktreeOpts !== null)
