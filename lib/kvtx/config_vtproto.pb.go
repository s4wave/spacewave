...
func (m *ConfigInput) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Op) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ConfigInput) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ConfigInput)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Ops) > 0 {
...
func (m *Op) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ValueString) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ValueString)))
		i--
		dAtA[i] = 0x42
	}
	if m.Value != nil {
	...
	if len(m.ValueInput) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ValueInput)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Key) > 0 {
	...
	if len(m.KeyInput) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.KeyInput)))
		i--
		dAtA[i] = 0x12
	}
	if m.OpType != 0 {
		i = encodeVarint(dAtA, i, uint64(m.OpType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
