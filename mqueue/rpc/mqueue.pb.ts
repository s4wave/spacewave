...
export class MqueueStoreClientImpl implements MqueueStore {
  ...
  RmMqueue(request: RmMqueueRequest): Promise<RmMqueueResponse> {
    ...
    const promise = this.rpc.request('mqueue.rpc.MqueueStore', 'RmMqueue', data)
