...
func (m *PrivateKey) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.KeyType)
...
func (x *PrivateKey) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "PrivateKey")
	if x.KeyType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "key_type")
		protobuf_go_lite.TextWriteStringer(&sb, KeyType(x.KeyType))
	}
	if len(x.Data) != 0 {
...
func (x *PublicKey) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "PublicKey")
	if x.KeyType != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "key_type")
		protobuf_go_lite.TextWriteStringer(&sb, KeyType(x.KeyType))
	}
