...
func (x *Envelope) MarshalProtoText() string {
	...
	if len(x.Grants) > 0 {
		...
		for i, v := range x.Grants {
			...
			if v == nil {
				sb.WriteString((&EnvelopeGrant{}).MarshalProtoText())
			} else {
	...
	if len(x.Keypairs) > 0 {
		...
		for i, v := range x.Keypairs {
			...
			if v == nil {
				sb.WriteString((&EnvelopeKeypair{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *EnvelopeGrantInner) MarshalProtoText() string {
	...
	if len(x.Shares) > 0 {
		...
		for i, v := range x.Shares {
			...
			if v == nil {
				sb.WriteString((&EnvelopeShare{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *EnvelopeConfig) MarshalProtoText() string {
	...
	if len(x.GrantConfigs) > 0 {
		...
		for i, v := range x.GrantConfigs {
			...
			if v == nil {
				sb.WriteString((&EnvelopeGrantConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
