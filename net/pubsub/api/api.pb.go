...
func (m *SubscribeRequest) CloneVT() *SubscribeRequest {
	...
	r.PublishRequest = protobuf_go_lite.CloneVTValue(m.PublishRequest)
...
func (m *SubscribeResponse) CloneVT() *SubscribeResponse {
	...
	r.IncomingMessage = protobuf_go_lite.CloneVTValue(m.IncomingMessage)
	r.OutgoingStatus = protobuf_go_lite.CloneVTValue(m.OutgoingStatus)
	r.SubscriptionStatus = protobuf_go_lite.CloneVTValue(m.SubscriptionStatus)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *SubscribeRequest) EqualVT(that *SubscribeRequest) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.PublishRequest, that.PublishRequest) {
		return false
	}
...
func (this *SubscribeResponse) EqualVT(that *SubscribeResponse) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.IncomingMessage, that.IncomingMessage) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.OutgoingStatus, that.OutgoingStatus) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.SubscriptionStatus, that.SubscriptionStatus) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *SubscriptionStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Subscribed {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.Subscribed)
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *OutgoingStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Sent {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.Sent)
		i--
		dAtA[i] = 0x10
	}
	if m.Identifier != 0 {
...
func (m *IncomingMessage) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Authenticated {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.Authenticated)
		i--
		dAtA[i] = 0x10
	}
...
func (m *PublishRequest) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Identifier)
	n += len(m.unknownFields)
	return n
}
...
func (m *SubscriptionStatus) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Subscribed)
	n += len(m.unknownFields)
	return n
}
...
func (m *OutgoingStatus) SizeVT() (n int) {
	...
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Identifier)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Sent)
	n += len(m.unknownFields)
	return n
}
...
func (m *IncomingMessage) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Authenticated)
	n += protobuf_go_lite.SizeBytesNonEmpty(1, m.Data)
	n += len(m.unknownFields)
	return n
}
...
func (x *SubscribeRequest) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SubscribeRequest")
	if x.ChannelId != "" {
	...
	if x.PublishRequest != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "publish_request")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.PublishRequest)
	}
...
func (x *PublishRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "PublishRequest")
	if len(x.Data) != 0 {
	...
	if x.Identifier != 0 {
		...
		protobuf_go_lite.TextWriteUint(&sb, x.Identifier)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *SubscribeResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SubscribeResponse")
	if x.IncomingMessage != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "incoming_message")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.IncomingMessage)
	}
	if x.OutgoingStatus != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "outgoing_status")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.OutgoingStatus)
	}
	if x.SubscriptionStatus != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "subscription_status")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.SubscriptionStatus)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *SubscriptionStatus) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SubscriptionStatus")
	if x.Subscribed != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "subscribed")
		protobuf_go_lite.TextWriteBool(&sb, x.Subscribed)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *OutgoingStatus) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "OutgoingStatus")
	if x.Identifier != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "identifier")
		protobuf_go_lite.TextWriteUint(&sb, x.Identifier)
	}
	if x.Sent != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "sent")
		protobuf_go_lite.TextWriteBool(&sb, x.Sent)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *IncomingMessage) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "IncomingMessage")
	if x.FromPeerId != "" {
	...
	if x.Authenticated != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "authenticated")
		protobuf_go_lite.TextWriteBool(&sb, x.Authenticated)
	}
	if len(x.Data) != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "data")
		protobuf_go_lite.TextWriteBytes(&sb, x.Data)
...
func (m *SubscribeRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.PublishRequest.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SubscribeResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.IncomingMessage.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := m.OutgoingStatus.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if err := m.SubscriptionStatus.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
