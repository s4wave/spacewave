...
import (
	...
	accept "github.com/s4wave/spacewave/net/stream/api/accept"
	dial "github.com/s4wave/spacewave/net/stream/api/dial"
	rpc "github.com/s4wave/spacewave/net/stream/api/rpc"
	forwarding "github.com/s4wave/spacewave/net/stream/forwarding"
	listening "github.com/s4wave/spacewave/net/stream/listening"
)
...
func (m *ForwardStreamsRequest) CloneVT() *ForwardStreamsRequest {
	...
	r.ForwardingConfig = protobuf_go_lite.CloneVTValue(m.ForwardingConfig)
...
func (m *ListenStreamsRequest) CloneVT() *ListenStreamsRequest {
	...
	r.ListeningConfig = protobuf_go_lite.CloneVTValue(m.ListeningConfig)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *ForwardStreamsRequest) EqualVT(that *ForwardStreamsRequest) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.ForwardingConfig, that.ForwardingConfig) {
		return false
	}
...
func (this *ListenStreamsRequest) EqualVT(that *ListenStreamsRequest) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.ListeningConfig, that.ListeningConfig) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *ForwardStreamsRequest) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ForwardStreamsRequest")
	if x.ForwardingConfig != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "forwarding_config")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.ForwardingConfig)
	}
...
func (x *ForwardStreamsResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ForwardStreamsResponse")
...
func (x *ListenStreamsRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ListenStreamsRequest")
	if x.ListeningConfig != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "listening_config")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.ListeningConfig)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *ListenStreamsResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ListenStreamsResponse")
	if x.ControllerStatus != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "controller_status")
		protobuf_go_lite.TextWriteStringer(&sb, exec.ControllerStatus(x.ControllerStatus))
	}
...
func (x *AcceptStreamRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "AcceptStreamRequest")
	if x.Config != nil {
...
func (x *AcceptStreamResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "AcceptStreamResponse")
	if x.Data != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "data")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Data)
	}
...
func (x *DialStreamRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "DialStreamRequest")
	if x.Config != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "config")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Config)
	}
...
func (x *DialStreamResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "DialStreamResponse")
	if x.Data != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "data")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Data)
	}
...
func (m *ForwardStreamsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.ForwardingConfig.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ListenStreamsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.ListeningConfig.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
