...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TargetMultiaddr) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.TargetMultiaddr)
		i--
		dAtA[i] = 0x1a
	}
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.TargetMultiaddr)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.TargetMultiaddr != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "target_multiaddr")
		protobuf_go_lite.TextWriteString(&sb, x.TargetMultiaddr)
	}
