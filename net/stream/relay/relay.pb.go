...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TargetProtocolId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.TargetProtocolId)
		i--
		dAtA[i] = 0x22
	}
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.TargetProtocolId)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.TargetProtocolId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "target_protocol_id")
		protobuf_go_lite.TextWriteString(&sb, x.TargetProtocolId)
	}
