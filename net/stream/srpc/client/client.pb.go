...
func (m *Config) CloneVT() *Config {
	...
	r.ServerPeerIds = protobuf_go_lite.CloneSlice(m.ServerPeerIds)
	r.PerServerBackoff = protobuf_go_lite.CloneVTValue(m.PerServerBackoff)
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.ServerPeerIds, that.ServerPeerIds) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.PerServerBackoff, that.PerServerBackoff) {
		return false
	}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TimeoutDur) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.TimeoutDur)
		i--
		dAtA[i] = 0x2a
	}
	if m.TransportId != 0 {
	...
	if len(m.SrcPeerId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.SrcPeerId)
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.ServerPeerIds) > 0 {
		for iNdEx := len(m.ServerPeerIds) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.ServerPeerIds[iNdEx])
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Config) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringSlice(1, m.ServerPeerIds)
	if m.PerServerBackoff != nil {
		l = m.PerServerBackoff.SizeVT()
		n += protobuf_go_lite.SizeMessage(1, l)
	}
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.SrcPeerId)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.TransportId)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.TimeoutDur)
...
func (x *Config) MarshalProtoText() string {
	...
	if len(x.ServerPeerIds) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "server_peer_ids")
	...
	if x.PerServerBackoff != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "per_server_backoff")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.PerServerBackoff)
	}
	if x.SrcPeerId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "src_peer_id")
		protobuf_go_lite.TextWriteString(&sb, x.SrcPeerId)
	}
	if x.TransportId != 0 {
	...
	if x.TimeoutDur != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "timeout_dur")
		protobuf_go_lite.TextWriteString(&sb, x.TimeoutDur)
	}
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ServerPeerIds = append(m.ServerPeerIds, v)
		case 2:
			if wireType != 2 {
			...
			if err := m.PerServerBackoff.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
