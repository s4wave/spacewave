...
func (m *Config) CloneVT() *Config {
	...
	r.ServiceIdPrefixes = protobuf_go_lite.CloneSlice(m.ServiceIdPrefixes)
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.ServiceIdPrefixes, that.ServiceIdPrefixes) {
		return false
	}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ServiceIdPrefixes) > 0 {
		for iNdEx := len(m.ServiceIdPrefixes) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.ServiceIdPrefixes[iNdEx])
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringSlice(1, m.ServiceIdPrefixes)
...
func (x *Config) MarshalProtoText() string {
	...
	if len(x.ServiceIdPrefixes) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "service_id_prefixes")
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.ServiceIdPrefixes = append(m.ServiceIdPrefixes, v)
		default:
			iNdEx = preIndex
