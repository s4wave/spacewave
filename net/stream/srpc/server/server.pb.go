...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DisableEstablishLink {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.DisableEstablishLink)
		i--
		dAtA[i] = 0x18
	}
...
func (m *Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBoolNonZero(1, m.DisableEstablishLink)
...
func (x *Config) MarshalProtoText() string {
	...
	if x.DisableEstablishLink != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "disable_establish_link")
		protobuf_go_lite.TextWriteBool(&sb, x.DisableEstablishLink)
	}
