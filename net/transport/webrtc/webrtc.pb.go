...
func (x *WebRtcConfig) MarshalProtoText() string {
	...
	if len(x.IceServers) > 0 {
		...
		for i, v := range x.IceServers {
			...
			if v == nil {
				sb.WriteString((&IceServerConfig{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *IceServerConfig) MarshalProtoText() string {
	...
	case *IceServerConfig_Oauth:
		...
		if body.Oauth == nil {
			sb.WriteString((&IceServerConfig_OauthCredential{}).MarshalProtoText())
		} else {
...
func (x *WebRtcSignal) MarshalProtoText() string {
	...
	case *WebRtcSignal_Sdp:
		...
		sb.WriteString("sdp: ")
		if body.Sdp == nil {
			sb.WriteString((&WebRtcSdp{}).MarshalProtoText())
		} else {
	...
	case *WebRtcSignal_Ice:
		...
		sb.WriteString("ice: ")
		if body.Ice == nil {
			sb.WriteString((&WebRtcIce{}).MarshalProtoText())
		} else {
