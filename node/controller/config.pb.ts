...
function createBaseConfig(): Config {
  return { disableLookup: false, disableDefaultLookup: false, defaultLookup: undefined };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.defaultLookup !== undefined) {
      ControllerConfig.encode(message.defaultLookup, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.defaultLookup = ControllerConfig.decode(reader, reader.uint32());
          break;
        default:
  ...
  fromJSON(object: any): Config {
    return {
      ...
      disableDefaultLookup: isSet(object.disableDefaultLookup) ? Boolean(object.disableDefaultLookup) : false,
      defaultLookup: isSet(object.defaultLookup) ? ControllerConfig.fromJSON(object.defaultLookup) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.disableDefaultLookup !== undefined && (obj.disableDefaultLookup = message.disableDefaultLookup);
    message.defaultLookup !== undefined &&
      (obj.defaultLookup = message.defaultLookup ? ControllerConfig.toJSON(message.defaultLookup) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.defaultLookup = (object.defaultLookup !== undefined && object.defaultLookup !== null)
