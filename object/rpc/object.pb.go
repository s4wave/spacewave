...
func (m *RmObjectStoreRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: RmObjectStoreRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: RmObjectStoreRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RmObjectStoreResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: RmObjectStoreResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: RmObjectStoreResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
