...
export interface Tx {
   ...
   */
  txCreateExecSpecs: TxCreateExecSpecs | undefined
  /**
   * TxUpdateExecStates contains the update exec states tx.
   * TxType_EXEC_COMPLETE
   */
  txUpdateExecStates: TxUpdateExecStates | undefined
  /**
...
export const Tx = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.txCreateExecSpecs = TxCreateExecSpecs.decode(
            reader,
            reader.uint32()
          )
          continue
        case 5:
          ...
          message.txUpdateExecStates = TxUpdateExecStates.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  toJSON(message: Tx): unknown {
    ...
    message.passObjectKey !== undefined &&
      (obj.passObjectKey = message.passObjectKey)
  ...
  fromPartial<I extends Exact<DeepPartial<Tx>, I>>(object: I): Tx {
    ...
    message.txStart =
      object.txStart !== undefined && object.txStart !== null
        ...
        : undefined
    message.txCreateExecSpecs =
      object.txCreateExecSpecs !== undefined &&
      object.txCreateExecSpecs !== null
        ? TxCreateExecSpecs.fromPartial(object.txCreateExecSpecs)
        : undefined
    message.txUpdateExecStates =
      object.txUpdateExecStates !== undefined &&
      object.txUpdateExecStates !== null
...
export const ExecSpec = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<ExecSpec | ExecSpec[]>
...
export const TxStart = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.createExecSpecs = TxCreateExecSpecs.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  fromJSON(object: any): TxStart {
    return {
      createExecSpecs: isSet(object.createExecSpecs)
        ? TxCreateExecSpecs.fromJSON(object.createExecSpecs)
        : undefined,
    }
  },
  ...
  toJSON(message: TxStart): unknown {
    ...
    message.createExecSpecs !== undefined &&
      (obj.createExecSpecs = message.createExecSpecs
        ? TxCreateExecSpecs.toJSON(message.createExecSpecs)
        : undefined)
    return obj
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TxStart>, I>>(object: I): TxStart {
    const message = createBaseTxStart()
    message.createExecSpecs =
      object.createExecSpecs !== undefined && object.createExecSpecs !== null
...
export const TxCreateExecSpecs = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<TxCreateExecSpecs | TxCreateExecSpecs[]>
  ...
  toJSON(message: TxCreateExecSpecs): unknown {
    ...
    if (message.execSpecs) {
      obj.execSpecs = message.execSpecs.map((e) =>
        e ? ExecSpec.toJSON(e) : undefined
      )
    } else {
      obj.execSpecs = []
    }
    message.clearExisting !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<TxCreateExecSpecs>, I>>(
    ...
    const message = createBaseTxCreateExecSpecs()
    message.execSpecs =
      object.execSpecs?.map((e) => ExecSpec.fromPartial(e)) || []
