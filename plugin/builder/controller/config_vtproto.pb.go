...
func (m *Config) CloneVT() *Config {
	...
	if rhs := m.BuilderConfig; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface {
			...
			r.BuilderConfig = proto.Clone(rhs).(*builder.PluginBuilderConfig)
		}
	}
	if rhs := m.BuilderControllerConfig; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface {
			CloneVT() *proto1.ControllerConfig
		}); ok {
			r.BuilderControllerConfig = vtpb.CloneVT()
		} else {
			r.BuilderControllerConfig = proto.Clone(rhs).(*proto1.ControllerConfig)
		}
	}
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if equal, ok := interface{}(this.BuilderControllerConfig).(interface {
		EqualVT(*proto1.ControllerConfig) bool
	}); ok {
		if !equal.EqualVT(that.BuilderControllerConfig) {
			return false
		}
	} else if !proto.Equal(this.BuilderControllerConfig, that.BuilderControllerConfig) {
		return false
	}
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.BuilderControllerConfig != nil {
		if vtmsg, ok := interface{}(m.BuilderControllerConfig).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.BuilderControllerConfig)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *Config) SizeVT() (n int) {
	...
	if m.BuilderControllerConfig != nil {
		if size, ok := interface{}(m.BuilderControllerConfig).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.BuilderControllerConfig)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.BuildBackoff != nil {
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.BuilderConfig == nil {
				m.BuilderConfig = &builder.PluginBuilderConfig{}
			}
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BuilderControllerConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BuilderControllerConfig == nil {
				m.BuilderControllerConfig = &proto1.ControllerConfig{}
			}
			if unmarshal, ok := interface{}(m.BuilderControllerConfig).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.BuilderControllerConfig); err != nil {
					return err
				}
			}
			iNdEx = postIndex
