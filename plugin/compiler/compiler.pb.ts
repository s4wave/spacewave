...
// @generated from file github.com/aperturerobotics/bldr/plugin/compiler/compiler.proto (package bldr.plugin.compiler, syntax proto3)
/* eslint-disable */
 ...
 *
 * @generated from message bldr.plugin.compiler.ViteEntrypointVar
 */
...
export const ViteEntrypointVar: MessageType<ViteEntrypointVar> =
  createMessageType({
    typeName: 'bldr.plugin.compiler.ViteEntrypointVar',
    fields: [
      { no: 1, name: 'pkg_import_path', kind: 'scalar', T: ScalarType.STRING },
      { no: 2, name: 'pkg_var', kind: 'scalar', T: ScalarType.STRING },
      { no: 3, name: 'pkg_code_path', kind: 'scalar', T: ScalarType.STRING },
 ...
 *
 * @generated from message bldr.plugin.compiler.ViteBundleMeta
 */
export interface ViteBundleMeta {
   ...
   * EntrypointVars is the list of entrypoint variables.
   *
   * @generated from field: repeated bldr.plugin.compiler.ViteEntrypointVar entrypoint_vars = 2;
   */
...
export const ViteBundleMeta: MessageType<ViteBundleMeta> = createMessageType({
  typeName: 'bldr.plugin.compiler.ViteBundleMeta',
  fields: [
    { no: 1, name: 'id', kind: 'scalar', T: ScalarType.STRING },
    {
      no: 2,
 ...
 *
 * @generated from message bldr.plugin.compiler.ViteOutputMeta
 */
...
export const ViteOutputMeta: MessageType<ViteOutputMeta> = createMessageType({
  typeName: 'bldr.plugin.compiler.ViteOutputMeta',
  fields: [
    { no: 1, name: 'path', kind: 'scalar', T: ScalarType.STRING },
...
export interface InputManifestMeta {
   ...
   *
   * @generated from field: map<string, bldr.plugin.compiler.ViteBundleMeta> vite_bundles = 8;
   */
  viteBundles?: { [key: string]: ViteBundleMeta }
  /**
   * ViteOutputs contains a list of files written by vite.
   *
   * @generated from field: repeated bldr.plugin.compiler.ViteOutputMeta vite_outputs = 9;
   */
