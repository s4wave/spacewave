...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.WebPluginId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.WebPluginId)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.EsbuildFlags) > 0 {
		for iNdEx := len(m.EsbuildFlags) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EsbuildFlags[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
	...
	if len(m.DelveAddr) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DelveAddr)))
		i--
		dAtA[i] = 0x42
	}
	...
	if len(m.WebPkgs) > 0 {
		for iNdEx := len(m.WebPkgs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.WebPkgs[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if len(m.GoPkgs) > 0 {
		for iNdEx := len(m.GoPkgs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.GoPkgs[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *EsbuildOutputMeta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.EntrypointPath) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EntrypointPath)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Length != 0 {
...
func (m *EsbuildEntrypointVar) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PkgVarType != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.PkgVarType))
		i--
		dAtA[i] = 0x20
	}
	if len(m.PkgCodePath) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PkgCodePath)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.PkgVar) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PkgVar)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.PkgImportPath) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PkgImportPath)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *EsbuildEntrypointVar) SizeVT() (n int) {
	...
	if m.PkgVarType != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.PkgVarType))
	}
	if len(m.EsbuildFlags) > 0 {
		for _, s := range m.EsbuildFlags {
			l = len(s)
