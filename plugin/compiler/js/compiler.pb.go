...
func (m *Config) CloneVT() *Config {
	...
	if rhs := m.EsbuildBundles; rhs != nil {
		tmpContainer := make([]*compiler.EsbuildBundleMeta, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
	...
	if rhs := m.ViteBundles; rhs != nil {
		tmpContainer := make([]*compiler1.ViteBundleMeta, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
	...
	if rhs := m.BackendEntrypoints; rhs != nil {
		tmpContainer := make([]*BackendEntrypoint, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.BackendEntrypoints = tmpContainer
	}
	if rhs := m.FrontendEntrypoints; rhs != nil {
		tmpContainer := make([]*FrontendEntrypoint, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.FrontendEntrypoints = tmpContainer
	}
