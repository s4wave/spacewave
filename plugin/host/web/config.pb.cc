...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {5, sizeof(::plugin::host::web::QuickJSConfig)},
};
...
const char descriptor_table_protodef_github_2ecom_2faperturerobotics_2fbldr_2fplugin_2fhost_2fweb_2fconfig_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\" \n\006Config\022\026\n\016web_runtime_id\030\001 \001(\t\"\'\n\rQu"
    "ickJSConfig\022\026\n\016web_runtime_id\030\001 \001(\tb\006pro"
    "to3"
};
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:plugin.host.web.Config)
}
...
// @@protoc_insertion_point(message_clear_start:plugin.host.web.Config)
...
::uint8_t* PROTOBUF_NONNULL Config::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:plugin.host.web.Config)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_web_runtime_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "plugin.host.web.Config.web_runtime_id");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:plugin.host.web.Config)
  return target;
}
...
::size_t Config::ByteSizeLong() const {
  const Config& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:plugin.host.web.Config)
  ::size_t total_size = 0;
...
void Config::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:plugin.host.web.Config)
...
void Config::CopyFrom(const Config& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:plugin.host.web.Config)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
