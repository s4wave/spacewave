...
function createBaseConfig(): Config {
  return { hostConfig: undefined, webRuntimeId: "" };
}
...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.webRuntimeId !== "") {
      writer.uint32(18).string(message.webRuntimeId);
    }
    return writer;
  },
  ...
  fromJSON(object: any): Config {
    return {
      ...
      webRuntimeId: isSet(object.webRuntimeId) ? globalThis.String(object.webRuntimeId) : "",
    };
  },
