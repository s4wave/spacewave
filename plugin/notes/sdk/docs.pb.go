...
func (m *WatchDocsResponse) CloneVT() *WatchDocsResponse {
	...
	r.Documentation = protobuf_go_lite.CloneVTValue(m.Documentation)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *WatchDocsResponse) EqualVT(that *WatchDocsResponse) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.Documentation, that.Documentation) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *WatchDocsRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "WatchDocsRequest")
...
func (x *WatchDocsResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WatchDocsResponse")
	if x.Documentation != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "documentation")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Documentation)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *WatchDocsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Documentation.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
