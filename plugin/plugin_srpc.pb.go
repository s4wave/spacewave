...
func NewSRPCPluginHostHandler(impl SRPCPluginHostServer) srpc.Handler {
	return &SRPCPluginHostHandler{impl: impl}
}
...
func NewSRPCPluginFetchHandler(impl SRPCPluginFetchServer) srpc.Handler {
	return &SRPCPluginFetchHandler{impl: impl}
}
