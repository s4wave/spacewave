...
func init() {
	bldr_example.AssetPath = "/p/bldr-demo/a/example.js"
	bldr_example.ExampleEntrypoint = bldr_values.EsbuildOutput{EntrypointHref: "/p/bldr-demo/a/example-463AYXN6.js", CssHref: "/p/bldr-demo/a/example-NAZ3GDK7.css"}
}
