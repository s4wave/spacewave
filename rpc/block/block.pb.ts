/* eslint-disable */
import { BlockRef, PutOpts } from "@go/github.com/aperturerobotics/hydra/block/block.pb.js";
import Long from "long";
import _m0 from "protobufjs/minimal.js";

export const protobufPackage = "rpc.block";
...
export const PutBlockRequest = {
  encode(message: PutBlockRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<PutBlockRequest | PutBlockRequest[]> | Iterable<PutBlockRequest | PutBlockRequest[]>,
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [PutBlockRequest.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [PutBlockRequest.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PutBlockRequest>, I>>(object: I): PutBlockRequest {
    const message = createBasePutBlockRequest();
...
export const PutBlockResponse = {
  encode(message: PutBlockResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<PutBlockResponse | PutBlockResponse[]> | Iterable<PutBlockResponse | PutBlockResponse[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
        ...
        yield* [PutBlockResponse.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [PutBlockResponse.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PutBlockResponse>, I>>(object: I): PutBlockResponse {
    const message = createBasePutBlockResponse();
...
export const GetBlockRequest = {
  ...
  async *encodeTransform(
    source: AsyncIterable<GetBlockRequest | GetBlockRequest[]> | Iterable<GetBlockRequest | GetBlockRequest[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
        ...
        yield* [GetBlockRequest.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [GetBlockRequest.decode(pkt)];
      }
    }
  },

  fromJSON(object: any): GetBlockRequest {
    return { ref: isSet(object.ref) ? BlockRef.fromJSON(object.ref) : undefined };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockRequest>, I>>(object: I): GetBlockRequest {
    const message = createBaseGetBlockRequest();
    message.ref = (object.ref !== undefined && object.ref !== null) ? BlockRef.fromPartial(object.ref) : undefined;
    return message;
  },
...
export const GetBlockResponse = {
  ...
  async *encodeTransform(
    source: AsyncIterable<GetBlockResponse | GetBlockResponse[]> | Iterable<GetBlockResponse | GetBlockResponse[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
        ...
        yield* [GetBlockResponse.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [GetBlockResponse.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockResponse>, I>>(object: I): GetBlockResponse {
    const message = createBaseGetBlockResponse();
...
export const GetBlockExistsRequest = {
  encode(message: GetBlockExistsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ref !== undefined) {
      BlockRef.encode(message.ref, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetBlockExistsRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [GetBlockExistsRequest.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [GetBlockExistsRequest.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockExistsRequest>, I>>(object: I): GetBlockExistsRequest {
    const message = createBaseGetBlockExistsRequest();
    message.ref = (object.ref !== undefined && object.ref !== null) ? BlockRef.fromPartial(object.ref) : undefined;
    return message;
  },
...
export const GetBlockExistsResponse = {
  encode(message: GetBlockExistsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.exists === true) {
      writer.uint32(8).bool(message.exists);
    }
    if (message.error !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetBlockExistsResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [GetBlockExistsResponse.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [GetBlockExistsResponse.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockExistsResponse>, I>>(object: I): GetBlockExistsResponse {
    const message = createBaseGetBlockExistsResponse();
    message.exists = object.exists ?? false;
    message.error = object.error ?? "";
    return message;
...
export const RmBlockRequest = {
  encode(message: RmBlockRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ref !== undefined) {
      BlockRef.encode(message.ref, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  async *encodeTransform(
    source: AsyncIterable<RmBlockRequest | RmBlockRequest[]> | Iterable<RmBlockRequest | RmBlockRequest[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
        ...
        yield* [RmBlockRequest.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [RmBlockRequest.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RmBlockRequest>, I>>(object: I): RmBlockRequest {
    const message = createBaseRmBlockRequest();
    message.ref = (object.ref !== undefined && object.ref !== null) ? BlockRef.fromPartial(object.ref) : undefined;
    return message;
  },
...
export const RmBlockResponse = {
  encode(message: RmBlockResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.error !== "") {
  ...
  async *encodeTransform(
    source: AsyncIterable<RmBlockResponse | RmBlockResponse[]> | Iterable<RmBlockResponse | RmBlockResponse[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
        ...
        yield* [RmBlockResponse.encode(pkt).finish()];
      }
    }
  },
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        ...
        yield* [RmBlockResponse.decode(pkt)];
      }
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RmBlockResponse>, I>>(object: I): RmBlockResponse {
    const message = createBaseRmBlockResponse();
    message.error = object.error ?? "";
    return message;
  },
...
export interface BlockStore {
  ...
  GetBlockExists(request: GetBlockExistsRequest): Promise<GetBlockExistsResponse>;
  /**
...
export class BlockStoreClientImpl implements BlockStore {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || "rpc.block.BlockStore";
    this.rpc = rpc;
  ...
  GetBlockExists(request: GetBlockExistsRequest): Promise<GetBlockExistsResponse> {
    ...
    return promise.then((data) => GetBlockExistsResponse.decode(new _m0.Reader(data)));
  }
