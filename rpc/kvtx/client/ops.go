...
type Ops struct {
	...
	client rpc_kvtx.SRPCKvtxOpsClient
}

// NewOps constructs a new TxOps.
func NewOps(ctx context.Context, client rpc_kvtx.SRPCKvtxOpsClient) *Ops {
	return &Ops{
		ctx:    ctx,
		client: client,
	}
...
func (o *Ops) Size() (uint64, error) {
	resp, err := o.client.KeyCount(o.ctx, &rpc_kvtx.KeyCountRequest{})
...
func (o *Ops) Get(key []byte) (data []byte, found bool, err error) {
	resp, err := o.client.KeyData(o.ctx, rpc_kvtx.NewKeyRequest(key))
	if err != nil {
...
func (o *Ops) Set(key []byte, value []byte) error {
	resp, err := o.client.SetKey(o.ctx, &rpc_kvtx.KvtxSetKeyRequest{
		Key:   key,
		Value: value,
	})
	if err := o.err(err, resp.GetError()); err != nil {
...
func (o *Ops) Delete(key []byte) error {
	resp, err := o.client.DeleteKey(o.ctx, &rpc_kvtx.KvtxDeleteKeyRequest{
		Key: key,
	})
	if err := o.err(err, resp.GetError()); err != nil {
		return err
...
func (o *Ops) Exists(key []byte) (bool, error) {
	resp, err := o.client.KeyExists(o.ctx, rpc_kvtx.NewKeyRequest(key))
	if err := o.err(err, resp.GetError()); err != nil {
		return false, err
	}
