...
export const protobufPackage = "rpc.object";
...
export const RmObjectStoreRequest = {
  encode(message: RmObjectStoreRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RmObjectStoreRequest {
  ...
  fromJSON(object: any): RmObjectStoreRequest {
    return { objectStoreId: isSet(object.objectStoreId) ? String(object.objectStoreId) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RmObjectStoreRequest>, I>>(object: I): RmObjectStoreRequest {
    const message = createBaseRmObjectStoreRequest();
...
export const RmObjectStoreResponse = {
  encode(message: RmObjectStoreResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.error !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RmObjectStoreResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<RmObjectStoreResponse>, I>>(object: I): RmObjectStoreResponse {
    const message = createBaseRmObjectStoreResponse();
...
export interface ObjectStore {
   ...
   */
  ObjectStoreRpc(request: AsyncIterable<RpcStreamPacket>): AsyncIterable<RpcStreamPacket>;
...
export class ObjectStoreClientImpl implements ObjectStore {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || "rpc.object.ObjectStore";
    this.rpc = rpc;
  ...
  ObjectStoreRpc(request: AsyncIterable<RpcStreamPacket>): AsyncIterable<RpcStreamPacket> {
    ...
    const result = this.rpc.bidirectionalStreamingRequest(this.service, "ObjectStoreRpc", data);
  ...
  RmObjectStore(request: RmObjectStoreRequest): Promise<RmObjectStoreResponse> {
    ...
    return promise.then((data) => RmObjectStoreResponse.decode(new _m0.Reader(data)));
  }
}
...
export const ObjectStoreDefinition = {
  name: "ObjectStore",
  fullName: "rpc.object.ObjectStore",
  methods: {
    /**
     * ObjectStoreRpc is a rpc request for an ObjectStore Kvtx service by ID.
     * Corresponds to a call to BuildObjectStoreAPI.
