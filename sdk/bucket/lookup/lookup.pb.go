...
func (x *GetBlockExistsBatchResponse) GetFound() []bool {
	if x != nil {
		return x.Found
	}
	return nil
...
func (m *GetBlockExistsBatchResponse) CloneVT() *GetBlockExistsBatchResponse {
	...
	r.Found = protobuf_go_lite.CloneSlice(m.Found)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *GetBlockExistsBatchResponse) EqualVT(that *GetBlockExistsBatchResponse) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.Found, that.Found) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *GetBlockExistsBatchResponse) MarshalProtoJSON(s *json.MarshalState) {
	...
	s.WriteObjectStart()
	var wroteField bool
	if len(x.Found) > 0 || s.HasField("found") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("found")
		s.WriteBoolArray(x.Found)
	}
	s.WriteObjectEnd()
}
...
func (m *GetBlockExistsBatchResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Found) > 0 {
		for iNdEx := len(m.Found) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeBool(dAtA, i, m.Found[iNdEx])
		}
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.Found)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *UnmarshalRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.BlockType) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.BlockType)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Data) > 0 {
...
func (m *GetBlockExistsBatchResponse) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeBoolPacked(1, m.Found)
	n += len(m.unknownFields)
	return n
}
...
func (m *BuildTransactionResponse) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintNonZero(1, m.TransactionResourceId)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.CursorResourceId)
	n += len(m.unknownFields)
	return n
}
...
func (m *UnmarshalRequest) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeBytesNonEmpty(1, m.Data)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.BlockType)
	n += len(m.unknownFields)
	return n
}
...
func (x *MountBucketLookupRequest) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MountBucketLookupRequest")
	if x.BucketId != "" {
...
func (x *MountBucketLookupResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MountBucketLookupResponse")
	if x.ResourceId != 0 {
...
func (x *GetRefRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "GetRefRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetRefResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetRefResponse")
	if x.Ref != nil {
...
func (x *FollowRefRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "FollowRefRequest")
	if x.Ref != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Ref)
	}
...
func (x *FollowRefResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "FollowRefResponse")
	if x.ResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.ResourceId)
	}
...
func (x *PutBlockBatchResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "PutBlockBatchResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetBlockExistsBatchResponse) MarshalProtoText() string {
	...
	if len(x.Found) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "found")
		for i, v := range x.Found {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
...
func (x *BuildTransactionRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "BuildTransactionRequest")
	if x.PutOpts != nil {
...
func (x *BuildTransactionResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "BuildTransactionResponse")
	if x.TransactionResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "transaction_resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.TransactionResourceId)
	}
	if x.CursorResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "cursor_resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.CursorResourceId)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *BuildTransactionAtRefRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "BuildTransactionAtRefRequest")
	if x.PutOpts != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "put_opts")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.PutOpts)
	}
...
func (x *BuildTransactionAtRefResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "BuildTransactionAtRefResponse")
	if x.TransactionResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "transaction_resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.TransactionResourceId)
	}
...
func (x *CloneRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "CloneRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CloneResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CloneResponse")
	if x.ResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.ResourceId)
	}
...
func (x *ReleaseRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "ReleaseRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *ReleaseResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "ReleaseResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *UnmarshalRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "UnmarshalRequest")
	if x.Ref != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Ref)
	}
	...
	if x.BlockType != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "block_type")
		protobuf_go_lite.TextWriteString(&sb, x.BlockType)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *UnmarshalResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "UnmarshalResponse")
	if len(x.Data) != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "data")
		protobuf_go_lite.TextWriteBytes(&sb, x.Data)
	}
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.Found) == 0 {
					m.Found = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v bool
					v, iNdEx, err = protobuf_go_lite.DecodeVarintBool(dAtA, iNdEx)
