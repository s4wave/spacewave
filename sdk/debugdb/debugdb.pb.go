...
func (m *BenchmarkResults) CloneVT() *BenchmarkResults {
	...
	if rhs := m.Suites; rhs != nil {
		r.Suites = make([]*BenchmarkSuite, len(rhs))
		for k, v := range rhs {
			r.Suites[k] = v.CloneVT()
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
...
func (m *BenchmarkSuite) CloneVT() *BenchmarkSuite {
	...
	if rhs := m.Metrics; rhs != nil {
		r.Metrics = make([]*BenchmarkMetric, len(rhs))
		for k, v := range rhs {
...
func (this *BenchmarkConfig) EqualVT(that *BenchmarkConfig) bool {
	...
	if len(this.BlockSizes) != len(that.BlockSizes) {
		return false
	}
	for i, vx := range this.BlockSizes {
		vy := that.BlockSizes[i]
		if vx != vy {
			return false
		}
	}
...
func (this *BenchmarkResults) EqualVT(that *BenchmarkResults) bool {
	...
	if len(this.Suites) != len(that.Suites) {
		return false
	}
	for i, vx := range this.Suites {
		vy := that.Suites[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &BenchmarkSuite{}
...
func (m *StorageInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.UserAgent) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.UserAgent)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Goarch) > 0 {
		i -= len(m.Goarch)
		copy(dAtA[i:], m.Goarch)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.Goarch)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Goos) > 0 {
		i -= len(m.Goos)
		copy(dAtA[i:], m.Goos)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.Goos)))
		i--
		dAtA[i] = 0x3a
	}
	if m.SyncIo {
	...
	if len(m.VolumeType) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.VolumeType)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *WatchProgressResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SuiteName) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.SuiteName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *BenchmarkMetric) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MaxMs != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MaxMs))))
		i--
		dAtA[i] = 0x41
	}
	if m.P99Ms != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.P99Ms))))
		i--
		dAtA[i] = 0x39
	}
	if m.P50Ms != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.P50Ms))))
		i--
		dAtA[i] = 0x31
	}
	if m.MinMs != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MinMs))))
		i--
		dAtA[i] = 0x29
	}
	if m.TotalMs != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.TotalMs))))
		i--
		dAtA[i] = 0x21
	}
	if m.Count != 0 {
...
func (m *BenchmarkConfig) SizeVT() (n int) {
	...
	_ = l
	if m.DurationSeconds != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.DurationSeconds))
	}
	if len(m.BlockSizes) > 0 {
		l = 0
...
func (m *WatchProgressResponse) SizeVT() (n int) {
	...
	if m.SuiteIndex != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.SuiteIndex))
	}
	if m.SuiteCount != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.SuiteCount))
	}
	if m.PercentComplete != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.PercentComplete))
	}
	l = len(m.MetricName)
	if l > 0 {
		n += 1 + l + protobuf_go_lite.SizeOfVarint(uint64(l))
...
func (m *BenchmarkResults) SizeVT() (n int) {
	...
	if m.StartTimeUnixMillis != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.StartTimeUnixMillis))
	}
	if m.TotalDurationMillis != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.TotalDurationMillis))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *BenchmarkMetric) SizeVT() (n int) {
	...
	if len(m.Samples) > 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(len(m.Samples)*8)) + len(m.Samples)*8
	}
	n += len(m.unknownFields)
	return n
}
...
func (x *GetStorageInfoRequest) MarshalProtoText() string {
	...
	sb.WriteString("GetStorageInfoRequest {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *GetStorageInfoResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetStorageInfoResponse {")
	if x.Info != nil {
		if sb.Len() > 24 {
			sb.WriteString(" ")
		}
...
func (x *StorageInfo) MarshalProtoText() string {
	...
	if x.VolumeType != "" {
		...
		sb.WriteString("volume_type: ")
		sb.WriteString(strconv.Quote(x.VolumeType))
	}
	...
	if x.Goos != "" {
		...
		sb.WriteString("goos: ")
		sb.WriteString(strconv.Quote(x.Goos))
	}
	if x.Goarch != "" {
		if sb.Len() > 13 {
			sb.WriteString(" ")
		}
		sb.WriteString("goarch: ")
		sb.WriteString(strconv.Quote(x.Goarch))
	}
	if x.UserAgent != "" {
		if sb.Len() > 13 {
			sb.WriteString(" ")
		...
		sb.WriteString(strconv.Quote(x.UserAgent))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *StartBenchmarkRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("StartBenchmarkRequest {")
	if x.Config != nil {
		if sb.Len() > 23 {
			sb.WriteString(" ")
		}
...
func (x *StartBenchmarkResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("StartBenchmarkResponse {")
	if x.ResourceId != 0 {
		if sb.Len() > 24 {
			sb.WriteString(" ")
		}
...
func (x *BenchmarkConfig) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("BenchmarkConfig {")
	if x.DurationSeconds != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("duration_seconds: ")
		sb.WriteString(strconv.FormatUint(uint64(x.DurationSeconds), 10))
	}
	if len(x.BlockSizes) > 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("block_sizes: [")
...
func (x *WatchProgressRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("WatchProgressRequest {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *WatchProgressResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("WatchProgressResponse {")
	if x.SuiteName != "" {
		if sb.Len() > 23 {
			sb.WriteString(" ")
		}
		sb.WriteString("suite_name: ")
		sb.WriteString(strconv.Quote(x.SuiteName))
	}
	if x.SuiteIndex != 0 {
		if sb.Len() > 23 {
			sb.WriteString(" ")
		}
		sb.WriteString("suite_index: ")
		sb.WriteString(strconv.FormatUint(uint64(x.SuiteIndex), 10))
	}
	if x.SuiteCount != 0 {
		if sb.Len() > 23 {
			sb.WriteString(" ")
		}
		sb.WriteString("suite_count: ")
		sb.WriteString(strconv.FormatUint(uint64(x.SuiteCount), 10))
	}
	if x.PercentComplete != 0 {
		if sb.Len() > 23 {
			sb.WriteString(" ")
		}
		sb.WriteString("percent_complete: ")
		sb.WriteString(strconv.FormatUint(uint64(x.PercentComplete), 10))
	}
	if x.MetricName != "" {
		if sb.Len() > 23 {
			sb.WriteString(" ")
...
func (x *GetResultsRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetResultsRequest {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *GetResultsResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetResultsResponse {")
	if x.Results != nil {
		if sb.Len() > 20 {
			sb.WriteString(" ")
		}
...
func (x *BenchmarkResults) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("BenchmarkResults {")
	if x.Info != nil {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
	...
	if len(x.Suites) > 0 {
		...
		for i, v := range x.Suites {
			...
			if v == nil {
				sb.WriteString((&BenchmarkSuite{}).MarshalProtoText())
			} else {
	...
	if x.StartTimeUnixMillis != 0 {
		...
		sb.WriteString("start_time_unix_millis: ")
		sb.WriteString(strconv.FormatUint(uint64(x.StartTimeUnixMillis), 10))
	}
	if x.TotalDurationMillis != 0 {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		sb.WriteString("total_duration_millis: ")
		sb.WriteString(strconv.FormatUint(uint64(x.TotalDurationMillis), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *BenchmarkSuite) MarshalProtoText() string {
	...
	if len(x.Metrics) > 0 {
		...
		for i, v := range x.Metrics {
			...
			if v == nil {
				sb.WriteString((&BenchmarkMetric{}).MarshalProtoText())
			} else {
				sb.WriteString(v.MarshalProtoText())
			}
		}
...
func (x *BenchmarkMetric) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("BenchmarkMetric {")
	if x.Name != "" {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
	...
	if x.TotalMs != 0 {
		...
		sb.WriteString("total_ms: ")
		sb.WriteString(strconv.FormatFloat(x.TotalMs, 'g', -1, 64))
	}
	if x.MinMs != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("min_ms: ")
		sb.WriteString(strconv.FormatFloat(x.MinMs, 'g', -1, 64))
	}
	if x.P50Ms != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("p50_ms: ")
		sb.WriteString(strconv.FormatFloat(x.P50Ms, 'g', -1, 64))
	}
	if x.P99Ms != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("p99_ms: ")
		sb.WriteString(strconv.FormatFloat(x.P99Ms, 'g', -1, 64))
	}
	if x.MaxMs != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("max_ms: ")
		sb.WriteString(strconv.FormatFloat(x.MaxMs, 'g', -1, 64))
	}
	if len(x.Samples) > 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
...
func (m *StorageInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.VolumeType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
