...
func (m *CommitInfo) CloneVT() *CommitInfo {
	...
	r.ParentHashes = protobuf_go_lite.CloneSlice(m.ParentHashes)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *ListRefsResponse) CloneVT() *ListRefsResponse {
	...
	r.HeadRef = m.HeadRef
	r.Branches = protobuf_go_lite.CloneVTSlice(m.Branches)
...
func (m *GetRepoInfoResponse) CloneVT() *GetRepoInfoResponse {
	...
	r.IsEmpty = m.IsEmpty
	r.LastCommit = protobuf_go_lite.CloneVTValue(m.LastCommit)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *LogResponse) CloneVT() *LogResponse {
	...
	r := new(LogResponse)
	r.HasMore = m.HasMore
	r.Commits = protobuf_go_lite.CloneVTSlice(m.Commits)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *CommitInfo) EqualVT(that *CommitInfo) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.ParentHashes, that.ParentHashes) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *ListRefsResponse) EqualVT(that *ListRefsResponse) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Branches, that.Branches, func() *RefInfo { return &RefInfo{} }) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Tags, that.Tags, func() *RefInfo { return &RefInfo{} }) {
		return false
	}
...
func (this *GetRepoInfoResponse) EqualVT(that *GetRepoInfoResponse) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.LastCommit, that.LastCommit) {
		return false
	}
...
func (this *LogResponse) EqualVT(that *LogResponse) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Commits, that.Commits, func() *CommitInfo { return &CommitInfo{} }) {
		return false
	}
...
func (this *GetDiffStatResponse) EqualVT(that *GetDiffStatResponse) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Files, that.Files, func() *DiffFileStat { return &DiffFileStat{} }) {
		return false
	}
...
func (m *RefInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.IsHead {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.IsHead)
		i--
		dAtA[i] = 0x18
	}
	if len(m.CommitHash) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.CommitHash)
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
...
func (m *CommitInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ParentHashes) > 0 {
		for iNdEx := len(m.ParentHashes) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.ParentHashes[iNdEx])
			i--
			dAtA[i] = 0x32
		}
	}
	...
	if len(m.AuthorEmail) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.AuthorEmail)
		i--
		dAtA[i] = 0x22
	}
	if len(m.AuthorName) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.AuthorName)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Message) > 0 {
...
func (m *ListRefsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.HeadRef) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.HeadRef)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Tags) > 0 {
...
func (m *ResolveRefRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RefName) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.RefName)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ResolveRefResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TreeHash) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.TreeHash)
		i--
		dAtA[i] = 0x12
	}
	if len(m.CommitHash) > 0 {
...
func (m *GetRepoInfoResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.IsEmpty {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.IsEmpty)
		i--
		dAtA[i] = 0x28
	}
	if m.LastCommit != nil {
	...
	if len(m.ReadmePath) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ReadmePath)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.HeadCommitHash) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.HeadCommitHash)
		i--
		dAtA[i] = 0x12
	}
	if len(m.HeadRef) > 0 {
...
func (m *LogRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SinceRef) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.SinceRef)
		i--
		dAtA[i] = 0x22
	}
	if m.Limit != 0 {
...
func (m *GetDiffStatRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RefB) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.RefB)
		i--
		dAtA[i] = 0x12
	}
	if len(m.RefA) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.RefA)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GetDiffPatchResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Patch) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.Patch)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RefInfo) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.CommitHash)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.IsHead)
...
func (m *CommitInfo) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.AuthorName)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.AuthorEmail)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.AuthorTimestamp)
	n += protobuf_go_lite.SizeStringSlice(1, m.ParentHashes)
	n += len(m.unknownFields)
	return n
}
...
func (m *ListRefsResponse) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.HeadRef)
	n += len(m.unknownFields)
	return n
}
...
func (m *ResolveRefRequest) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.RefName)
	n += len(m.unknownFields)
	return n
}
...
func (m *ResolveRefResponse) SizeVT() (n int) {
	...
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.CommitHash)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.TreeHash)
	n += len(m.unknownFields)
	return n
}
...
func (m *GetRepoInfoResponse) SizeVT() (n int) {
	...
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.HeadRef)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.HeadCommitHash)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ReadmePath)
	if m.LastCommit != nil {
		l = m.LastCommit.SizeVT()
		n += protobuf_go_lite.SizeMessage(1, l)
	}
	n += protobuf_go_lite.SizeBoolNonZero(1, m.IsEmpty)
	n += len(m.unknownFields)
	return n
}
...
func (m *LogRequest) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.SinceRef)
	n += len(m.unknownFields)
	return n
}
...
func (m *GetDiffStatRequest) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.RefA)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.RefB)
	n += len(m.unknownFields)
	return n
}
...
func (m *GetDiffStatResponse) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.TotalAdditions)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.TotalDeletions)
	n += len(m.unknownFields)
	return n
}
...
func (m *DiffFileStat) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Additions)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Deletions)
	n += len(m.unknownFields)
	return n
}
...
func (x *RefInfo) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "RefInfo")
	if x.Name != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "name")
		protobuf_go_lite.TextWriteString(&sb, x.Name)
	}
	if x.CommitHash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "commit_hash")
		protobuf_go_lite.TextWriteString(&sb, x.CommitHash)
	}
	if x.IsHead != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_head")
		protobuf_go_lite.TextWriteBool(&sb, x.IsHead)
	}
...
func (x *CommitInfo) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CommitInfo")
	if x.Hash != "" {
	...
	if x.AuthorName != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "author_name")
		protobuf_go_lite.TextWriteString(&sb, x.AuthorName)
	}
	if x.AuthorEmail != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "author_email")
		protobuf_go_lite.TextWriteString(&sb, x.AuthorEmail)
	}
	if x.AuthorTimestamp != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "author_timestamp")
		protobuf_go_lite.TextWriteInt(&sb, x.AuthorTimestamp)
	}
...
func (x *ListRefsRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "ListRefsRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *ListRefsResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ListRefsResponse")
	if len(x.Branches) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "branches")
		for i, v := range x.Branches {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &RefInfo{})
			} else {
	...
	if x.HeadRef != "" {
		...
		protobuf_go_lite.TextWriteString(&sb, x.HeadRef)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *ResolveRefRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ResolveRefRequest")
	if x.RefName != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref_name")
		protobuf_go_lite.TextWriteString(&sb, x.RefName)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *ResolveRefResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ResolveRefResponse")
	if x.CommitHash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "commit_hash")
		protobuf_go_lite.TextWriteString(&sb, x.CommitHash)
	}
	if x.TreeHash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "tree_hash")
		protobuf_go_lite.TextWriteString(&sb, x.TreeHash)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetRepoInfoRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "GetRepoInfoRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetRepoInfoResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetRepoInfoResponse")
	if x.HeadRef != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "head_ref")
		protobuf_go_lite.TextWriteString(&sb, x.HeadRef)
	}
	if x.HeadCommitHash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "head_commit_hash")
		protobuf_go_lite.TextWriteString(&sb, x.HeadCommitHash)
	}
	if x.ReadmePath != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "readme_path")
		protobuf_go_lite.TextWriteString(&sb, x.ReadmePath)
	}
	if x.LastCommit != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "last_commit")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.LastCommit)
	}
	if x.IsEmpty != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_empty")
		protobuf_go_lite.TextWriteBool(&sb, x.IsEmpty)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetTreeResourceRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetTreeResourceRequest")
	if x.RefName != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref_name")
		protobuf_go_lite.TextWriteString(&sb, x.RefName)
	}
...
func (x *GetTreeResourceResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetTreeResourceResponse")
	if x.ResourceId != 0 {
...
func (x *GetRepoFilesystemResourceRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetRepoFilesystemResourceRequest")
	if x.Writable != false {
...
func (x *GetRepoFilesystemResourceResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetRepoFilesystemResourceResponse")
	if x.ResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.ResourceId)
	}
...
func (x *LogRequest) MarshalProtoText() string {
	...
	if x.SinceRef != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "since_ref")
		protobuf_go_lite.TextWriteString(&sb, x.SinceRef)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *LogResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "LogResponse")
	if len(x.Commits) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "commits")
		for i, v := range x.Commits {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CommitInfo{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
...
func (x *GetCommitRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetCommitRequest")
	if x.Hash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "hash")
		protobuf_go_lite.TextWriteString(&sb, x.Hash)
	}
...
func (x *GetCommitResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetCommitResponse")
	if x.Commit != nil {
...
func (x *GetDiffStatRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetDiffStatRequest")
	if x.RefA != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref_a")
		protobuf_go_lite.TextWriteString(&sb, x.RefA)
	}
	if x.RefB != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref_b")
		protobuf_go_lite.TextWriteString(&sb, x.RefB)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetDiffStatResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetDiffStatResponse")
	if len(x.Files) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "files")
		for i, v := range x.Files {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &DiffFileStat{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
	...
	if x.TotalAdditions != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "total_additions")
		protobuf_go_lite.TextWriteUint(&sb, x.TotalAdditions)
	}
	if x.TotalDeletions != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "total_deletions")
		protobuf_go_lite.TextWriteUint(&sb, x.TotalDeletions)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetDiffPatchRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetDiffPatchRequest")
	if x.RefA != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ref_a")
		protobuf_go_lite.TextWriteString(&sb, x.RefA)
	}
...
func (x *GetDiffPatchResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetDiffPatchResponse")
	if x.Patch != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "patch")
		protobuf_go_lite.TextWriteString(&sb, x.Patch)
	}
	...
	if x.LimitBytes != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "limit_bytes")
		protobuf_go_lite.TextWriteUint(&sb, x.LimitBytes)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *DiffFileStat) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "DiffFileStat")
	if x.Path != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "path")
		protobuf_go_lite.TextWriteString(&sb, x.Path)
	}
	if x.Additions != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "additions")
		protobuf_go_lite.TextWriteUint(&sb, x.Additions)
	}
	if x.Deletions != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "deletions")
		protobuf_go_lite.TextWriteUint(&sb, x.Deletions)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *ListRefsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Branches[len(m.Branches)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *GetRepoInfoResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.LastCommit.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *LogResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Commits[len(m.Commits)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
