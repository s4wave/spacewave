...
func (m *CommitFilesResponse) CloneVT() *CommitFilesResponse {
	...
	r.AffectedPaths = protobuf_go_lite.CloneSlice(m.AffectedPaths)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *WatchStatusResponse) EqualVT(that *WatchStatusResponse) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Entries, that.Entries, func() *StatusEntry { return &StatusEntry{} }) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *CommitFilesResponse) EqualVT(that *CommitFilesResponse) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.AffectedPaths, that.AffectedPaths) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *GetWorktreeInfoResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HasWorkdir {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.HasWorkdir)
		i--
		dAtA[i] = 0x28
	}
	...
	if len(m.CheckedOutRef) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.CheckedOutRef)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.WorkdirObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.WorkdirObjectKey)
		i--
		dAtA[i] = 0x12
	}
...
func (m *StatusEntry) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FilePath) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.FilePath)
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CommitFilesResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AffectedPaths) > 0 {
		for iNdEx := len(m.AffectedPaths) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.AffectedPaths[iNdEx])
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.BranchRef) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.BranchRef)
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BaseCommitHash) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.BaseCommitHash)
		i--
		dAtA[i] = 0x12
	}
...
func (m *GetWorktreeInfoResponse) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.WorkdirObjectKey)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.CheckedOutRef)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.HeadCommitHash)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.HasWorkdir)
	n += len(m.unknownFields)
	return n
}
...
func (m *StatusEntry) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.FilePath)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.StagingStatus)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.WorktreeStatus)
	n += len(m.unknownFields)
	return n
}
...
func (m *CommitFilesResponse) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.BaseCommitHash)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.BranchRef)
	n += protobuf_go_lite.SizeStringSlice(1, m.AffectedPaths)
	n += len(m.unknownFields)
	return n
}
...
func (x *GetWorktreeInfoRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "GetWorktreeInfoRequest")
...
func (x *GetWorktreeInfoResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetWorktreeInfoResponse")
	if x.RepoObjectKey != "" {
	...
	if x.WorkdirObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "workdir_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.WorkdirObjectKey)
	}
	if x.CheckedOutRef != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "checked_out_ref")
		protobuf_go_lite.TextWriteString(&sb, x.CheckedOutRef)
	}
	if x.HeadCommitHash != "" {
	...
	if x.HasWorkdir != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "has_workdir")
		protobuf_go_lite.TextWriteBool(&sb, x.HasWorkdir)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetRepoResourceRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "GetRepoResourceRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetRepoResourceResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetRepoResourceResponse")
	if x.ResourceId != 0 {
...
func (x *GetWorkdirResourceRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "GetWorkdirResourceRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *GetWorkdirResourceResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "GetWorkdirResourceResponse")
	if x.ResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.ResourceId)
	}
...
func (x *StatusEntry) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "StatusEntry")
	if x.FilePath != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "file_path")
		protobuf_go_lite.TextWriteString(&sb, x.FilePath)
	}
	if x.StagingStatus != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "staging_status")
		protobuf_go_lite.TextWriteStringer(&sb, FileStatusCode(x.StagingStatus))
	}
	if x.WorktreeStatus != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "worktree_status")
		protobuf_go_lite.TextWriteStringer(&sb, FileStatusCode(x.WorktreeStatus))
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WatchStatusRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "WatchStatusRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WatchStatusResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WatchStatusResponse")
	if len(x.Entries) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "entries")
		for i, v := range x.Entries {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &StatusEntry{})
			} else {
...
func (x *StageFilesRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "StageFilesRequest")
	if len(x.Paths) > 0 {
...
func (x *StageFilesResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "StageFilesResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *UnstageFilesRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "UnstageFilesRequest")
	if len(x.Paths) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "paths")
		for i, v := range x.Paths {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
...
func (x *UnstageFilesResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "UnstageFilesResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CommitFilesRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CommitFilesRequest")
	if len(x.Paths) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "paths")
		for i, v := range x.Paths {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
...
func (x *CommitFilesResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CommitFilesResponse")
	if x.CommitHash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "commit_hash")
		protobuf_go_lite.TextWriteString(&sb, x.CommitHash)
	}
	if x.BaseCommitHash != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "base_commit_hash")
		protobuf_go_lite.TextWriteString(&sb, x.BaseCommitHash)
	}
	if x.BranchRef != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "branch_ref")
		protobuf_go_lite.TextWriteString(&sb, x.BranchRef)
	}
	if len(x.AffectedPaths) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "affected_paths")
...
func (m *CommitFilesResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.AffectedPaths = append(m.AffectedPaths, v)
		default:
			iNdEx = preIndex
			skippy, err := protobuf_go_lite.Skip(dAtA[iNdEx:])
			if err != nil {
