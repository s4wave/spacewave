...
type RegisterObjectTypeRequest struct {
	...
	AttachedHandlerResourceId uint32 `protobuf:"varint,4,opt,name=attached_handler_resource_id,json=attachedHandlerResourceId,proto3" json:"attachedHandlerResourceId,omitempty"`
}
...
func (x *RegisterObjectTypeRequest) GetAttachedHandlerResourceId() uint32 {
	if x != nil {
		return x.AttachedHandlerResourceId
	}
	return 0
}
...
func (x *WatchObjectTypesRequest) GetInstanceKey() string {
	if x != nil {
...
func (m *RegisterObjectTypeRequest) CloneVT() *RegisterObjectTypeRequest {
	...
	r.TypeId = m.TypeId
	r.PluginId = m.PluginId
	r.AttachedHandlerResourceId = m.AttachedHandlerResourceId
	r.Metadata = protobuf_go_lite.CloneVTValue(m.Metadata)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
...
func (this *RegisterObjectTypeRequest) EqualVT(that *RegisterObjectTypeRequest) bool {
	...
	if this.AttachedHandlerResourceId != that.AttachedHandlerResourceId {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (x *RegisterObjectTypeRequest) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.AttachedHandlerResourceId != 0 || s.HasField("attachedHandlerResourceId") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("attachedHandlerResourceId")
		s.WriteUint32(x.AttachedHandlerResourceId)
	}
	s.WriteObjectEnd()
}
...
func (x *RegisterObjectTypeRequest) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "metadata":
			...
			x.Metadata = &ObjectTypeMetadata{}
			x.Metadata.UnmarshalProtoJSON(s.WithField("metadata", true))
		case "attached_handler_resource_id", "attachedHandlerResourceId":
			s.AddField("attached_handler_resource_id")
			x.AttachedHandlerResourceId = s.ReadUint32()
		}
	})
}
...
func (m *RegisterObjectTypeRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.AttachedHandlerResourceId != 0 {
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(m.AttachedHandlerResourceId))
		i--
		dAtA[i] = 0x20
	}
	if m.Metadata != nil {
...
func (m *RegisterObjectTypeRequest) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.AttachedHandlerResourceId)
	n += len(m.unknownFields)
	return n
}
...
func (x *RegisterObjectTypeRequest) MarshalProtoText() string {
	...
	if x.AttachedHandlerResourceId != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "attached_handler_resource_id")
		protobuf_go_lite.TextWriteUint(&sb, x.AttachedHandlerResourceId)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *WatchObjectTypesRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WatchObjectTypesRequest")
	if x.InstanceKey != "" {
...
func (m *RegisterObjectTypeRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AttachedHandlerResourceId", wireType)
			}
			m.AttachedHandlerResourceId = 0
			m.AttachedHandlerResourceId, iNdEx, err = protobuf_go_lite.DecodeVarintUint32(dAtA, iNdEx)
			if err != nil {
				return err
			}
		default:
