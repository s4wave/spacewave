...
func (x *ExecuteRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "ExecuteRequest")
...
func (x *ExecuteStatus) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ExecuteStatus")
	if x.State != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "state")
		protobuf_go_lite.TextWriteStringer(&sb, ExecutionState(x.State))
	}
	if x.Error != "" {
