...
pub struct WatchSyncStatusResponse {
    ...
    #[prost(uint64, tag="53")]
    pub active_upload_transferred_bytes: u64,
    /// InFlightUploadCount is the number of active upload requests.
    #[prost(uint32, tag="54")]
    pub in_flight_upload_count: u32,
...
pub struct WatchSharedObjectSelfEnrollmentStateResponse {
    ...
    #[prost(string, tag="6")]
    pub current_shared_object_id: ::prost::alloc::string::String,
    /// CompletedSharedObjectIds is the set completed by the current run.
    #[prost(string, repeated, tag="7")]
    pub completed_shared_object_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct StartSharedObjectSelfEnrollmentRequest {
}
/// StartSharedObjectSelfEnrollmentResponse is the response for Start.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct StartSharedObjectSelfEnrollmentResponse {
}
/// SkipSharedObjectSelfEnrollmentRequest is the request for Skip.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SkipSharedObjectSelfEnrollmentRequest {
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SkipSharedObjectSelfEnrollmentResponse {
}
/// SharedObjectSelfEnrollmentErrorCategory classifies per-object failures.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum SharedObjectSelfEnrollmentErrorCategory {
...
impl SharedObjectSelfEnrollmentErrorCategory {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unknown => "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_UNKNOWN",
            Self::Retry => "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_RETRY",
            Self::OpenObject => "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_OPEN_OBJECT",
            Self::Report => "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_REPORT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_UNKNOWN" => Some(Self::Unknown),
            "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_RETRY" => Some(Self::Retry),
            "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_OPEN_OBJECT" => Some(Self::OpenObject),
            "SHARED_OBJECT_SELF_ENROLLMENT_ERROR_CATEGORY_REPORT" => Some(Self::Report),
            _ => None,
        }
    }
}
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct MountSharedObjectSelfEnrollmentRequest {
}
/// MountSharedObjectSelfEnrollmentResponse is the response for MountSharedObjectSelfEnrollment.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct MountSharedObjectSelfEnrollmentResponse {
