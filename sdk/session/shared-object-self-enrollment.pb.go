...
func (m *WatchSharedObjectSelfEnrollmentStateResponse) CloneVT() *WatchSharedObjectSelfEnrollmentStateResponse {
	...
	r.CompletedSharedObjectIds = protobuf_go_lite.CloneSlice(m.CompletedSharedObjectIds)
	r.Failures = protobuf_go_lite.CloneVTSlice(m.Failures)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *WatchSharedObjectSelfEnrollmentStateResponse) EqualVT(that *WatchSharedObjectSelfEnrollmentStateResponse) bool {
	...
	if !protobuf_go_lite.EqualSlice(this.CompletedSharedObjectIds, that.CompletedSharedObjectIds) {
		return false
	}
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Failures, that.Failures, func() *SharedObjectSelfEnrollmentFailure { return &SharedObjectSelfEnrollmentFailure{} }) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *WatchSharedObjectSelfEnrollmentStateResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SkippedGenerationKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.SkippedGenerationKey)
		i--
		dAtA[i] = 0x4a
	}
	if m.Skipped {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.Skipped)
		i--
		dAtA[i] = 0x40
	}
	if len(m.CompletedSharedObjectIds) > 0 {
		for iNdEx := len(m.CompletedSharedObjectIds) - 1; iNdEx >= 0; iNdEx-- {
			i = protobuf_go_lite.EncodeString(dAtA, i, m.CompletedSharedObjectIds[iNdEx])
			i--
			dAtA[i] = 0x3a
		}
	}
	if len(m.CurrentSharedObjectId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.CurrentSharedObjectId)
		i--
		dAtA[i] = 0x32
	}
	if m.Running {
	...
	if m.CredentialRequired {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.CredentialRequired)
		i--
		dAtA[i] = 0x20
	}
	if m.Count != 0 {
	...
	if len(m.GenerationKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.GenerationKey)
		i--
		dAtA[i] = 0x12
	}
...
func (m *WatchSharedObjectSelfEnrollmentStateResponse) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.GenerationKey)
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Count)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.CredentialRequired)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Running)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.CurrentSharedObjectId)
	n += protobuf_go_lite.SizeStringSlice(1, m.CompletedSharedObjectIds)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Skipped)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.SkippedGenerationKey)
...
func (m *SharedObjectSelfEnrollmentFailure) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.Category)
...
func (x *WatchSharedObjectSelfEnrollmentStateRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "WatchSharedObjectSelfEnrollmentStateRequest")
...
func (x *WatchSharedObjectSelfEnrollmentStateResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "WatchSharedObjectSelfEnrollmentStateResponse")
	...
	if x.GenerationKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "generation_key")
		protobuf_go_lite.TextWriteString(&sb, x.GenerationKey)
	}
	if x.Count != 0 {
	...
	if x.CredentialRequired != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "credential_required")
		protobuf_go_lite.TextWriteBool(&sb, x.CredentialRequired)
	}
	if x.Running != false {
	...
	if x.CurrentSharedObjectId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "current_shared_object_id")
		protobuf_go_lite.TextWriteString(&sb, x.CurrentSharedObjectId)
	}
	if len(x.CompletedSharedObjectIds) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "completed_shared_object_ids")
	...
	if x.Skipped != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "skipped")
		protobuf_go_lite.TextWriteBool(&sb, x.Skipped)
	}
	if x.SkippedGenerationKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "skipped_generation_key")
		protobuf_go_lite.TextWriteString(&sb, x.SkippedGenerationKey)
	}
	if len(x.Failures) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "failures")
		for i, v := range x.Failures {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &SharedObjectSelfEnrollmentFailure{})
			} else {
...
func (x *SharedObjectSelfEnrollmentFailure) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SharedObjectSelfEnrollmentFailure")
	if x.SharedObjectId != "" {
	...
	if x.Category != 0 {
		...
		protobuf_go_lite.TextWriteStringer(&sb, SharedObjectSelfEnrollmentErrorCategory(x.Category))
	}
	if x.Message != "" {
...
func (x *StartSharedObjectSelfEnrollmentRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "StartSharedObjectSelfEnrollmentRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *StartSharedObjectSelfEnrollmentResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "StartSharedObjectSelfEnrollmentResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *SkipSharedObjectSelfEnrollmentRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SkipSharedObjectSelfEnrollmentRequest")
	if x.GenerationKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "generation_key")
		protobuf_go_lite.TextWriteString(&sb, x.GenerationKey)
	}
...
func (x *SkipSharedObjectSelfEnrollmentResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "SkipSharedObjectSelfEnrollmentResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (m *WatchSharedObjectSelfEnrollmentStateResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.CompletedSharedObjectIds = append(m.CompletedSharedObjectIds, v)
		case 8:
			if wireType != 0 {
		...
		case 10:
			...
			if err := m.Failures[len(m.Failures)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
