...
func (x *MountSharedObjectSelfEnrollmentRequest) MarshalProtoText() string {
	...
	protobuf_go_lite.TextStartMessage(&sb, "MountSharedObjectSelfEnrollmentRequest")
...
func (x *MountSharedObjectSelfEnrollmentResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MountSharedObjectSelfEnrollmentResponse")
	if x.ResourceId != 0 {
