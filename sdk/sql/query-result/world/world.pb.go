...
func (m *SqlQueryResultSetRootOp) CloneVT() *SqlQueryResultSetRootOp {
	if m == nil {
		return (*SqlQueryResultSetRootOp)(nil)
	}
	r := new(SqlQueryResultSetRootOp)
...
func (m *SqlQueryResultSetRootOp) CloneMessageVT() protobuf_go_lite.CloneMessage {
	return m.CloneVT()
}

func (this *SqlQueryResultSetRootOp) EqualVT(that *SqlQueryResultSetRootOp) bool {
	if this == that {
		return true
...
func (this *SqlQueryResultSetRootOp) EqualMessageVT(thatMsg any) bool {
	that, ok := thatMsg.(*SqlQueryResultSetRootOp)
	if !ok {
		return false
	}
...
func (x *SqlQueryResultSetRootOp) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SqlQueryResultSetRootOp")
	if x.ObjectKey != "" {
...
func (m *SqlQueryResultSetRootOp) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: SqlQueryResultSetRootOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SqlQueryResultSetRootOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
