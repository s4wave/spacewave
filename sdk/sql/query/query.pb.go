...
func (m *Query) CloneVT() *Query {
	...
	if rhs := m.Parameters; rhs != nil {
		r.Parameters = make([]*sql.SqlValue, len(rhs))
		for k, v := range rhs {
			r.Parameters[k] = v.CloneVT()
		}
	}
...
func (m *Query) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.DialectHint) > 0 {
		i -= len(m.DialectHint)
		copy(dAtA[i:], m.DialectHint)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.DialectHint)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.SqlText) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.SqlText)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *RunQueryResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ResultObjectKey) > 0 {
		i -= len(m.ResultObjectKey)
		copy(dAtA[i:], m.ResultObjectKey)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.ResultObjectKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RunQueryRequest) SizeVT() (n int) {
	...
	_ = l
	if m.MaxRows != 0 {
		n += 1 + protobuf_go_lite.SizeOfVarint(uint64(m.MaxRows))
	}
	n += len(m.unknownFields)
	return n
}
...
func (x *Query) MarshalProtoText() string {
	...
	if x.SqlText != "" {
		...
		sb.WriteString("sql_text: ")
		sb.WriteString(strconv.Quote(x.SqlText))
	}
	...
	if x.DialectHint != "" {
		...
		sb.WriteString("dialect_hint: ")
		sb.WriteString(strconv.Quote(x.DialectHint))
	}
...
func (x *GetQueryTextRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetQueryTextRequest {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *GetQueryTextResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetQueryTextResponse {")
	if x.SqlText != "" {
		if sb.Len() > 22 {
			sb.WriteString(" ")
		}
...
func (x *SetQueryTextRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SetQueryTextRequest {")
	if x.SqlText != "" {
		if sb.Len() > 21 {
			sb.WriteString(" ")
		}
...
func (x *SetQueryTextResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SetQueryTextResponse {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *SetParametersRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SetParametersRequest {")
	if len(x.Parameters) > 0 {
		if sb.Len() > 22 {
			sb.WriteString(" ")
		}
...
func (x *SetParametersResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("SetParametersResponse {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *RunQueryRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("RunQueryRequest {")
	if x.MaxRows != 0 {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
		sb.WriteString("max_rows: ")
		sb.WriteString(strconv.FormatUint(uint64(x.MaxRows), 10))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *RunQueryResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("RunQueryResponse {")
	if x.ResultObjectKey != "" {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
		sb.WriteString("result_object_key: ")
		sb.WriteString(strconv.Quote(x.ResultObjectKey))
	}
	if x.Error != "" {
		if sb.Len() > 18 {
			sb.WriteString(" ")
...
func (m *Query) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.DialectHint = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *RunQueryResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ResultObjectKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
