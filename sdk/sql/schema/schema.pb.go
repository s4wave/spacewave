...
func (m *ListTablesResponse) CloneVT() *ListTablesResponse {
	...
	if rhs := m.Tables; rhs != nil {
		r.Tables = make([]*TableInfo, len(rhs))
		for k, v := range rhs {
...
func (m *Schema) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SchemaName) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.SchemaName)))
		i--
		dAtA[i] = 0xa
	}
...
func (x *Schema) MarshalProtoText() string {
	...
	if x.SchemaName != "" {
		...
		sb.WriteString(strconv.Quote(x.SchemaName))
	}
...
func (x *GetSchemaRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetSchemaRequest {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *GetSchemaResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("GetSchemaResponse {")
	if x.Schema != nil {
		if sb.Len() > 19 {
			sb.WriteString(" ")
		}
		sb.WriteString("schema: ")
		sb.WriteString(x.Schema.MarshalProtoText())
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (x *ListTablesRequest) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ListTablesRequest {")
	sb.WriteString("}")
	return sb.String()
}
...
func (x *ListTablesResponse) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("ListTablesResponse {")
	if len(x.Tables) > 0 {
		if sb.Len() > 20 {
			sb.WriteString(" ")
		}
		...
		for i, v := range x.Tables {
			...
			if v == nil {
				sb.WriteString((&TableInfo{}).MarshalProtoText())
			} else {
