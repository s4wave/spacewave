...
type MarkTestResultRequest struct {
	...
	TestName string `protobuf:"bytes,3,opt,name=test_name,json=testName,proto3" json:"testName,omitempty"`
}
...
func (x *MarkTestResultRequest) GetTestName() string {
	if x != nil {
		return x.TestName
	}
	return ""
...
type ClaimTestRequest struct {
	unknownFields []byte
}

func (x *ClaimTestRequest) Reset() {
	*x = ClaimTestRequest{}
}

func (*ClaimTestRequest) ProtoMessage() {}

// ClaimTestResponse is the response type for ClaimTest.
type ClaimTestResponse struct {
	unknownFields []byte
	// TestName is the next queued test case name.
	TestName string `protobuf:"bytes,1,opt,name=test_name,json=testName,proto3" json:"testName,omitempty"`
...
func (x *ClaimTestResponse) Reset() {
	*x = ClaimTestResponse{}
}

func (*ClaimTestResponse) ProtoMessage() {}

func (x *ClaimTestResponse) GetTestName() string {
	if x != nil {
		return x.TestName
	}
	return ""
...
func (x *ClaimTestResponse) GetClosed() bool {
	if x != nil {
		return x.Closed
	}
	return false
...
func (m *ClaimTestRequest) CloneVT() *ClaimTestRequest {
	if m == nil {
		return (*ClaimTestRequest)(nil)
	}
	r := new(ClaimTestRequest)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *ClaimTestRequest) CloneMessageVT() protobuf_go_lite.CloneMessage {
	return m.CloneVT()
}

func (m *ClaimTestResponse) CloneVT() *ClaimTestResponse {
	if m == nil {
		return (*ClaimTestResponse)(nil)
	}
	r := new(ClaimTestResponse)
	r.TestName = m.TestName
	r.Closed = m.Closed
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
...
func (m *ClaimTestResponse) CloneMessageVT() protobuf_go_lite.CloneMessage {
	return m.CloneVT()
}
...
func (this *MarkTestResultRequest) EqualVT(that *MarkTestResultRequest) bool {
	...
	if this.TestName != that.TestName {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *ClaimTestRequest) EqualVT(that *ClaimTestRequest) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ClaimTestRequest) EqualMessageVT(thatMsg any) bool {
	that, ok := thatMsg.(*ClaimTestRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *ClaimTestResponse) EqualVT(that *ClaimTestResponse) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ClaimTestResponse) EqualMessageVT(thatMsg any) bool {
	that, ok := thatMsg.(*ClaimTestResponse)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (x *MarkTestResultRequest) MarshalProtoJSON(s *json.MarshalState) {
	...
	if x.TestName != "" || s.HasField("testName") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("testName")
		s.WriteString(x.TestName)
	}
	s.WriteObjectEnd()
}
...
func (x *MarkTestResultRequest) UnmarshalProtoJSON(s *json.UnmarshalState) {
	...
	s.ReadObject(func(key string) {
		...
		case "test_name", "testName":
			s.AddField("test_name")
			x.TestName = s.ReadString()
		}
	})
}
...
// MarshalProtoJSON marshals the ClaimTestRequest message to JSON.
func (x *ClaimTestRequest) MarshalProtoJSON(s *json.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
...
// MarshalJSON marshals the ClaimTestRequest to JSON.
func (x *ClaimTestRequest) MarshalJSON() ([]byte, error) {
	return json.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the ClaimTestRequest message from JSON.
func (x *ClaimTestRequest) UnmarshalProtoJSON(s *json.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
...
// UnmarshalJSON unmarshals the ClaimTestRequest from JSON.
func (x *ClaimTestRequest) UnmarshalJSON(b []byte) error {
	return json.DefaultUnmarshalerConfig.Unmarshal(b, x)
}

// MarshalProtoJSON marshals the ClaimTestResponse message to JSON.
func (x *ClaimTestResponse) MarshalProtoJSON(s *json.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
...
// MarshalJSON marshals the ClaimTestResponse to JSON.
func (x *ClaimTestResponse) MarshalJSON() ([]byte, error) {
	return json.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the ClaimTestResponse message from JSON.
func (x *ClaimTestResponse) UnmarshalProtoJSON(s *json.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
...
// UnmarshalJSON unmarshals the ClaimTestResponse from JSON.
func (x *ClaimTestResponse) UnmarshalJSON(b []byte) error {
	return json.DefaultUnmarshalerConfig.Unmarshal(b, x)
}
...
func (m *MarkTestResultRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TestName) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.TestName)
		i--
		dAtA[i] = 0x1a
	}
...
func (m *ClaimTestRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ClaimTestRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ClaimTestRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ClaimTestResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ClaimTestResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ClaimTestResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *MarkTestResultRequest) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.TestName)
	n += len(m.unknownFields)
	return n
}
...
func (m *ClaimTestRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClaimTestResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (x *CreateWorldRequest) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CreateWorldRequest")
	if x.EngineId != "" {
...
func (x *CreateWorldResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CreateWorldResponse")
	if x.ResourceId != 0 {
...
func (x *MarkTestResultRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MarkTestResultRequest")
	if x.Success != false {
	...
	if x.TestName != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "test_name")
		protobuf_go_lite.TextWriteString(&sb, x.TestName)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *MarkTestResultResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "MarkTestResultResponse")
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *ClaimTestRequest) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	protobuf_go_lite.TextStartMessage(&sb, "ClaimTestRequest")
	return protobuf_go_lite.TextFinishMessage(&sb)
}

func (x *ClaimTestRequest) String() string {
	return x.MarshalProtoText()
}

func (x *ClaimTestResponse) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "ClaimTestResponse")
	if x.TestName != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "test_name")
		protobuf_go_lite.TextWriteString(&sb, x.TestName)
	}
...
func (x *ClaimTestResponse) String() string {
	return x.MarshalProtoText()
}
...
func (m *ClaimTestRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	var err error
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClaimTestRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClaimTestRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ClaimTestResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	var err error
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClaimTestResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClaimTestResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
