...
func (this *V86Config) EqualVT(that *V86Config) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Mounts, that.Mounts, func() *VmMount { return &VmMount{} }) {
		return false
	}
...
func (this *CreateV86ImageOp) EqualVT(that *CreateV86ImageOp) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.Image, that.Image) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.Timestamp, that.Timestamp) {
		return false
...
func (m *V86Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RuntimePluginId) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.RuntimePluginId)
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Mounts) > 0 {
	...
	if len(m.BootArgs) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.BootArgs)
		i--
		dAtA[i] = 0x2a
	}
	if m.SerialEnabled {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.SerialEnabled)
		i--
		dAtA[i] = 0x20
	}
	if m.Networking {
		i = protobuf_go_lite.EncodeBool(dAtA, i, m.Networking)
		i--
		dAtA[i] = 0x18
	}
	if m.VgaMemoryMb != 0 {
...
func (m *CreateVmV86Op) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.WasmOverrideObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.WasmOverrideObjectKey)
		i--
		dAtA[i] = 0x4a
	}
	if len(m.BiosOverrideObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.BiosOverrideObjectKey)
		i--
		dAtA[i] = 0x42
	}
	if len(m.RootfsOverrideObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.RootfsOverrideObjectKey)
		i--
		dAtA[i] = 0x3a
	}
	if len(m.KernelOverrideObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.KernelOverrideObjectKey)
		i--
		dAtA[i] = 0x32
	}
	if len(m.ImageObjectKey) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.ImageObjectKey)
		i--
		dAtA[i] = 0x2a
	}
	if m.Timestamp != nil {
...
func (m *V86Image) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.KernelVersion) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.KernelVersion)
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Distro) > 0 {
		i = protobuf_go_lite.EncodeString(dAtA, i, m.Distro)
		i--
		dAtA[i] = 0x22
	}
	if len(m.Platform) > 0 {
...
func (m *V86Config) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintNonZero(1, m.VgaMemoryMb)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.Networking)
	n += protobuf_go_lite.SizeBoolNonZero(1, m.SerialEnabled)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.BootArgs)
	for _, e := range m.Mounts {
		l = e.SizeVT()
		n += protobuf_go_lite.SizeMessage(1, l)
	}
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.RuntimePluginId)
...
func (m *CreateVmV86Op) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.ImageObjectKey)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.KernelOverrideObjectKey)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.RootfsOverrideObjectKey)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.BiosOverrideObjectKey)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.WasmOverrideObjectKey)
	n += len(m.unknownFields)
	return n
}
...
func (m *V86Image) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.Distro)
	n += protobuf_go_lite.SizeStringNonEmpty(1, m.KernelVersion)
...
func (x *V86Config) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "V86Config")
	if x.MemoryMb != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "memory_mb")
		protobuf_go_lite.TextWriteUint(&sb, x.MemoryMb)
	}
	if x.VgaMemoryMb != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "vga_memory_mb")
		protobuf_go_lite.TextWriteUint(&sb, x.VgaMemoryMb)
	}
	if x.Networking != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "networking")
		protobuf_go_lite.TextWriteBool(&sb, x.Networking)
	}
	if x.SerialEnabled != false {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "serial_enabled")
		protobuf_go_lite.TextWriteBool(&sb, x.SerialEnabled)
	}
	if x.BootArgs != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "boot_args")
		protobuf_go_lite.TextWriteString(&sb, x.BootArgs)
	}
	if len(x.Mounts) > 0 {
		...
		for i, v := range x.Mounts {
			...
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &VmMount{})
			} else {
	...
	if x.RuntimePluginId != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "runtime_plugin_id")
		protobuf_go_lite.TextWriteString(&sb, x.RuntimePluginId)
	}
...
func (x *VmMount) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "VmMount")
	if x.Path != "" {
...
func (x *VmV86) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "VmV86")
	if x.State != 0 {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "state")
		protobuf_go_lite.TextWriteStringer(&sb, VmState(x.State))
	}
	if x.Name != "" {
...
func (x *CreateVmV86Op) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CreateVmV86Op")
	if x.ObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_key")
		protobuf_go_lite.TextWriteString(&sb, x.ObjectKey)
	}
	...
	if x.ImageObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "image_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.ImageObjectKey)
	}
	if x.KernelOverrideObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "kernel_override_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.KernelOverrideObjectKey)
	}
	if x.RootfsOverrideObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "rootfs_override_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.RootfsOverrideObjectKey)
	}
	if x.BiosOverrideObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "bios_override_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.BiosOverrideObjectKey)
	}
	if x.WasmOverrideObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "wasm_override_object_key")
		protobuf_go_lite.TextWriteString(&sb, x.WasmOverrideObjectKey)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *SetV86ConfigOp) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SetV86ConfigOp")
	if x.ObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_key")
		protobuf_go_lite.TextWriteString(&sb, x.ObjectKey)
	}
...
func (x *SetV86StateOp) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SetV86StateOp")
	if x.ObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_key")
		protobuf_go_lite.TextWriteString(&sb, x.ObjectKey)
	}
...
func (x *V86Image) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "V86Image")
	if x.Name != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "name")
		protobuf_go_lite.TextWriteString(&sb, x.Name)
	}
	...
	if x.Distro != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "distro")
		protobuf_go_lite.TextWriteString(&sb, x.Distro)
	}
	if x.KernelVersion != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "kernel_version")
		protobuf_go_lite.TextWriteString(&sb, x.KernelVersion)
	}
	if x.Description != "" {
...
func (x *CreateV86ImageOp) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CreateV86ImageOp")
	if x.ObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_key")
		protobuf_go_lite.TextWriteString(&sb, x.ObjectKey)
	}
	if x.Image != nil {
		...
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Image)
	}
	if x.Timestamp != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "timestamp")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.Timestamp)
...
func (x *SetV86ImageMetadataOp) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SetV86ImageMetadataOp")
	if x.ObjectKey != "" {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "object_key")
		protobuf_go_lite.TextWriteString(&sb, x.ObjectKey)
	}
...
func (m *CreateV86ImageOp) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Image.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
