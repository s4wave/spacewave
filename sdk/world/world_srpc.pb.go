...
func (c *srpcWorldStateResourceServiceClient) OpenOuterWorld(ctx context.Context, in *OpenOuterWorldRequest) (*OpenOuterWorldResponse, error) {
	out := new(OpenOuterWorldResponse)
	err := c.cc.ExecCall(ctx, c.serviceID, "OpenOuterWorld", in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (d *SRPCWorldStateResourceServiceHandler) InvokeMethod(
	...
	case "OpenOuterWorld":
		return true, d.InvokeMethod_OpenOuterWorld(d.impl, strm)
	case "CreateObject":
...
func (SRPCWorldStateResourceServiceHandler) InvokeMethod_OpenOuterWorld(impl SRPCWorldStateResourceServiceServer, strm srpc.Stream) error {
	req := new(OpenOuterWorldRequest)
	if err := strm.MsgRecv(req); err != nil {
		return err
	}
	out, err := impl.OpenOuterWorld(strm.Context(), req)
	if err != nil {
		return err
	}
	return strm.MsgSend(out)
...
type SRPCWorldStateResourceService_OpenOuterWorldStream interface {
	srpc.Stream
}

type srpcWorldStateResourceService_OpenOuterWorldStream struct {
	srpc.Stream
}
