...
export const StoreMeta = {
  encode(message: StoreMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<StoreMeta | StoreMeta[]> | Iterable<StoreMeta | StoreMeta[]>,
  ...
  fromJSON(object: any): StoreMeta {
    return { createdTs: isSet(object.createdTs) ? Timestamp.fromJSON(object.createdTs) : undefined };
  },

  toJSON(message: StoreMeta): unknown {
    const obj: any = {};
    message.createdTs !== undefined &&
      (obj.createdTs = message.createdTs ? Timestamp.toJSON(message.createdTs) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<StoreMeta>, I>>(object: I): StoreMeta {
    const message = createBaseStoreMeta();
