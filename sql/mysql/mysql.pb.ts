...
export const Root = {
  ...
  async *encodeTransform(source: AsyncIterable<Root | Root[]> | Iterable<Root | Root[]>): AsyncIterable<Uint8Array> {
  ...
  fromJSON(object: any): Root {
    return { databases: Array.isArray(object?.databases) ? object.databases.map((e: any) => RootDb.fromJSON(e)) : [] };
  },

  toJSON(message: Root): unknown {
    const obj: any = {};
    if (message.databases) {
      obj.databases = message.databases.map((e) => e ? RootDb.toJSON(e) : undefined);
    } else {
      obj.databases = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    const message = createBaseRoot();
    message.databases = object.databases?.map((e) => RootDb.fromPartial(e)) || [];
    return message;
  },
};
...
export const RootDb = {
  encode(message: RootDb, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  toJSON(message: RootDb): unknown {
    ...
    message.ref !== undefined && (obj.ref = message.ref ? BlockRef.toJSON(message.ref) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RootDb>, I>>(object: I): RootDb {
    ...
    message.ref = (object.ref !== undefined && object.ref !== null) ? BlockRef.fromPartial(object.ref) : undefined;
    return message;
  },
};
...
export const DatabaseRoot = {
  encode(message: DatabaseRoot, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<DatabaseRoot | DatabaseRoot[]> | Iterable<DatabaseRoot | DatabaseRoot[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): DatabaseRoot {
    return {
      tables: Array.isArray(object?.tables) ? object.tables.map((e: any) => DatabaseRootTable.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: DatabaseRoot): unknown {
    const obj: any = {};
    if (message.tables) {
      obj.tables = message.tables.map((e) => e ? DatabaseRootTable.toJSON(e) : undefined);
    } else {
      obj.tables = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<DatabaseRoot>, I>>(object: I): DatabaseRoot {
    const message = createBaseDatabaseRoot();
    message.tables = object.tables?.map((e) => DatabaseRootTable.fromPartial(e)) || [];
    return message;
  },
};
...
export const DatabaseRootTable = {
  encode(message: DatabaseRootTable, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.ref !== undefined) {
  ...
  async *encodeTransform(
    source: AsyncIterable<DatabaseRootTable | DatabaseRootTable[]> | Iterable<DatabaseRootTable | DatabaseRootTable[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<DatabaseRootTable>, I>>(object: I): DatabaseRootTable {
    const message = createBaseDatabaseRootTable();
    message.name = object.name ?? "";
    message.ref = (object.ref !== undefined && object.ref !== null) ? BlockRef.fromPartial(object.ref) : undefined;
    return message;
...
export const TableRoot = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 2:
          message.tablePartitions.push(TablePartitionRoot.decode(reader, reader.uint32()));
          break;
        case 3:
  ...
  async *encodeTransform(
    source: AsyncIterable<TableRoot | TableRoot[]> | Iterable<TableRoot | TableRoot[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): TableRoot {
    return {
      ...
      tablePartitions: Array.isArray(object?.tablePartitions)
        ...
        : [],
      rowNonce: isSet(object.rowNonce) ? Long.fromValue(object.rowNonce) : Long.UZERO,
      autoIncrVal: isSet(object.autoIncrVal) ? TableColumn.fromJSON(object.autoIncrVal) : undefined,
    };
  },
  ...
  toJSON(message: TableRoot): unknown {
    ...
    if (message.tablePartitions) {
      obj.tablePartitions = message.tablePartitions.map((e) => e ? TablePartitionRoot.toJSON(e) : undefined);
    } else {
      obj.tablePartitions = [];
    }
    message.rowNonce !== undefined && (obj.rowNonce = (message.rowNonce || Long.UZERO).toString());
    message.autoIncrVal !== undefined &&
      (obj.autoIncrVal = message.autoIncrVal ? TableColumn.toJSON(message.autoIncrVal) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<TableRoot>, I>>(object: I): TableRoot {
    const message = createBaseTableRoot();
    ...
    message.rowNonce = (object.rowNonce !== undefined && object.rowNonce !== null)
      ...
      : Long.UZERO;
    message.autoIncrVal = (object.autoIncrVal !== undefined && object.autoIncrVal !== null)
...
export const TablePartitionRoot = {
  encode(message: TablePartitionRoot, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): TablePartitionRoot {
    return {
      treeRef: isSet(object.treeRef) ? BlockRef.fromJSON(object.treeRef) : undefined,
      partitionImpl: isSet(object.partitionImpl) ? partitionImplFromJSON(object.partitionImpl) : 0,
    };
  },

  toJSON(message: TablePartitionRoot): unknown {
    const obj: any = {};
    message.treeRef !== undefined && (obj.treeRef = message.treeRef ? BlockRef.toJSON(message.treeRef) : undefined);
    message.partitionImpl !== undefined && (obj.partitionImpl = partitionImplToJSON(message.partitionImpl));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<TablePartitionRoot>, I>>(object: I): TablePartitionRoot {
    const message = createBaseTablePartitionRoot();
    message.treeRef = (object.treeRef !== undefined && object.treeRef !== null)
...
export const TablePartitionRow = {
  encode(message: TablePartitionRow, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.rowNonce.isZero()) {
  ...
  async *encodeTransform(
    source: AsyncIterable<TablePartitionRow | TablePartitionRow[]> | Iterable<TablePartitionRow | TablePartitionRow[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): TablePartitionRow {
    return {
      rowNonce: isSet(object.rowNonce) ? Long.fromValue(object.rowNonce) : Long.UZERO,
      tableRowRef: isSet(object.tableRowRef) ? BlockRef.fromJSON(object.tableRowRef) : undefined,
    };
  },
  ...
  toJSON(message: TablePartitionRow): unknown {
    ...
    message.tableRowRef !== undefined &&
      (obj.tableRowRef = message.tableRowRef ? BlockRef.toJSON(message.tableRowRef) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<TablePartitionRow>, I>>(object: I): TablePartitionRow {
    const message = createBaseTablePartitionRow();
    message.rowNonce = (object.rowNonce !== undefined && object.rowNonce !== null)
      ? Long.fromValue(object.rowNonce)
      : Long.UZERO;
    message.tableRowRef = (object.tableRowRef !== undefined && object.tableRowRef !== null)
...
export const TableRow = {
  encode(message: TableRow, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<TableRow | TableRow[]> | Iterable<TableRow | TableRow[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): TableRow {
    return { columns: Array.isArray(object?.columns) ? object.columns.map((e: any) => TableColumn.fromJSON(e)) : [] };
  },
...
export const TableColumn = {
  ...
  async *encodeTransform(
    source: AsyncIterable<TableColumn | TableColumn[]> | Iterable<TableColumn | TableColumn[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): TableColumn {
    return { msgpackBlob: isSet(object.msgpackBlob) ? MsgpackBlob.fromJSON(object.msgpackBlob) : undefined };
  },

  toJSON(message: TableColumn): unknown {
    const obj: any = {};
    message.msgpackBlob !== undefined &&
      (obj.msgpackBlob = message.msgpackBlob ? MsgpackBlob.toJSON(message.msgpackBlob) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<TableColumn>, I>>(object: I): TableColumn {
    const message = createBaseTableColumn();
    message.msgpackBlob = (object.msgpackBlob !== undefined && object.msgpackBlob !== null)
...
export const TableSchema = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TableSchema {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.columns.push(TableSchemaColumn.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  async *encodeTransform(
    source: AsyncIterable<TableSchema | TableSchema[]> | Iterable<TableSchema | TableSchema[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): TableSchema {
    return {
      columns: Array.isArray(object?.columns) ? object.columns.map((e: any) => TableSchemaColumn.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: TableSchema): unknown {
    const obj: any = {};
    if (message.columns) {
      obj.columns = message.columns.map((e) => e ? TableSchemaColumn.toJSON(e) : undefined);
    } else {
      obj.columns = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<TableSchema>, I>>(object: I): TableSchema {
    const message = createBaseTableSchema();
    message.columns = object.columns?.map((e) => TableSchemaColumn.fromPartial(e)) || [];
    return message;
  },
};
...
export const TableSchemaColumn = {
  encode(message: TableSchemaColumn, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  async *encodeTransform(
    source: AsyncIterable<TableSchemaColumn | TableSchemaColumn[]> | Iterable<TableSchemaColumn | TableSchemaColumn[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): TableSchemaColumn {
    return {
      ...
      defaultValueExpr: isSet(object.defaultValueExpr) ? String(object.defaultValueExpr) : "",
  ...
  toJSON(message: TableSchemaColumn): unknown {
    ...
    message.defaultValueExpr !== undefined && (obj.defaultValueExpr = message.defaultValueExpr);
  ...
  fromPartial<I extends Exact<DeepPartial<TableSchemaColumn>, I>>(object: I): TableSchemaColumn {
    const message = createBaseTableSchemaColumn();
    message.name = object.name ?? "";
