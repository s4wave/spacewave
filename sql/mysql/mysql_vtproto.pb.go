...
func (m *RootDb) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Ref != nil {
		if marshalto, ok := interface{}(m.Ref).(interface {
...
func (m *TablePartitionRoot) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TreeRef != nil {
		if marshalto, ok := interface{}(m.TreeRef).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *TablePartitionRow) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TableRowRef != nil {
		if marshalto, ok := interface{}(m.TableRowRef).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *TableColumn) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MsgpackBlob != nil {
		if marshalto, ok := interface{}(m.MsgpackBlob).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
