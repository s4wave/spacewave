...
import type { Runtime, WebView as BldrWebView, WebViewRegistration } from '../bldr'
...
export class WebView extends React.Component<IWebViewProps> implements BldrWebView {
