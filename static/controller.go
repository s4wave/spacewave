...
const ControllerID = "aperture/auth/static/provider/1"

// Controller implements the static auth domain controller.
...
func (c *Controller) GetControllerInfo() controller.Info {
	return controller.Info{
		...
		Description: "static auth domain entity list provider",
	}
}
