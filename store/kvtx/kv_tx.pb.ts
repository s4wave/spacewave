...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return { mqueueConfig: isSet(object.mqueueConfig) ? Config1.fromJSON(object.mqueueConfig) : undefined };
  },

  toJSON(message: Config): unknown {
    const obj: any = {};
    message.mqueueConfig !== undefined &&
      (obj.mqueueConfig = message.mqueueConfig ? Config1.toJSON(message.mqueueConfig) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    const message = createBaseConfig();
    message.mqueueConfig = (object.mqueueConfig !== undefined && object.mqueueConfig !== null)
...
export const MqueueMeta = {
  encode(message: MqueueMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<MqueueMeta | MqueueMeta[]> | Iterable<MqueueMeta | MqueueMeta[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<MqueueMeta>, I>>(object: I): MqueueMeta {
    const message = createBaseMqueueMeta();
...
export const BucketReconcilerMqueueId = {
  encode(message: BucketReconcilerMqueueId, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.bucketId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BucketReconcilerMqueueId {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<BucketReconcilerMqueueId>, I>>(object: I): BucketReconcilerMqueueId {
    const message = createBaseBucketReconcilerMqueueId();
