...
func (m *Target) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Input) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *InputWorld) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *InputWorldObject) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Output) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Exec) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *ValueSet) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (this *ValueSet) EqualVT(that *ValueSet) bool {
	...
	for i, vx := range this.Inputs {
		vy := that.Inputs[i]
		if equal, ok := interface{}(vx).(interface{ EqualVT(*value.Value) bool }); ok {
			if !equal.EqualVT(vy) {
				return false
			}
