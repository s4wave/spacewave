...
func (this *Target) EqualVT(that *Target) bool {
	...
	for i := range this.Inputs {
		if !this.Inputs[i].EqualVT(that.Inputs[i]) {
			return false
		}
	}
	...
	for i := range this.Outputs {
		if !this.Outputs[i].EqualVT(that.Outputs[i]) {
			return false
		}
	}
...
func (this *ValueSet) EqualVT(that *ValueSet) bool {
	...
	for i := range this.Inputs {
		if equal, ok := interface{}(this.Inputs[i]).(interface{ EqualVT(*value.Value) bool }); ok {
			if !equal.EqualVT(that.Inputs[i]) {
				return false
			}
		} else if !proto.Equal(this.Inputs[i], that.Inputs[i]) {
			return false
		}
	}
	if len(this.Outputs) != len(that.Outputs) {
	...
	for i := range this.Outputs {
		if equal, ok := interface{}(this.Outputs[i]).(interface{ EqualVT(*value.Value) bool }); ok {
			if !equal.EqualVT(that.Outputs[i]) {
				return false
			}
		} else if !proto.Equal(this.Outputs[i], that.Outputs[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
