...
export const Tx = {
  encode(message: Tx, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.txUpdateInputs !== undefined) {
      TxUpdateInputs.encode(message.txUpdateInputs, writer.uint32(26).fork()).ldelim();
    }
    ...
    if (message.txUpdateWithPassState !== undefined) {
      TxUpdateWithPassState.encode(message.txUpdateWithPassState, writer.uint32(42).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.txUpdateInputs = TxUpdateInputs.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag != 34) {
            break;
        ...
        case 5:
          ...
          message.txUpdateWithPassState = TxUpdateWithPassState.decode(reader, reader.uint32());
          continue;
        case 6:
          if (tag != 50) {
            break;
  ...
  fromJSON(object: any): Tx {
    return {
      ...
      taskObjectKey: isSet(object.taskObjectKey) ? String(object.taskObjectKey) : "",
      txUpdateInputs: isSet(object.txUpdateInputs) ? TxUpdateInputs.fromJSON(object.txUpdateInputs) : undefined,
  ...
  toJSON(message: Tx): unknown {
    ...
    message.taskObjectKey !== undefined && (obj.taskObjectKey = message.taskObjectKey);
    message.txUpdateInputs !== undefined &&
      (obj.txUpdateInputs = message.txUpdateInputs ? TxUpdateInputs.toJSON(message.txUpdateInputs) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Tx>, I>>(object: I): Tx {
    ...
    message.txUpdateInputs = (object.txUpdateInputs !== undefined && object.txUpdateInputs !== null)
    ...
    message.txUpdateWithPassState =
      (object.txUpdateWithPassState !== undefined && object.txUpdateWithPassState !== null)
...
export const TxUpdateInputs = {
  encode(message: TxUpdateInputs, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<TxUpdateInputs | TxUpdateInputs[]> | Iterable<TxUpdateInputs | TxUpdateInputs[]>,
  ...
  fromJSON(object: any): TxUpdateInputs {
    return {
      updateTarget: isSet(object.updateTarget) ? Boolean(object.updateTarget) : false,
      resetInputs: isSet(object.resetInputs) ? Boolean(object.resetInputs) : false,
  ...
  toJSON(message: TxUpdateInputs): unknown {
    const obj: any = {};
    message.updateTarget !== undefined && (obj.updateTarget = message.updateTarget);
...
export const TxStart = {
  ...
  fromJSON(object: any): TxStart {
    return { assignSelf: isSet(object.assignSelf) ? Boolean(object.assignSelf) : false };
  },
...
export const TxUpdateWithPassState = {
  encode(_: TxUpdateWithPassState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): TxUpdateWithPassState {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
