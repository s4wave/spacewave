...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      unixfsPrefix: isSet(object.unixfsPrefix) ? String(object.unixfsPrefix) : "",
      unixfsHttpPrefix: isSet(object.unixfsHttpPrefix) ? String(object.unixfsHttpPrefix) : "",
      ...
      matchPathPrefixes: Array.isArray(object?.matchPathPrefixes)
        ...
        : [],
      stripPathPrefix: isSet(object.stripPathPrefix) ? Boolean(object.stripPathPrefix) : false,
  ...
  toJSON(message: Config): unknown {
    ...
    message.unixfsPrefix !== undefined && (obj.unixfsPrefix = message.unixfsPrefix);
    message.unixfsHttpPrefix !== undefined && (obj.unixfsHttpPrefix = message.unixfsHttpPrefix);
    ...
    message.stripPathPrefix !== undefined && (obj.stripPathPrefix = message.stripPathPrefix);
