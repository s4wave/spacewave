...
func (this *Config) EqualVT(that *Config) bool {
	...
	if equal, ok := interface{}(this.FsRef).(interface{ EqualVT(*world.UnixfsRef) bool }); ok {
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FsId) > 0 {
		i -= len(m.FsId)
		copy(dAtA[i:], m.FsId)
		i = encodeVarint(dAtA, i, uint64(len(m.FsId)))
		i--
		dAtA[i] = 0xa
	}
