...
function createBaseValue(): Value {
  return { name: "", valueType: 0, blockRef: undefined, bucketRef: undefined, worldObjectSnapshot: undefined };
}
...
export const Value = {
  encode(message: Value, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.worldObjectSnapshot !== undefined) {
      WorldObjectSnapshot.encode(message.worldObjectSnapshot, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.worldObjectSnapshot = WorldObjectSnapshot.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) == 4 || tag == 0) {
        break;
  ...
  fromJSON(object: any): Value {
    return {
      ...
      valueType: isSet(object.valueType) ? valueTypeFromJSON(object.valueType) : 0,
      blockRef: isSet(object.blockRef) ? BlockRef.fromJSON(object.blockRef) : undefined,
      bucketRef: isSet(object.bucketRef) ? ObjectRef.fromJSON(object.bucketRef) : undefined,
  ...
  toJSON(message: Value): unknown {
    ...
    message.valueType !== undefined && (obj.valueType = valueTypeToJSON(message.valueType));
    ...
    message.bucketRef !== undefined &&
      (obj.bucketRef = message.bucketRef ? ObjectRef.toJSON(message.bucketRef) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Value>, I>>(object: I): Value {
    ...
    message.blockRef = (object.blockRef !== undefined && object.blockRef !== null)
      ...
      : undefined;
    message.bucketRef = (object.bucketRef !== undefined && object.bucketRef !== null)
      ? ObjectRef.fromPartial(object.bucketRef)
      : undefined;
    message.worldObjectSnapshot = (object.worldObjectSnapshot !== undefined && object.worldObjectSnapshot !== null)
...
function createBaseWorldObjectSnapshot(): WorldObjectSnapshot {
  return { key: "", rootRef: undefined, rev: Long.UZERO, objectType: "", objectParent: "" };
}

export const WorldObjectSnapshot = {
  encode(message: WorldObjectSnapshot, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  fromJSON(object: any): WorldObjectSnapshot {
    return {
      ...
      objectParent: isSet(object.objectParent) ? String(object.objectParent) : "",
    };
  },
  ...
  toJSON(message: WorldObjectSnapshot): unknown {
    ...
    message.objectParent !== undefined && (obj.objectParent = message.objectParent);
    return obj;
  },

  create<I extends Exact<DeepPartial<WorldObjectSnapshot>, I>>(base?: I): WorldObjectSnapshot {
    return WorldObjectSnapshot.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<WorldObjectSnapshot>, I>>(object: I): WorldObjectSnapshot {
    const message = createBaseWorldObjectSnapshot();
