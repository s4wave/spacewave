...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      badgerDebug: isSet(object.badgerDebug) ? Boolean(object.badgerDebug) : false,
      ...
      tableLoadingMode: isSet(object.tableLoadingMode) ? fileLoadingModeFromJSON(object.tableLoadingMode) : 0,
      valueLogLoadingMode: isSet(object.valueLogLoadingMode) ? fileLoadingModeFromJSON(object.valueLogLoadingMode) : 0,
      numVersionsToKeep: isSet(object.numVersionsToKeep) ? Number(object.numVersionsToKeep) : 0,
      maxTableSize: isSet(object.maxTableSize) ? Long.fromValue(object.maxTableSize) : Long.UZERO,
      levelSizeMultiplier: isSet(object.levelSizeMultiplier) ? Number(object.levelSizeMultiplier) : 0,
      maxLevels: isSet(object.maxLevels) ? Number(object.maxLevels) : 0,
      valueThreshold: isSet(object.valueThreshold) ? Number(object.valueThreshold) : 0,
      numMemtables: isSet(object.numMemtables) ? Number(object.numMemtables) : 0,
      numLevelZeroTables: isSet(object.numLevelZeroTables) ? Number(object.numLevelZeroTables) : 0,
      numLevelZeroTablesStall: isSet(object.numLevelZeroTablesStall) ? Number(object.numLevelZeroTablesStall) : 0,
      levelOneSize: isSet(object.levelOneSize) ? Long.fromValue(object.levelOneSize) : Long.UZERO,
      valueLogFileSize: isSet(object.valueLogFileSize) ? Long.fromValue(object.valueLogFileSize) : Long.UZERO,
      valueLogMaxEntries: isSet(object.valueLogMaxEntries) ? Number(object.valueLogMaxEntries) : 0,
      numCompactors: isSet(object.numCompactors) ? Number(object.numCompactors) : 0,
      truncate: isSet(object.truncate) ? Boolean(object.truncate) : false,
      noSyncWrites: isSet(object.noSyncWrites) ? Boolean(object.noSyncWrites) : false,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.tableLoadingMode !== undefined && (obj.tableLoadingMode = fileLoadingModeToJSON(message.tableLoadingMode));
    message.valueLogLoadingMode !== undefined &&
      (obj.valueLogLoadingMode = fileLoadingModeToJSON(message.valueLogLoadingMode));
    message.numVersionsToKeep !== undefined && (obj.numVersionsToKeep = Math.round(message.numVersionsToKeep));
    message.maxTableSize !== undefined && (obj.maxTableSize = (message.maxTableSize || Long.UZERO).toString());
    message.levelSizeMultiplier !== undefined && (obj.levelSizeMultiplier = Math.round(message.levelSizeMultiplier));
    message.maxLevels !== undefined && (obj.maxLevels = Math.round(message.maxLevels));
    message.valueThreshold !== undefined && (obj.valueThreshold = Math.round(message.valueThreshold));
    message.numMemtables !== undefined && (obj.numMemtables = Math.round(message.numMemtables));
    message.numLevelZeroTables !== undefined && (obj.numLevelZeroTables = Math.round(message.numLevelZeroTables));
    message.numLevelZeroTablesStall !== undefined &&
      (obj.numLevelZeroTablesStall = Math.round(message.numLevelZeroTablesStall));
    message.levelOneSize !== undefined && (obj.levelOneSize = (message.levelOneSize || Long.UZERO).toString());
    message.valueLogFileSize !== undefined &&
      (obj.valueLogFileSize = (message.valueLogFileSize || Long.UZERO).toString());
    message.valueLogMaxEntries !== undefined && (obj.valueLogMaxEntries = Math.round(message.valueLogMaxEntries));
    message.numCompactors !== undefined && (obj.numCompactors = Math.round(message.numCompactors));
    message.truncate !== undefined && (obj.truncate = message.truncate);
    message.noSyncWrites !== undefined && (obj.noSyncWrites = message.noSyncWrites);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.maxTableSize = (object.maxTableSize !== undefined && object.maxTableSize !== null)
    ...
    message.levelOneSize = (object.levelOneSize !== undefined && object.levelOneSize !== null)
      ? Long.fromValue(object.levelOneSize)
      : Long.UZERO;
    message.valueLogFileSize = (object.valueLogFileSize !== undefined && object.valueLogFileSize !== null)
