...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.stateTransformConf !== undefined) {
      Config4.encode(message.stateTransformConf, writer.uint32(98).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Config {
    return {
      ...
      stateTransformConf: isSet(object.stateTransformConf) ? Config4.fromJSON(object.stateTransformConf) : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    message.stateTransformConf !== undefined &&
      (obj.stateTransformConf = message.stateTransformConf ? Config4.toJSON(message.stateTransformConf) : undefined);
    return obj;
  },
