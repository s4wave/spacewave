...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto = nullptr;
const ::uint32_t
    TableStruct_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_._has_bits_),
        9, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_.file_path_),
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_.kv_key_opts_),
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_.verbose_),
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_.volume_config_),
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_.store_config_),
        PROTOBUF_FIELD_OFFSET(::volume::kvfile::Config, _impl_.no_generate_key_),
        0,
        1,
        4,
        2,
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::volume::kvfile::Config)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::volume::kvfile::_Config_default_instance_._instance,
};
const char descriptor_table_protodef_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n<github.com/aperturerobotics/hydra/volu"
    "me/kvfile/kvfile.proto\022\rvolume.kvfile\0327g"
    ...
    "roller/controller.proto\"\313\001\n\006Config\022\021\n\tfi"
    "le_path\030\007 \001(\t\022(\n\013kv_key_opts\030\001 \001(\0132\023.sto"
    "re.kvkey.Config\022\017\n\007verbose\030\002 \001(\010\0220\n\rvolu"
    "me_config\030\003 \001(\0132\031.volume.controller.Conf"
    "ig\022(\n\014store_config\030\004 \001(\0132\022.store.kvtx.Co"
    "nfig\022\027\n\017no_generate_key\030\005 \001(\010b\006proto3"
};
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto_deps[3] = {
...
static ::absl::once_flag descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto = {
    false,
    false,
    477,
    descriptor_table_protodef_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto,
    "github.com/aperturerobotics/hydra/volume/kvfile/kvfile.proto",
    &descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto_once,
    descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto_deps,
    3,
    1,
    schemas,
    file_default_instances,
    TableStruct_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto::offsets,
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto,
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto,
};
namespace volume {
namespace kvfile {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:volume.kvfile.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::volume::kvfile::Config& from_msg)
...
Config::Config(
  ...
  ::memcpy(reinterpret_cast<char*>(&_impl_) +
           ...
           offsetof(Impl_, no_generate_key_) -
               offsetof(Impl_, verbose_) +
               sizeof(Impl_::no_generate_key_));

  // @@protoc_insertion_point(copy_constructor:volume.kvfile.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
Config::~Config() {
  // @@protoc_insertion_point(destructor:volume.kvfile.Config)
  SharedDtor(*this);
}
...
constexpr auto Config::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto,
      nullptr,  // tracker
  };
}
...
Config::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::volume::kvfile::Config>(),  // to_prefetch
    ...
    {::_pbi::TcParser::FastUS1,
     {58, 0, 0,
      PROTOBUF_FIELD_OFFSET(Config, _impl_.file_path_)}},
  }}, {{
    65535, 65535
  }}, {{
    // .store.kvkey.Config kv_key_opts = 1;
    ...
    // string file_path = 7;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.file_path_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  {{
  ...
  {{
    "\24\0\0\0\0\0\11\0"
    "volume.kvfile.Config"
    "file_path"
  }},
};
PROTOBUF_NOINLINE void Config::Clear() {
// @@protoc_insertion_point(message_clear_start:volume.kvfile.Config)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  ::memset(&_impl_.verbose_, 0, static_cast<::size_t>(
      reinterpret_cast<char*>(&_impl_.no_generate_key_) -
      reinterpret_cast<char*>(&_impl_.verbose_)) + sizeof(_impl_.no_generate_key_));
...
::uint8_t* PROTOBUF_NONNULL Config::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:volume.kvfile.Config)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_file_path().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "volume.kvfile.Config.file_path");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:volume.kvfile.Config)
  return target;
}
...
::size_t Config::ByteSizeLong() const {
  const Config& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:volume.kvfile.Config)
  ::size_t total_size = 0;
...
void Config::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:volume.kvfile.Config)
...
void Config::CopyFrom(const Config& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:volume.kvfile.Config)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Config::InternalSwap(Config* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Config, _impl_.no_generate_key_)
      + sizeof(Config::_impl_.no_generate_key_)
      - PROTOBUF_FIELD_OFFSET(Config, _impl_.kv_key_opts_)>(
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fkvfile_2fkvfile_2eproto),
         ::std::false_type{});
