...
func (m *Config) CloneVT() *Config {
	...
	if rhs := m.Client; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *redis.ClientConfig }); ok {
			r.Client = vtpb.CloneVT()
		} else {
			r.Client = proto.Clone(rhs).(*redis.ClientConfig)
		}
	}
...
func (this *Config) EqualVT(that *Config) bool {
	...
	if equal, ok := interface{}(this.Client).(interface {
		EqualVT(*redis.ClientConfig) bool
	}); ok {
