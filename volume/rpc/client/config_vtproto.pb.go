...
func (m *VolumeAliases) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *VolumeAliases) EqualMessageVT(thatMsg proto.Message) bool {
...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ReleaseDelay) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ReleaseDelay)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ClientId) > 0 {
