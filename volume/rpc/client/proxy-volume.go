...
import (
	...
	rpc_bucket_client "github.com/aperturerobotics/hydra/bucket/rpc/client"
...
func NewProxyVolume(
	...
	return &ProxyVolume{
		BlockStore:  rpc_block_client.NewBlockStore(ctx, blockStoreClient, volInfo.GetHashType()),
