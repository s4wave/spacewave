...
func (m *WatchVolumeInfoRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: WatchVolumeInfoRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: WatchVolumeInfoRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *WatchVolumeInfoResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: WatchVolumeInfoResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: WatchVolumeInfoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GetVolumeInfoRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: GetVolumeInfoRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: GetVolumeInfoRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GetVolumeInfoResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: GetVolumeInfoResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: GetVolumeInfoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetPeerPrivRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: GetPeerPrivRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: GetPeerPrivRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GetPeerPrivResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: GetPeerPrivResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: GetPeerPrivResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
