...
export const WatchVolumeInfoRequest = {
  encode(message: WatchVolumeInfoRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.volumeId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WatchVolumeInfoRequest {
  ...
  fromPartial<I extends Exact<DeepPartial<WatchVolumeInfoRequest>, I>>(object: I): WatchVolumeInfoRequest {
    const message = createBaseWatchVolumeInfoRequest();
...
export const WatchVolumeInfoResponse = {
  encode(message: WatchVolumeInfoResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WatchVolumeInfoResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<WatchVolumeInfoResponse>, I>>(object: I): WatchVolumeInfoResponse {
    const message = createBaseWatchVolumeInfoResponse();
...
export const GetVolumeInfoRequest = {
  encode(_: GetVolumeInfoRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GetVolumeInfoRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<GetVolumeInfoRequest>, I>>(_: I): GetVolumeInfoRequest {
    const message = createBaseGetVolumeInfoRequest();
    return message;
  },
};
...
export const GetVolumeInfoResponse = {
  encode(message: GetVolumeInfoResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.volumeInfo !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetVolumeInfoResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GetVolumeInfoResponse {
    return { volumeInfo: isSet(object.volumeInfo) ? VolumeInfo.fromJSON(object.volumeInfo) : undefined };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetVolumeInfoResponse>, I>>(object: I): GetVolumeInfoResponse {
    const message = createBaseGetVolumeInfoResponse();
    message.volumeInfo = (object.volumeInfo !== undefined && object.volumeInfo !== null)
      ? VolumeInfo.fromPartial(object.volumeInfo)
      : undefined;
...
export const GetPeerPrivRequest = {
  encode(_: GetPeerPrivRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetPeerPrivRequest>, I>>(_: I): GetPeerPrivRequest {
    const message = createBaseGetPeerPrivRequest();
    return message;
  },
};
...
export const GetPeerPrivResponse = {
  encode(message: GetPeerPrivResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.privKey !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<GetPeerPrivResponse>, I>>(object: I): GetPeerPrivResponse {
    const message = createBaseGetPeerPrivResponse();
...
export interface AccessVolumes {
   ...
   */
  WatchVolumeInfo(request: WatchVolumeInfoRequest): AsyncIterable<WatchVolumeInfoResponse>;
  /**
   * VolumeRpc uses the LookupVolume directive access a Volume handle.
   * Exposes the ProxyVolume service.
   * Id: volume id
   */
  VolumeRpc(request: AsyncIterable<RpcStreamPacket>): AsyncIterable<RpcStreamPacket>;
}
...
export class AccessVolumesClientImpl implements AccessVolumes {
  ...
  WatchVolumeInfo(request: WatchVolumeInfoRequest): AsyncIterable<WatchVolumeInfoResponse> {
    ...
    const result = this.rpc.serverStreamingRequest(this.service, "WatchVolumeInfo", data);
    return WatchVolumeInfoResponse.decodeTransform(result);
  }

  VolumeRpc(request: AsyncIterable<RpcStreamPacket>): AsyncIterable<RpcStreamPacket> {
    const data = RpcStreamPacket.encodeTransform(request);
    const result = this.rpc.bidirectionalStreamingRequest(this.service, "VolumeRpc", data);
...
export class ProxyVolumeClientImpl implements ProxyVolume {
  ...
  GetVolumeInfo(request: GetVolumeInfoRequest): Promise<GetVolumeInfoResponse> {
    ...
    return promise.then((data) => GetVolumeInfoResponse.decode(new _m0.Reader(data)));
  }

  GetPeerPriv(request: GetPeerPrivRequest): Promise<GetPeerPrivResponse> {
    const data = GetPeerPrivRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetPeerPriv", data);
    return promise.then((data) => GetPeerPrivResponse.decode(new _m0.Reader(data)));
  }
}
