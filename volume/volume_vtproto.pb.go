...
func (m *VolumeInfo) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *VolumeBucketInfo) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
...
func (m *ListBucketsRequest) CloneGenericVT() proto.Message {
	return m.CloneVT()
}
