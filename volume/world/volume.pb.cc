...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto = nullptr;
const ::uint32_t
    TableStruct_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_._has_bits_),
        14, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.kv_key_opts_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.verbose_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.volume_config_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.store_config_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.no_generate_key_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.no_write_key_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.init_head_ref_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.engine_id_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.object_key_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.bucket_id_),
        PROTOBUF_FIELD_OFFSET(::volume::world::Config, _impl_.volume_id_),
        4,
        8,
        5,
        6,
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::volume::world::Config)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::volume::world::_Config_default_instance_._instance,
};
const char descriptor_table_protodef_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n;github.com/aperturerobotics/hydra/volu"
    "me/world/volume.proto\022\014volume.world\032Agit"
    ...
    "roller/controller.proto\"\305\002\n\006Config\022(\n\013kv"
    ...
    "_head_ref\030\006 \001(\0132\021.bucket.ObjectRef\022\021\n\ten"
    "gine_id\030\007 \001(\t\022\022\n\nobject_key\030\010 \001(\t\022\021\n\tbuc"
    "ket_id\030\t \001(\t\022\021\n\tvolume_id\030\n \001(\tb\006proto3"
};
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto_deps[5] = {
...
static ::absl::once_flag descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto = {
    false,
    false,
    719,
    descriptor_table_protodef_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto,
    "github.com/aperturerobotics/hydra/volume/world/volume.proto",
    &descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto_once,
    descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto_deps,
    5,
    1,
    schemas,
    file_default_instances,
    TableStruct_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto::offsets,
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto,
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto,
};
namespace volume {
namespace world {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:volume.world.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::volume::world::Config& from_msg)
...
Config::Config(
  ...
  // @@protoc_insertion_point(copy_constructor:volume.world.Config)
}
PROTOBUF_NDEBUG_INLINE Config::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
Config::~Config() {
  // @@protoc_insertion_point(destructor:volume.world.Config)
  SharedDtor(*this);
}
...
constexpr auto Config::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto,
      nullptr,  // tracker
  };
}
...
const ::_pbi::TcParseTable<4, 11, 4, 73, 2>
Config::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::volume::world::Config>(),  // to_prefetch
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Config, _impl_.no_generate_key_), 9>(),
     {40, 9, 0,
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Config, _impl_.no_write_key_), 10>(),
     {88, 10, 0,
    ...
    // bool no_generate_key = 5;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.no_generate_key_), _Internal::kHasBitsOffset + 9, 0, (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // .bucket.ObjectRef init_head_ref = 6;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.init_head_ref_), _Internal::kHasBitsOffset + 7, 3, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // string engine_id = 7;
    ...
    // bool no_write_key = 11;
    {PROTOBUF_FIELD_OFFSET(Config, _impl_.no_write_key_), _Internal::kHasBitsOffset + 10, 0, (0 | ::_fl::kFcOptional | ::_fl::kBool)},
  }},
  {{
  ...
  {{
    "\23\0\0\0\0\0\0\11\12\11\11\0\0\0\0\0"
    "volume.world.Config"
    "engine_id"
    "object_key"
    "bucket_id"
...
// @@protoc_insertion_point(message_clear_start:volume.world.Config)
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
::uint8_t* PROTOBUF_NONNULL Config::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:volume.world.Config)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBit(cached_has_bits, 0x00000080U)) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        6, *this_._impl_.init_head_ref_, this_._impl_.init_head_ref_->GetCachedSize(), target,
        stream);
  }
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_engine_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "volume.world.Config.engine_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    if (!this_._internal_object_key().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "volume.world.Config.object_key");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    if (!this_._internal_bucket_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "volume.world.Config.bucket_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000008U)) {
    if (!this_._internal_volume_id().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "volume.world.Config.volume_id");
  ...
  if (CheckHasBit(cached_has_bits, 0x00000400U)) {
    if (this_._internal_no_write_key() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteBoolToArray(
          11, this_._internal_no_write_key(), target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:volume.world.Config)
  return target;
}
...
::size_t Config::ByteSizeLong() const {
  const Config& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:volume.world.Config)
  ::size_t total_size = 0;
...
void Config::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:volume.world.Config)
...
void Config::CopyFrom(const Config& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:volume.world.Config)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_github_2ecom_2faperturerobotics_2fhydra_2fvolume_2fworld_2fvolume_2eproto),
         ::std::false_type{});
