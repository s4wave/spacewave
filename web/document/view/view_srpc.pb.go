...
func NewSRPCWebViewHostHandler(impl SRPCWebViewHostServer) srpc.Handler {
	return &SRPCWebViewHostHandler{impl: impl}
}
...
func NewSRPCWebViewHandler(impl SRPCWebViewServer) srpc.Handler {
	return &SRPCWebViewHandler{impl: impl}
}
