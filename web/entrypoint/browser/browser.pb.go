...
func (m *Config) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MessagePort) > 0 {
		i -= len(m.MessagePort)
		copy(dAtA[i:], m.MessagePort)
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.MessagePort)))
		i--
		dAtA[i] = 0x12
	}
...
func (x *Config) MarshalProtoText() string {
	...
	if x.MessagePort != "" {
		...
		sb.WriteString("message_port: ")
		sb.WriteString(strconv.Quote(x.MessagePort))
	}
	sb.WriteString("}")
	return sb.String()
}
...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.MessagePort = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
