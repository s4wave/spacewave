...
export interface FetchRequest {
  body?: { $case: "requestInfo"; requestInfo: FetchRequestInfo } | {
    $case: "requestData";
...
export interface FetchResponse {
  body?: { $case: "responseInfo"; responseInfo: ResponseInfo } | { $case: "responseData"; responseData: ResponseData };
}
...
export const FetchRequest = {
  encode(message: FetchRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.body?.$case === "requestInfo") {
      FetchRequestInfo.encode(message.body.requestInfo, writer.uint32(10).fork()).ldelim();
    }
    if (message.body?.$case === "requestData") {
      FetchRequestData.encode(message.body.requestData, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FetchRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.body = { $case: "requestInfo", requestInfo: FetchRequestInfo.decode(reader, reader.uint32()) };
          break;
        case 2:
          message.body = { $case: "requestData", requestData: FetchRequestData.decode(reader, reader.uint32()) };
          break;
        default:
  ...
  async *encodeTransform(
    source: AsyncIterable<FetchRequest | FetchRequest[]> | Iterable<FetchRequest | FetchRequest[]>,
  ...
  fromJSON(object: any): FetchRequest {
    return {
      body: isSet(object.requestInfo)
        ? { $case: "requestInfo", requestInfo: FetchRequestInfo.fromJSON(object.requestInfo) }
        : isSet(object.requestData)
        ? { $case: "requestData", requestData: FetchRequestData.fromJSON(object.requestData) }
        : undefined,
    };
  },
  ...
  toJSON(message: FetchRequest): unknown {
    ...
    message.body?.$case === "requestInfo" &&
      (obj.requestInfo = message.body?.requestInfo ? FetchRequestInfo.toJSON(message.body?.requestInfo) : undefined);
    message.body?.$case === "requestData" &&
      (obj.requestData = message.body?.requestData ? FetchRequestData.toJSON(message.body?.requestData) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FetchRequest>, I>>(object: I): FetchRequest {
    ...
    if (
      ...
      message.body = { $case: "requestInfo", requestInfo: FetchRequestInfo.fromPartial(object.body.requestInfo) };
    }
    if (
      ...
      message.body = { $case: "requestData", requestData: FetchRequestData.fromPartial(object.body.requestData) };
    }
    return message;
  },
};
...
export const FetchRequestInfo = {
  encode(message: FetchRequestInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.method !== "") {
    ...
    Object.entries(message.headers).forEach(([key, value]) => {
      FetchRequestInfo_HeadersEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).ldelim();
    });
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = FetchRequestInfo_HeadersEntry.decode(reader, reader.uint32());
  ...
  async *encodeTransform(
    source: AsyncIterable<FetchRequestInfo | FetchRequestInfo[]> | Iterable<FetchRequestInfo | FetchRequestInfo[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): FetchRequestInfo {
    return {
      ...
      referrerPolicy: isSet(object.referrerPolicy) ? String(object.referrerPolicy) : "",
    };
  },
  ...
  toJSON(message: FetchRequestInfo): unknown {
    ...
    message.referrerPolicy !== undefined && (obj.referrerPolicy = message.referrerPolicy);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<FetchRequestInfo>, I>>(object: I): FetchRequestInfo {
    const message = createBaseFetchRequestInfo();
...
export const FetchRequestInfo_HeadersEntry = {
  encode(message: FetchRequestInfo_HeadersEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FetchRequestInfo_HeadersEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FetchRequestInfo_HeadersEntry | FetchRequestInfo_HeadersEntry[]>
      | Iterable<FetchRequestInfo_HeadersEntry | FetchRequestInfo_HeadersEntry[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
...
export const FetchRequestData = {
  encode(message: FetchRequestData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<FetchRequestData | FetchRequestData[]> | Iterable<FetchRequestData | FetchRequestData[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<FetchRequestData>, I>>(object: I): FetchRequestData {
    const message = createBaseFetchRequestData();
...
export const FetchResponse = {
  encode(message: FetchResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.body?.$case === "responseInfo") {
      ResponseInfo.encode(message.body.responseInfo, writer.uint32(10).fork()).ldelim();
    }
    if (message.body?.$case === "responseData") {
      ResponseData.encode(message.body.responseData, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FetchResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.body = { $case: "responseInfo", responseInfo: ResponseInfo.decode(reader, reader.uint32()) };
          break;
        case 2:
          message.body = { $case: "responseData", responseData: ResponseData.decode(reader, reader.uint32()) };
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  async *encodeTransform(
    source: AsyncIterable<FetchResponse | FetchResponse[]> | Iterable<FetchResponse | FetchResponse[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): FetchResponse {
    return {
      body: isSet(object.responseInfo)
        ? { $case: "responseInfo", responseInfo: ResponseInfo.fromJSON(object.responseInfo) }
        : isSet(object.responseData)
        ? { $case: "responseData", responseData: ResponseData.fromJSON(object.responseData) }
        : undefined,
    };
  },
  ...
  toJSON(message: FetchResponse): unknown {
    ...
    message.body?.$case === "responseInfo" &&
      (obj.responseInfo = message.body?.responseInfo ? ResponseInfo.toJSON(message.body?.responseInfo) : undefined);
    message.body?.$case === "responseData" &&
      (obj.responseData = message.body?.responseData ? ResponseData.toJSON(message.body?.responseData) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FetchResponse>, I>>(object: I): FetchResponse {
    ...
    if (
      ...
      message.body = { $case: "responseInfo", responseInfo: ResponseInfo.fromPartial(object.body.responseInfo) };
    }
    if (
      ...
      message.body = { $case: "responseData", responseData: ResponseData.fromPartial(object.body.responseData) };
    }
    return message;
  },
};
...
function createBaseResponseInfo(): ResponseInfo {
  return { headers: {}, ok: false, redirected: false, status: 0, statusText: "", responseType: "" };
}

export const ResponseInfo = {
  encode(message: ResponseInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.headers).forEach(([key, value]) => {
      ResponseInfo_HeadersEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
    if (message.ok === true) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ResponseInfo {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 = ResponseInfo_HeadersEntry.decode(reader, reader.uint32());
  ...
  async *encodeTransform(
    source: AsyncIterable<ResponseInfo | ResponseInfo[]> | Iterable<ResponseInfo | ResponseInfo[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
...
export const ResponseInfo_HeadersEntry = {
  encode(message: ResponseInfo_HeadersEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ResponseInfo_HeadersEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<ResponseInfo_HeadersEntry>, I>>(object: I): ResponseInfo_HeadersEntry {
    const message = createBaseResponseInfo_HeadersEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const ResponseData = {
  ...
  async *encodeTransform(
    source: AsyncIterable<ResponseData | ResponseData[]> | Iterable<ResponseData | ResponseData[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
