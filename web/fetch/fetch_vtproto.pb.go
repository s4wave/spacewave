...
func (this *FetchRequest) EqualVT(that *FetchRequest) bool {
	...
	if this.Body == nil && that.Body != nil {
		...
		if !this.GetRequestInfo().EqualVT(that.GetRequestInfo()) {
			return false
		}
		if !this.GetRequestData().EqualVT(that.GetRequestData()) {
			return false
		}
	}
...
func (this *FetchRequestInfo) EqualVT(that *FetchRequestInfo) bool {
	...
	for i := range this.Headers {
		if this.Headers[i] != that.Headers[i] {
			return false
		}
	}
...
func (this *FetchResponse) EqualVT(that *FetchResponse) bool {
	...
	if this.Body == nil && that.Body != nil {
		...
		if !this.GetResponseInfo().EqualVT(that.GetResponseInfo()) {
			return false
		}
		if !this.GetResponseData().EqualVT(that.GetResponseData()) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Body.(*FetchRequest_RequestInfo); ok {
				...
				m.Body = &FetchRequest_RequestInfo{v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			if oneof, ok := m.Body.(*FetchRequest_RequestData); ok {
				...
				m.Body = &FetchRequest_RequestData{v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Body.(*FetchResponse_ResponseInfo); ok {
				...
				m.Body = &FetchResponse_ResponseInfo{v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			if oneof, ok := m.Body.(*FetchResponse_ResponseData); ok {
				...
				m.Body = &FetchResponse_ResponseData{v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
