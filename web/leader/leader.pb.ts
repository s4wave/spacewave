...
export const ElectionEvent = {
  encode(message: ElectionEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<ElectionEvent | ElectionEvent[]> | Iterable<ElectionEvent | ElectionEvent[]>,
  ...
  fromJSON(object: any): ElectionEvent {
    return {
      eventType: isSet(object.eventType) ? electionEventTypeFromJSON(object.eventType) : 0,
  ...
  toJSON(message: ElectionEvent): unknown {
    const obj: any = {};
    message.eventType !== undefined && (obj.eventType = electionEventTypeToJSON(message.eventType));
    message.workerId !== undefined && (obj.workerId = message.workerId);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ElectionEvent>, I>>(object: I): ElectionEvent {
    const message = createBaseElectionEvent();
