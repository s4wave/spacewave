...
func (m *ObjectInfo_WorldObjectInfo) CloneVT() *ObjectInfo_WorldObjectInfo {
	...
	r.WorldObjectInfo = m.WorldObjectInfo.CloneVT()
	return r
}
...
func (m *ObjectInfo_UnixfsObjectInfo) CloneVT() *ObjectInfo_UnixfsObjectInfo {
	...
	r.UnixfsObjectInfo = m.UnixfsObjectInfo.CloneVT()
	return r
}
...
func (this *ObjectInfo_WorldObjectInfo) EqualVT(thatIface isObjectInfo_Info) bool {
	...
	if p, q := this.WorldObjectInfo, that.WorldObjectInfo; p != q {
		if p == nil {
			p = &WorldObjectInfo{}
		}
		if q == nil {
...
func (this *ObjectInfo_UnixfsObjectInfo) EqualVT(thatIface isObjectInfo_Info) bool {
	...
	if p, q := this.UnixfsObjectInfo, that.UnixfsObjectInfo; p != q {
		if p == nil {
			p = &UnixfsObjectInfo{}
		}
		if q == nil {
...
func (m *UnixfsObjectInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MimeType) > 0 {
		...
		i = protobuf_go_lite.EncodeVarint(dAtA, i, uint64(len(m.MimeType)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Path) > 0 {
...
func (x *ObjectInfo) MarshalProtoText() string {
	...
	sb.WriteString("ObjectInfo {")
	switch body := x.Info.(type) {
	case *ObjectInfo_WorldObjectInfo:
		if sb.Len() > 12 {
			sb.WriteString(" ")
		}
		sb.WriteString("world_object_info: ")
		if body.WorldObjectInfo == nil {
			sb.WriteString((&WorldObjectInfo{}).MarshalProtoText())
		} else {
			sb.WriteString(body.WorldObjectInfo.MarshalProtoText())
		}
	case *ObjectInfo_UnixfsObjectInfo:
		if sb.Len() > 12 {
			sb.WriteString(" ")
		}
		sb.WriteString("unixfs_object_info: ")
		if body.UnixfsObjectInfo == nil {
			sb.WriteString((&UnixfsObjectInfo{}).MarshalProtoText())
		} else {
			sb.WriteString(body.UnixfsObjectInfo.MarshalProtoText())
		}
	}
	sb.WriteString("}")
	return sb.String()
...
func (x *WorldObjectInfo) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("WorldObjectInfo {")
	if x.EngineId != "" {
		if sb.Len() > 17 {
			sb.WriteString(" ")
		}
...
func (x *UnixfsObjectInfo) MarshalProtoText() string {
	var sb strings.Builder
	sb.WriteString("UnixfsObjectInfo {")
	if x.UnixfsId != "" {
		if sb.Len() > 18 {
			sb.WriteString(" ")
		}
	...
	if x.MimeType != "" {
		...
		sb.WriteString(strconv.Quote(x.MimeType))
	}
	sb.WriteString("}")
	return sb.String()
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if oneof, ok := m.Info.(*ObjectInfo_WorldObjectInfo); ok {
				if err := oneof.WorldObjectInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &WorldObjectInfo{}
		...
		case 2:
			...
			if oneof, ok := m.Info.(*ObjectInfo_UnixfsObjectInfo); ok {
				if err := oneof.UnixfsObjectInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &UnixfsObjectInfo{}
