...
export const WebPluginBrowserHostServiceName = "bldr.web.plugin.browser.WebPluginBrowserHost";
 ...
 * accessed by web/plugin/browser/web-plugin-browser.ts
 */
export type WebPluginBrowserHostDefinition = typeof WebPluginBrowserHostDefinition;
