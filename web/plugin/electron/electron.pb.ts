  ...
  fromJSON(object: any): Config {
    return {
      electronPath: isSet(object.electronPath)
        ? globalThis.String(object.electronPath)
        : '',
      workdirPath: isSet(object.workdirPath)
        ? globalThis.String(object.workdirPath)
        : '',
      rendererPath: isSet(object.rendererPath)
        ? globalThis.String(object.rendererPath)
        : '',
      webRuntimeId: isSet(object.webRuntimeId)
        ? globalThis.String(object.webRuntimeId)
        : '',
      electronFlags: globalThis.Array.isArray(object?.electronFlags)
        ? object.electronFlags.map((e: any) => globalThis.String(e))
        : [],
    }
  },
