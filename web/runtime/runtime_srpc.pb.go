...
// protoc-gen-srpc version: v0.10.9
...
func (SRPCWebRuntimeHostHandler) GetServiceID() string { return SRPCWebRuntimeHostServiceID }
...
func NewSRPCWebRuntimeHostHandler(impl SRPCWebRuntimeHostServer) srpc.Handler {
	return &SRPCWebRuntimeHostHandler{impl: impl}
}

func SRPCRegisterWebRuntimeHost(mux srpc.Mux, impl SRPCWebRuntimeHostServer) error {
	return mux.Register(&SRPCWebRuntimeHostHandler{impl: impl})
}
...
func NewSRPCWebRuntimeHandler(impl SRPCWebRuntimeServer) srpc.Handler {
	return &SRPCWebRuntimeHandler{impl: impl}
}
