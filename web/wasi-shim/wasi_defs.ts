...
// Size of subscription struct: 48 bytes
// Layout:
//   userdata: u64 (8 bytes) at offset 0
//   u.tag (eventtype): u8 at offset 8
//   For clock: u.u.clock at offset 16:
//     id: u32 at offset 16
//     timeout: u64 at offset 24
//     precision: u64 at offset 32
//     flags: u16 at offset 40
//   For fd_read/fd_write: u.u.fd_read/fd_write at offset 16:
//     file_descriptor: u32 at offset 16
  ...
  static read_bytes(view: DataView, ptr: number): Subscription {
    ...
    if (eventtype === EVENTTYPE_CLOCK) {
      return new Subscription(
        userdata,
        eventtype,
        view.getUint32(ptr + 16, true), // clockid
        view.getBigUint64(ptr + 24, true), // timeout
        view.getBigUint64(ptr + 32, true), // precision
        view.getUint16(ptr + 40, true), // flags
        0, // fd (not used)
      )
    }
    // FD_READ or FD_WRITE
    return new Subscription(
      ...
      0, // clockid (not used)
      0n, // timeout (not used)
      0n, // precision (not used)
      0, // flags (not used)
      view.getUint32(ptr + 16, true), // fd
    )
  }
...
// Size of event struct: 32 bytes
// Layout:
//   userdata: u64 at offset 0
//   error: u16 at offset 8
//   type: u8 at offset 10
//   fd_readwrite (if applicable):
//     nbytes: u64 at offset 16
//     flags: u16 at offset 24
export class Event {
  constructor(
    public userdata: bigint,
    public error: number,
    public eventtype: number,
    public nbytes: bigint = 0n,
    public rwflags: number = 0,
  ) {}
