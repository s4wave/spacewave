...
func (m *Config) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ObjectStoreId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ObjectStorePrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ObjectStoreHeadKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 7:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field InitHeadRef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 8:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field DisableLookup", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 9:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field DisableApplyWorldOp", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 10:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field DisableApplyObjectOp", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 11:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field StateTransformConf", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *HeadState) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: HeadState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: HeadState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
