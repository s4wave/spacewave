...
export const Config = {
  encode(message: Config, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.stateTransformConf !== undefined) {
      Config1.encode(message.stateTransformConf, writer.uint32(90).fork()).ldelim();
    }
  ...
  fromJSON(object: any): Config {
    return {
      ...
      objectStoreId: isSet(object.objectStoreId) ? String(object.objectStoreId) : "",
      objectStorePrefix: isSet(object.objectStorePrefix) ? String(object.objectStorePrefix) : "",
      objectStoreHeadKey: isSet(object.objectStoreHeadKey) ? String(object.objectStoreHeadKey) : "",
      initHeadRef: isSet(object.initHeadRef) ? ObjectRef.fromJSON(object.initHeadRef) : undefined,
      stateTransformConf: isSet(object.stateTransformConf) ? Config1.fromJSON(object.stateTransformConf) : undefined,
      disableLookup: isSet(object.disableLookup) ? Boolean(object.disableLookup) : false,
      disableApplyWorldOp: isSet(object.disableApplyWorldOp) ? Boolean(object.disableApplyWorldOp) : false,
      disableApplyObjectOp: isSet(object.disableApplyObjectOp) ? Boolean(object.disableApplyObjectOp) : false,
  ...
  toJSON(message: Config): unknown {
    ...
    message.objectStoreId !== undefined && (obj.objectStoreId = message.objectStoreId);
    message.objectStorePrefix !== undefined && (obj.objectStorePrefix = message.objectStorePrefix);
    message.objectStoreHeadKey !== undefined && (obj.objectStoreHeadKey = message.objectStoreHeadKey);
    message.initHeadRef !== undefined &&
      (obj.initHeadRef = message.initHeadRef ? ObjectRef.toJSON(message.initHeadRef) : undefined);
    message.stateTransformConf !== undefined &&
      (obj.stateTransformConf = message.stateTransformConf ? Config1.toJSON(message.stateTransformConf) : undefined);
    message.disableLookup !== undefined && (obj.disableLookup = message.disableLookup);
    message.disableApplyWorldOp !== undefined && (obj.disableApplyWorldOp = message.disableApplyWorldOp);
    message.disableApplyObjectOp !== undefined && (obj.disableApplyObjectOp = message.disableApplyObjectOp);
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.initHeadRef = (object.initHeadRef !== undefined && object.initHeadRef !== null)
      ? ObjectRef.fromPartial(object.initHeadRef)
      : undefined;
    message.stateTransformConf = (object.stateTransformConf !== undefined && object.stateTransformConf !== null)
...
export const HeadState = {
  encode(message: HeadState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<HeadState | HeadState[]> | Iterable<HeadState | HeadState[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): HeadState {
    return { headRef: isSet(object.headRef) ? ObjectRef.fromJSON(object.headRef) : undefined };
  },

  toJSON(message: HeadState): unknown {
    const obj: any = {};
    message.headRef !== undefined && (obj.headRef = message.headRef ? ObjectRef.toJSON(message.headRef) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<HeadState>, I>>(object: I): HeadState {
    const message = createBaseHeadState();
