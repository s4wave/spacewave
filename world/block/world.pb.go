...
func (m *World) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: World: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: World: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ObjectKeyValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field GraphKeyValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field LastChangeDisable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Object) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: Object: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: Object: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *WorldChange) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: WorldChange: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: WorldChange: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 5:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ObjectRef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field PrevObjectRef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 7:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field ObjectRev", wireType)
			}
			m.ObjectRev = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *WorldChangeLL) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: WorldChangeLL: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: WorldChangeLL: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field Height", wireType)
			}
			m.Height = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			if wireType != 0 {
				return errors.Errorf("proto: wrong wireType = %d for field TotalSize", wireType)
			}
			m.TotalSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field Changes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ChangeLogLL) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: ChangeLogLL: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: ChangeLogLL: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ChangeBatch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field KeyFilters", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
