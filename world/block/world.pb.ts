...
function createBaseWorld(): World {
  return { objectKeyValue: undefined, graphKeyValue: undefined, lastChange: undefined, lastChangeDisable: false };
}

export const World = {
  encode(message: World, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.objectKeyValue !== undefined) {
      KeyValueStore.encode(message.objectKeyValue, writer.uint32(10).fork()).ldelim();
    }
    if (message.graphKeyValue !== undefined) {
      KeyValueStore.encode(message.graphKeyValue, writer.uint32(18).fork()).ldelim();
    }
  ...
  fromJSON(object: any): World {
    return {
      objectKeyValue: isSet(object.objectKeyValue) ? KeyValueStore.fromJSON(object.objectKeyValue) : undefined,
      graphKeyValue: isSet(object.graphKeyValue) ? KeyValueStore.fromJSON(object.graphKeyValue) : undefined,
      lastChange: isSet(object.lastChange) ? ChangeLogLL.fromJSON(object.lastChange) : undefined,
      lastChangeDisable: isSet(object.lastChangeDisable) ? Boolean(object.lastChangeDisable) : false,
    };
  },
  ...
  toJSON(message: World): unknown {
    ...
    message.objectKeyValue !== undefined &&
      (obj.objectKeyValue = message.objectKeyValue ? KeyValueStore.toJSON(message.objectKeyValue) : undefined);
    message.graphKeyValue !== undefined &&
      (obj.graphKeyValue = message.graphKeyValue ? KeyValueStore.toJSON(message.graphKeyValue) : undefined);
    message.lastChange !== undefined &&
      (obj.lastChange = message.lastChange ? ChangeLogLL.toJSON(message.lastChange) : undefined);
    message.lastChangeDisable !== undefined && (obj.lastChangeDisable = message.lastChangeDisable);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<World>, I>>(object: I): World {
    const message = createBaseWorld();
    message.objectKeyValue = (object.objectKeyValue !== undefined && object.objectKeyValue !== null)
      ? KeyValueStore.fromPartial(object.objectKeyValue)
      : undefined;
    message.graphKeyValue = (object.graphKeyValue !== undefined && object.graphKeyValue !== null)
...
export const WorldChange = {
  encode(message: WorldChange, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<WorldChange | WorldChange[]> | Iterable<WorldChange | WorldChange[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): WorldChange {
    return {
      changeType: isSet(object.changeType) ? worldChangeTypeFromJSON(object.changeType) : 0,
      key: isSet(object.key) ? String(object.key) : "",
      ...
      objectRef: isSet(object.objectRef) ? BlockRef.fromJSON(object.objectRef) : undefined,
      prevObjectRef: isSet(object.prevObjectRef) ? BlockRef.fromJSON(object.prevObjectRef) : undefined,
      objectRev: isSet(object.objectRev) ? Long.fromValue(object.objectRev) : Long.UZERO,
    };
  },

  toJSON(message: WorldChange): unknown {
    const obj: any = {};
    message.changeType !== undefined && (obj.changeType = worldChangeTypeToJSON(message.changeType));
    message.key !== undefined && (obj.key = message.key);
    ...
    message.objectRef !== undefined &&
      (obj.objectRef = message.objectRef ? BlockRef.toJSON(message.objectRef) : undefined);
    message.prevObjectRef !== undefined &&
      (obj.prevObjectRef = message.prevObjectRef ? BlockRef.toJSON(message.prevObjectRef) : undefined);
    message.objectRev !== undefined && (obj.objectRev = (message.objectRev || Long.UZERO).toString());
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<WorldChange>, I>>(object: I): WorldChange {
    const message = createBaseWorldChange();
    ...
    message.transactionRef = (object.transactionRef !== undefined && object.transactionRef !== null)
      ...
      : undefined;
    message.objectRef = (object.objectRef !== undefined && object.objectRef !== null)
      ? BlockRef.fromPartial(object.objectRef)
      : undefined;
    message.prevObjectRef = (object.prevObjectRef !== undefined && object.prevObjectRef !== null)
      ? BlockRef.fromPartial(object.prevObjectRef)
      : undefined;
    message.objectRev = (object.objectRev !== undefined && object.objectRev !== null)
...
export const WorldChangeLL = {
  encode(message: WorldChangeLL, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.height !== 0) {
  ...
  async *encodeTransform(
    source: AsyncIterable<WorldChangeLL | WorldChangeLL[]> | Iterable<WorldChangeLL | WorldChangeLL[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): WorldChangeLL {
    return {
      ...
      changes: Array.isArray(object?.changes) ? object.changes.map((e: any) => WorldChange.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: WorldChangeLL): unknown {
    ...
    if (message.changes) {
      obj.changes = message.changes.map((e) => e ? WorldChange.toJSON(e) : undefined);
    } else {
      obj.changes = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<WorldChangeLL>, I>>(object: I): WorldChangeLL {
    const message = createBaseWorldChangeLL();
    ...
    message.changes = object.changes?.map((e) => WorldChange.fromPartial(e)) || [];
    return message;
  },
};

function createBaseChangeLogLL(): ChangeLogLL {
  return { seqno: Long.UZERO, prevRef: undefined, changeBatch: undefined, changeType: 0, keyFilters: undefined };
}

export const ChangeLogLL = {
  encode(message: ChangeLogLL, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.changeBatch !== undefined) {
      WorldChangeLL.encode(message.changeBatch, writer.uint32(26).fork()).ldelim();
    }
    if (message.changeType !== 0) {
  ...
  async *encodeTransform(
    source: AsyncIterable<ChangeLogLL | ChangeLogLL[]> | Iterable<ChangeLogLL | ChangeLogLL[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): ChangeLogLL {
    return {
      ...
      prevRef: isSet(object.prevRef) ? BlockRef.fromJSON(object.prevRef) : undefined,
      changeBatch: isSet(object.changeBatch) ? WorldChangeLL.fromJSON(object.changeBatch) : undefined,
      changeType: isSet(object.changeType) ? worldChangeTypeFromJSON(object.changeType) : 0,
      keyFilters: isSet(object.keyFilters) ? KeyFilters.fromJSON(object.keyFilters) : undefined,
    };
  },
  ...
  toJSON(message: ChangeLogLL): unknown {
    ...
    message.changeBatch !== undefined &&
      (obj.changeBatch = message.changeBatch ? WorldChangeLL.toJSON(message.changeBatch) : undefined);
    message.changeType !== undefined && (obj.changeType = worldChangeTypeToJSON(message.changeType));
    message.keyFilters !== undefined &&
      (obj.keyFilters = message.keyFilters ? KeyFilters.toJSON(message.keyFilters) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ChangeLogLL>, I>>(object: I): ChangeLogLL {
    const message = createBaseChangeLogLL();
    message.seqno = (object.seqno !== undefined && object.seqno !== null) ? Long.fromValue(object.seqno) : Long.UZERO;
    message.prevRef = (object.prevRef !== undefined && object.prevRef !== null)
      ? BlockRef.fromPartial(object.prevRef)
      : undefined;
    message.changeBatch = (object.changeBatch !== undefined && object.changeBatch !== null)
      ? WorldChangeLL.fromPartial(object.changeBatch)
      : undefined;
    message.changeType = object.changeType ?? 0;
    message.keyFilters = (object.keyFilters !== undefined && object.keyFilters !== null)
