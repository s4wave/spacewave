...
export const MockObjectOp = {
  encode(message: MockObjectOp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nextMsg !== "") {
  ...
  async *encodeTransform(
    source: AsyncIterable<MockObjectOp | MockObjectOp[]> | Iterable<MockObjectOp | MockObjectOp[]>,
  ...
  fromPartial<I extends Exact<DeepPartial<MockObjectOp>, I>>(object: I): MockObjectOp {
    const message = createBaseMockObjectOp();
...
export const MockWorldOp = {
  encode(message: MockWorldOp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<MockWorldOp | MockWorldOp[]> | Iterable<MockWorldOp | MockWorldOp[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<MockWorldOp>, I>>(object: I): MockWorldOp {
    const message = createBaseMockWorldOp();
