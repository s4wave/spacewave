...
export const EntityUpdateOp = {
  encode(message: EntityUpdateOp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<EntityUpdateOp | EntityUpdateOp[]> | Iterable<EntityUpdateOp | EntityUpdateOp[]>,
  ...
  fromJSON(object: any): EntityUpdateOp {
    return { entityRef: isSet(object.entityRef) ? ObjectRef.fromJSON(object.entityRef) : undefined };
  },

  toJSON(message: EntityUpdateOp): unknown {
    const obj: any = {};
    message.entityRef !== undefined &&
      (obj.entityRef = message.entityRef ? ObjectRef.toJSON(message.entityRef) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<EntityUpdateOp>, I>>(object: I): EntityUpdateOp {
    const message = createBaseEntityUpdateOp();
...
export const KeypairUpdateOp = {
  encode(message: KeypairUpdateOp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<KeypairUpdateOp | KeypairUpdateOp[]> | Iterable<KeypairUpdateOp | KeypairUpdateOp[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): KeypairUpdateOp {
    return { keypairRef: isSet(object.keypairRef) ? ObjectRef.fromJSON(object.keypairRef) : undefined };
  },

  toJSON(message: KeypairUpdateOp): unknown {
    const obj: any = {};
    message.keypairRef !== undefined &&
      (obj.keypairRef = message.keypairRef ? ObjectRef.toJSON(message.keypairRef) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<KeypairUpdateOp>, I>>(object: I): KeypairUpdateOp {
    const message = createBaseKeypairUpdateOp();
    message.keypairRef = (object.keypairRef !== undefined && object.keypairRef !== null)
...
export const DomainInfoUpdateOp = {
  encode(message: DomainInfoUpdateOp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): DomainInfoUpdateOp {
    return { domainInfoRef: isSet(object.domainInfoRef) ? ObjectRef.fromJSON(object.domainInfoRef) : undefined };
  },

  toJSON(message: DomainInfoUpdateOp): unknown {
    const obj: any = {};
    message.domainInfoRef !== undefined &&
      (obj.domainInfoRef = message.domainInfoRef ? ObjectRef.toJSON(message.domainInfoRef) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<DomainInfoUpdateOp>, I>>(object: I): DomainInfoUpdateOp {
    const message = createBaseDomainInfoUpdateOp();
    message.domainInfoRef = (object.domainInfoRef !== undefined && object.domainInfoRef !== null)
